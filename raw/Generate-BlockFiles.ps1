...
$new = @("basalt_sparklestone_light", "calcite_sparklestone_light", "stone_sparklestone_light", "granite_sparklestone_light", "diorite_sparklestone_light", "andesite_sparklestone_light", "deepslate_sparklestone_light")
