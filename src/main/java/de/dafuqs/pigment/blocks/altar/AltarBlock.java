...
public class AltarBlock extends BlockWithEntity {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        if(world.isClient) {
            ...
            return checkType(type, PigmentBlockEntityRegistry.ALTAR_BLOCK_ENTITY_TYPE, AltarBlockEntity::tick);
        }
    }
    ...
    public void power(World world, BlockPos pos) {
        world.setBlockState(pos, PigmentBlocks.ALTAR.getDefaultState().with(AltarBlock.STATE, AltarState.REDSTONE));
    }

    public void unPower(World world, BlockPos pos) {
        world.setBlockState(pos, PigmentBlocks.ALTAR.getDefaultState().with(AltarBlock.STATE, AltarState.DEFAULT));
    }

    @Environment(EnvType.CLIENT)
    public void randomDisplayTick(BlockState state, World world, BlockPos pos, Random random) {
        if (world.getBlockState(pos).equals(PigmentBlocks.ALTAR.getDefaultState().with(AltarBlock.STATE, AltarState.REDSTONE))) {
