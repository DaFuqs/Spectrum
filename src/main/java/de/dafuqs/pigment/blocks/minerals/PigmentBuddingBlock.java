...
public class PigmentBuddingBlock extends BuddingAmethystBlock {
    ...
    public PigmentBuddingBlock(Settings settings, Block smallBlock, Block mediumBlock, Block largeBlock, Block clusterBlock, SoundEvent hitSoundEvent, SoundEvent chimeSoundEvent) {
        super(settings);
