package de.dafuqs.pigment.blocks.types.decay;
...
public class DecayBlock2 extends DecayBlock {
    ...
    public void randomDisplayTick(BlockState state, World world, BlockPos pos, Random random) {
        ...
        if(CRYING_OBSIDIAN_BLOCKSTATE == null) {
            CRYING_OBSIDIAN_BLOCKSTATE = PigmentBlocks.DECAY2.getDefaultState().with(DecayBlock2.DECAY_STATE, DecayConversion.CRYING_OBSIDIAN);
        }
