...
public abstract class PigmentItemFrameItem extends ItemFrameItem {

    public PigmentItemFrameItem(EntityType<? extends AbstractDecorationEntity> entityType, Item.Settings settings) {
