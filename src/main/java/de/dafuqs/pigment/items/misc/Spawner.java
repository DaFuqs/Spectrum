    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
        if(itemStack.getTag() != null && itemStack.getTag().get("BlockEntityTag") != null) {
            ...
            if(entityType.isPresent()) {
                ...
                tooltip.add(new TranslatableText("item.pigment.spawner.tooltip.unknown_mob"));
            }
            tooltip.add(new TranslatableText("item.pigment.spawner.tooltip.spawn_count", spawnCount));
            tooltip.add(new TranslatableText("item.pigment.spawner.tooltip.min_spawn_delay", minSpawnDelay));
            tooltip.add(new TranslatableText("item.pigment.spawner.tooltip.max_spawn_delay", maxSpawnDelay));
            tooltip.add(new TranslatableText("item.pigment.spawner.tooltip.spawn_range", spawnRange));
            tooltip.add(new TranslatableText("item.pigment.spawner.tooltip.required_player_range", requiredPlayerRange));
        }
    }
