...
import de.dafuqs.spectrum.blocks.fluid.SpectrumFluidTags;
...
public class SpectrumCommon implements ModInitializer {
    ...
    private static SpectrumBlockCloaker spectrumBlockCloaker;
    ...
    public void onInitialize() {
        ...
        spectrumBlockCloaker = new SpectrumBlockCloaker();
    ...
    public static SpectrumBlockCloaker getModelSwapper() {
        return spectrumBlockCloaker;
    }
