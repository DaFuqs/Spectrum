...
/**
 * An object designed to hold {@link de.dafuqs.spectrum.blocks.blocklikeentities.api.BlockLikeEntity}s together.
...
public class BlockLikeSet {
    ...
    private final Map<Vec3i, de.dafuqs.spectrum.blocks.blocklikeentities.api.BlockLikeEntity> entries;
     ...
     */
    public BlockLikeSet(de.dafuqs.spectrum.blocks.blocklikeentities.api.BlockLikeEntity entity1, de.dafuqs.spectrum.blocks.blocklikeentities.api.BlockLikeEntity entity2, Vec3i offset) {
        this.entries = Map.of(
                Vec3i.ZERO, entity1,
                offset, entity2
        );
     ...
     */
    public BlockLikeSet(Map<Vec3i, de.dafuqs.spectrum.blocks.blocklikeentities.api.BlockLikeEntity> map) {
        this.entries = map;
    }
     ...
     */
    public Map<Vec3i, de.dafuqs.spectrum.blocks.blocklikeentities.api.BlockLikeEntity> getEntries(){
    ...
    protected void synchronize() {
        de.dafuqs.spectrum.blocks.blocklikeentities.api.BlockLikeEntity master = getMasterBlock();
    ...
    public void postTick() {
        ...
        for (de.dafuqs.spectrum.blocks.blocklikeentities.api.BlockLikeEntity block : entries.values()) {
            if (block.isRemoved()) {
    ...
    public void land(de.dafuqs.spectrum.blocks.blocklikeentities.api.BlockLikeEntity lander, boolean success) {
        this.synchronize();
    ...
    public de.dafuqs.spectrum.blocks.blocklikeentities.api.BlockLikeEntity getMasterBlock() {
    ...
    public static class Builder {
        protected final Map<Vec3i, de.dafuqs.spectrum.blocks.blocklikeentities.api.BlockLikeEntity> entries;
         ...
         */
        public Builder add(de.dafuqs.spectrum.blocks.blocklikeentities.api.BlockLikeEntity entity){
         ...
         */
        public Builder addIf(de.dafuqs.spectrum.blocks.blocklikeentities.api.BlockLikeEntity entity, Predicate<Map<Vec3i, BlockLikeEntity>> predicate){
