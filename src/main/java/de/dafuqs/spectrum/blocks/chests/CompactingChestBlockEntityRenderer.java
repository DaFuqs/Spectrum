...
public class CompactingChestBlockEntityRenderer implements BlockEntityRenderer<CompactingChestBlockEntity> {
	...
	public static LayerDefinition getTexturedModelData() {
		...
		PartDefinition root = modelData.getRoot().addOrReplaceChild("root", CubeListBuilder.create().texOffs(81, 44).addBox(-1.5F, -10.0F, -1.5F, 3.0F, 9.0F, 3.0F, new CubeDeformation(0.0F))
		...
		root.addOrReplaceChild("driver", CubeListBuilder.create().texOffs(53, 38).addBox(-3.5F, -36.0F, -3.5F, 7.0F, 11.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 21.0F, 0.0F));
		root.addOrReplaceChild("piston", CubeListBuilder.create().texOffs(89, 17).addBox(-3.5F, 7.0F, -3.5F, 7.0F, 14.0F, 7.0F, new CubeDeformation(0.0F))
				.texOffs(45, 13).addBox(-5.5F, 7.0F, -5.5F, 11.0F, 14.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -22.0F, 0.0F));
		root.addOrReplaceChild("cap", CubeListBuilder.create().texOffs(0, 24).addBox(-7.5F, -36.0F, -7.5F, 15.0F, 4.0F, 15.0F, new CubeDeformation(0.0F))
