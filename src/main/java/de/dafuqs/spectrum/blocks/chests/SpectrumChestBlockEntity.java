		...
		this.stateManager = new ContainerOpenersCounter() {
			...
			protected boolean isOwnContainer(Player player) {
				...
				switch (screenHandler) {
					case ChestMenu chestMenu -> inventory = chestMenu.getContainer();
					case FabricationChestScreenHandler fabricationChestScreenHandler -> inventory = fabricationChestScreenHandler.getInventory();
					case BlackHoleChestScreenHandler blackHoleChestScreenHandler -> inventory = blackHoleChestScreenHandler.getInventory();
					case CompactingChestScreenHandler compactingChestScreenHandler -> inventory = compactingChestScreenHandler.getInventory();
					default -> {
					}
				}
