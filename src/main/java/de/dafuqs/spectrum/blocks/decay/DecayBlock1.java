...
public class DecayBlock1 extends DecayBlock {
    ...
    public DecayBlock1(Settings settings, Tag<Block> whiteListBlockTag, Tag<Block> blackListBlockTag, int tier, float damageOnTouching) {
        ...
        addDecayConversion(SpectrumBlockTags.DECAY_MAGICAL_LEAVES, destinationBlockState2);
    }
    ...
    public void randomDisplayTick(BlockState state, World world, BlockPos pos, Random random) {
        ...
        if(MAGIC_LEAVES_BLOCKSTATE == null) {
            MAGIC_LEAVES_BLOCKSTATE = SpectrumBlocks.DECAY1.getDefaultState().with(DecayBlock1.DECAY_STATE, DecayConversion.MAGIC_LEAVES);
        }
