...
public class FlexLanternBlock extends DiagonalBlock implements Waterloggable {
    ...
    public static final VoxelShape STANDING, STANDING_ALT, HANGED, HANGED_ALT;
    ...
    public VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        ...
        if (state.get(HANGING)) {
            return alt ? HANGED_ALT : HANGED;
        }
        else {
            return alt ? STANDING_ALT : STANDING;
        }
    }
    ...
    static {
        STANDING = Block.createCuboidShape(4, 0, 4, 12, 13, 12);
        STANDING_ALT = Block.createCuboidShape(4, 0, 4, 12, 16, 12);
        HANGED = Block.createCuboidShape(4, 4, 4, 12, 16, 12);
        HANGED_ALT = Block.createCuboidShape(4, 7, 4, 12, 16, 12);
    }
}
