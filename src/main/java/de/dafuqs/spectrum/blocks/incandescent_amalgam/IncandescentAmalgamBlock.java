...
public class IncandescentAmalgamBlock extends PlaceableItemBlock implements Waterloggable {
	...
	protected static void explode(World world, BlockPos pos) {
		if (!world.isClient) {
			...
			world.createExplosion(null, SpectrumDamageSources.incandescence(world), new ExplosionBehavior(), pos.getX() + 0.5, pos.getY() + 0.5, pos.getZ() + 0.5, power, true, World.ExplosionSourceType.BLOCK);
		}
	}
