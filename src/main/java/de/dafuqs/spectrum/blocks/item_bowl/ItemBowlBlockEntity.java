...
public class ItemBowlBlockEntity extends InWorldInteractionBlockEntity {
	...
	public void spawnOrbParticles(Vec3 orbTargetPos) {
		...
		if (!storedStack.isEmpty() && level != null) {
			...
			level.playSound(null, this.worldPosition, SpectrumSoundEvents.CRAFTING_DING, SoundSource.BLOCKS, SpectrumCommon.CONFIG.BlockSoundVolume, 0.7F + level.getRandom().nextFloat() * 0.6F);
		}
	}
