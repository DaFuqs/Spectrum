...
public enum SpectrumSkullType implements SkullBlock.SkullType {
    ...
    LIZARD_BLACK(SpectrumEntityTypes.LIZARD),
    LIZARD_BLUE(SpectrumEntityTypes.LIZARD),
    LIZARD_BROWN(SpectrumEntityTypes.LIZARD),
    LIZARD_CYAN(SpectrumEntityTypes.LIZARD),
    LIZARD_GRAY(SpectrumEntityTypes.LIZARD),
    LIZARD_GREEN(SpectrumEntityTypes.LIZARD),
    LIZARD_LIGHT_BLUE(SpectrumEntityTypes.LIZARD),
    LIZARD_LIGHT_GRAY(SpectrumEntityTypes.LIZARD),
    LIZARD_LIME(SpectrumEntityTypes.LIZARD),
    LIZARD_MAGENTA(SpectrumEntityTypes.LIZARD),
    LIZARD_ORANGE(SpectrumEntityTypes.LIZARD),
    LIZARD_PINK(SpectrumEntityTypes.LIZARD),
    LIZARD_PURPLE(SpectrumEntityTypes.LIZARD),
    LIZARD_RED(SpectrumEntityTypes.LIZARD),
    LIZARD_WHITE(SpectrumEntityTypes.LIZARD),
    LIZARD_YELLOW(SpectrumEntityTypes.LIZARD),
