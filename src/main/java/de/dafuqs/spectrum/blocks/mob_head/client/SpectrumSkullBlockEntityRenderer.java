...
public class SpectrumSkullBlockEntityRenderer implements BlockEntityRenderer<SpectrumSkullBlockEntity> {
	...
	public static Map<SkullBlock.Type, List<Tuple<SpectrumSkullModel, ResourceLocation>>> getModels(EntityModelSet modelLoader) {
		...
		builder.put(SpectrumSkullType.MAGMA_CUBE, List.of(new Tuple<>(new SlimeHeadModel(modelLoader.bakeLayer(SpectrumModelLayers.MAGMA_CUBE_HEAD), modelLoader.bakeLayer(SpectrumModelLayers.SLIME_HEAD_TRANSLUCENT)), ResourceLocation.parse("textures/entity/slime/magmacube.png"))));
