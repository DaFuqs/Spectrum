...
public class SpectrumEmiRecipeCategories {
	...
	public static final EmiRecipeCategory NATURES_STAFF = new SpectrumCategory(SpectrumCommon.locate("natures_staff_conversions"), EmiStack.of(SpectrumItems.NATURES_STAFF), SpectrumItems.NATURES_STAFF.get().getDescriptionId());
	...
	public static final EmiRecipeCategory SPIRIT_INSTILLER = new SpectrumCategory(SpectrumCommon.locate("spirit_instiller"), EmiStack.of(SpectrumBlocks.SPIRIT_INSTILLER), SpectrumBlocks.SPIRIT_INSTILLER.get().getDescriptionId());
	public static final EmiRecipeCategory SLUDGE_CONVERTING = new SpectrumCategory(SpectrumCommon.locate("sludge_converting"), EmiStack.of(SpectrumItems.SLUDGE_BUCKET));
	...
	public static final EmiRecipeCategory CINDERHEARTH = new SpectrumCategory(SpectrumCommon.locate("cinderhearth"), EmiStack.of(SpectrumBlocks.CINDERHEARTH), SpectrumBlocks.CINDERHEARTH.get().getDescriptionId());
	public static final EmiRecipeCategory TITRATION_BARREL = new SpectrumCategory(SpectrumCommon.locate("titration_barrel"), EmiStack.of(SpectrumBlocks.TITRATION_BARREL), SpectrumBlocks.TITRATION_BARREL.get().getDescriptionId());
