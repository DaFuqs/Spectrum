...
public class PagePedestalCrafting extends PageDoubleRecipeRegistry<PedestalCraftingRecipe> {
	...
	private static final Identifier BACKGROUND_TEXTURE = new Identifier(SpectrumCommon.MOD_ID, "textures/gui/patchouli/pedestal_crafting.png");
	...
	@Override
	protected void drawRecipe(MatrixStack ms, PedestalCraftingRecipe recipe, int recipeX, int recipeY, int mouseX, int mouseY, boolean second) {
