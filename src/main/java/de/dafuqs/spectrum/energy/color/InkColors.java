...
public class InkColors {
	...
	public static ElementalColor CYAN = new ElementalColor(DyeColor.CYAN, BASE_ADVANCEMENT_ID, new Vec3f(0.36f, 1f, 0.93f));
	public static ElementalColor MAGENTA = new ElementalColor(DyeColor.MAGENTA, BASE_ADVANCEMENT_ID, new Vec3f(0.84f, 0.25f, 0.94f));
	public static ElementalColor YELLOW = new ElementalColor(DyeColor.YELLOW, BASE_ADVANCEMENT_ID, new Vec3f(0.97f, 0.75f, 0.24f));
	public static ElementalColor BLACK = new ElementalColor(DyeColor.BLACK, BASE_ADVANCEMENT_ID, new Vec3f(0.07f, 0.07f, 0.07f));
	public static ElementalColor WHITE = new ElementalColor(DyeColor.WHITE, BASE_ADVANCEMENT_ID, new Vec3f(0.93f, 0.95f, 0.98f));
