...
public class InkColors {
	...
	public static ElementalColor MAGENTA = new ElementalColor(DyeColor.MAGENTA, new Vec3f(0.92f, 0.25f, 0.94f), BASE_ADVANCEMENT_ID);
	public static ElementalColor YELLOW = new ElementalColor(DyeColor.YELLOW, new Vec3f(0.93F, 0.93F, 0.0F), BASE_ADVANCEMENT_ID);
	...
	public static CompoundColor LIME = new CompoundColor(DyeColor.LIME, new Vec3f(0.23f, 1f, 0.22f), BASE_ADVANCEMENT_ID, new HashMap<>() {{
		put(CYAN, 1F / 3F);
		put(YELLOW, 2F / 3F);
	}});
	public static CompoundColor PINK = new CompoundColor(DyeColor.PINK, new Vec3f(1.0F, 0.78F, 0.87F), BASE_ADVANCEMENT_ID, new HashMap<>() {{
		put(MAGENTA, 2F / 3F);
		put(YELLOW, 1F / 3F);
	}});
	public static CompoundColor RED = new CompoundColor(DyeColor.RED, new Vec3f(0.85f, 0.1f, 0.04f), BASE_ADVANCEMENT_ID, new HashMap<>() {{
		put(MAGENTA, 2F / 4F);
		put(YELLOW, 2F / 4F);
	}});
	...
	public static CompoundColor PURPLE = new CompoundColor(DyeColor.PURPLE, new Vec3f(0.5f, 0.17f, 0.77f), BASE_ADVANCEMENT_ID, new HashMap<>() {{
		put(CYAN, 2F / 6F);
		put(MAGENTA, 3F / 6F);
		put(YELLOW, 1F / 6F);
	}});
	...
	public static CompoundColor LIGHT_GRAY = new CompoundColor(DyeColor.LIGHT_GRAY, new Vec3f(0.68F, 0.68F, 0.68F), WHITE_ADVANCEMENT_ID, new HashMap<>() {{
		put(CYAN, 2F / 6F);
		put(MAGENTA, 2F / 6F);
		put(YELLOW, 2F / 6F);
	}});
	public static CompoundColor GRAY = new CompoundColor(DyeColor.GRAY, new Vec3f(0.26f, 0.25f, 0.28f), WHITE_ADVANCEMENT_ID, new HashMap<>() {{
		put(CYAN, 2F / 6F);
		put(MAGENTA, 2F / 6F);
		put(YELLOW, 2F / 6F);
	}});
