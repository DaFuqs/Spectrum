...
public class SpectrumEntityTypes {
	...
	public static final DeferredHolder<EntityType<?>, EntityType<? extends ThrowableItemProjectile>> BLOCK_FLOODER_PROJECTILE = register("block_flooder_projectile", 4, 10, true, EntityDimensions.scalable(0.25F, 0.25F), true, BlockFlooderProjectile::new);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<? extends ItemEntity>> FIREPROOF_ITEM = register("fireproof_item", 6, 20, true, EntityDimensions.scalable(0.25F, 0.25F), true, FireproofItemEntity::new);
