...
public class SpectrumEntityTypes {
	...
	public static final EntityType<PreservationTurretEntity> GUARDIAN_TURRET = register("guardian_turret", EntityType.Builder.create(PreservationTurretEntity::new, SpawnGroup.MONSTER).makeFireImmune().spawnableFarFromPlayer().setDimensions(1.0F, 1.0F).maxTrackingRange(10));
	...
	public static void register() {
		...
		FabricDefaultAttributeRegistry.register(GUARDIAN_TURRET, PreservationTurretEntity.createGuardianTurretAttributes());
