...
public class EraserEntityModel extends SinglePartEntityModel<EraserEntity> {
	...
	public EraserEntityModel(ModelPart root) {
		...
		this.rightMiddleLeg = legs.getChild("rightmidleg");
		this.leftMiddleLeg = legs.getChild("leftmidleg");
		this.rightFrontLeg = legs.getChild(EntityModelPartNames.RIGHT_FRONT_LEG);
		this.leftFrontLeg = legs.getChild(EntityModelPartNames.LEFT_FRONT_LEG);
