...
public class KindlingEntityModel extends QuadrupedEntityModel<KindlingEntity> {
	...
	@Override
	public void setAngles(KindlingEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
