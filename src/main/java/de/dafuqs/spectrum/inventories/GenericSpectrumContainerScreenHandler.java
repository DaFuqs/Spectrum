...
public class GenericSpectrumContainerScreenHandler extends GenericContainerScreenHandler {
	...
	public static @NotNull GenericSpectrumContainerScreenHandler createGeneric9x3(int syncId, PlayerInventory playerInventory, Inventory inventory, SpectrumTier tier) {
	...
	@Contract("_, _, _, _ -> new")
	public static @NotNull GenericSpectrumContainerScreenHandler createGeneric9x6(int syncId, PlayerInventory playerInventory, Inventory inventory, SpectrumTier tier) {
