...
public class GenericSpectrumContainerScreenHandler extends GenericContainerScreenHandler {
	...
	public static @NotNull GenericSpectrumContainerScreenHandler createGeneric9x3(int syncId, PlayerInventory playerInventory, Inventory inventory, @NotNull ProgressionStage tier) {
		switch (tier) {
			case EARLYGAME -> { return new GenericSpectrumContainerScreenHandler(SpectrumScreenHandlerTypes.GENERIC_TIER1_9X3, syncId, playerInventory, inventory, 3, tier); }
			case MIDGAME -> { return new GenericSpectrumContainerScreenHandler(SpectrumScreenHandlerTypes.GENERIC_TIER2_9X3, syncId, playerInventory, inventory, 3, tier); }
	...
	public static @NotNull GenericSpectrumContainerScreenHandler createGeneric9x6(int syncId, PlayerInventory playerInventory, Inventory inventory, @NotNull ProgressionStage tier) {
		switch (tier) {
			case EARLYGAME -> { return new GenericSpectrumContainerScreenHandler(SpectrumScreenHandlerTypes.GENERIC_TIER1_9X6, syncId, playerInventory, inventory, 6, tier); }
			case MIDGAME -> { return new GenericSpectrumContainerScreenHandler(SpectrumScreenHandlerTypes.GENERIC_TIER2_9X6, syncId, playerInventory, inventory, 6, tier); }
