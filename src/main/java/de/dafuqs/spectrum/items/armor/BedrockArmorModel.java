...
public class BedrockArmorModel extends BipedEntityModel<LivingEntity> {
    ...
    public static ModelData getModelData() {
        ...
        var visor = head.addChild("visor", ModelPartBuilder.create()
                .uv(30, 11)
            .cuboid(-5.0F, -3.0F, -6.8F, 10.0F, 5.0F, 7.0F, Dilation.NONE),
        ...
        var left_boot = left_leg.addChild("left_boot", ModelPartBuilder.create()
                .uv(82, 42).cuboid(-2.5F, 9.5F, -2.5F, 5.0F, 3.0F, 5.0F, new Dilation(0.01f))
                .uv(32, 80).mirrored().cuboid(-2.5F, 5.0F, -1.25F, 5.0F, 6.0F, 4.0F, new Dilation(0.01f)).mirrored(false), ModelTransform.NONE);
        ...
        var right_boot = right_leg.addChild("right_boot", ModelPartBuilder.create()
                .uv(32, 80).cuboid(-2.5F, 5.0F, -1.25F, 5.0F, 6.0F, 4.0F, new Dilation(0.01f))
                .uv(80, 34).cuboid(-2.5F, 9.5F, -2.5F, 5.0F, 3.0F, 5.0F, new Dilation(0.01f)), ModelTransform.NONE);
        return data;
    }
