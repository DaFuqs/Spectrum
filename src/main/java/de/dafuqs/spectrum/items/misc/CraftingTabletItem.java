...
public class CraftingTabletItem extends Item {
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
        ...
        if(recipe == null) {
            tooltip.add(new TranslatableText("item.spectrum.crafting_tablet.tooltip.no_recipe"));
        } else {
            tooltip.add(new TranslatableText("item.spectrum.crafting_tablet.tooltip.recipe", recipe.getOutput().getCount(), recipe.getOutput().getName().getString()));
        }
