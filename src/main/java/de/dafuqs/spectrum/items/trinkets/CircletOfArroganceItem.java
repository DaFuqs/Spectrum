...
public class CircletOfArroganceItem extends SpectrumTrinketItem {
	...
	public Multimap<EntityAttribute, EntityAttributeModifier> getModifiers(ItemStack stack, SlotReference slot, LivingEntity entity, UUID uuid) {
		...
		modifiers.put(SpectrumEntityAttributes.INDUCED_SLEEP_VULNERABILITY, new EntityAttributeModifier(uuid, "spectrum:circlet_of_arrogance", -0.25, EntityAttributeModifier.Operation.MULTIPLY_TOTAL));
		return modifiers;
    }
