...
public class GleamingPinItem extends SpectrumTrinketItem {
	...
	public static void doGleamingPinEffect(@NotNull PlayerEntity player, @NotNull ServerWorld world) {
		...
		world.getOtherEntities(player, player.getBoundingBox().expand(RANGE), EntityPredicates.VALID_LIVING_ENTITY).forEach((entity) -> {
