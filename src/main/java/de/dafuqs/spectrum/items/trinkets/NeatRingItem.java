...
public class NeatRingItem extends SpectrumTrinketItem {
	...
	public Multimap<EntityAttribute, EntityAttributeModifier> getModifiers(ItemStack stack, SlotReference slot, LivingEntity entity, UUID uuid) {
		...
		modifiers.put(SpectrumEntityAttributes.MENTAL_PRESENCE, new EntityAttributeModifier(uuid, "spectrum:neat_ring", 0.0069, EntityAttributeModifier.Operation.ADDITION));
		return modifiers;
	}
