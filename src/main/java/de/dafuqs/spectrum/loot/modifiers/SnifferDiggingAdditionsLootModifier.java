...
public class SnifferDiggingAdditionsLootModifier extends LootModifier {
	
	public static final MapCodec<SnifferDiggingAdditionsLootModifier> CODEC = RecordCodecBuilder.mapCodec(i ->
			LootModifier.codecStart(i).and(i.group(
					...
					).apply(i, SnifferDiggingAdditionsLootModifier::new));
	...
	protected SnifferDiggingAdditionsLootModifier(LootItemCondition[] conditionsIn, List<ResourceLocation> targets, IntProvider count, float chance, boolean replace) {
		super(conditionsIn);
