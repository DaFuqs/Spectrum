...
public class BlockPosEventTransferParticle extends SpriteBillboardParticle {
	
	private final BlockPosEventTransfer blockPosEventTransfer;
	private float field_28250;
	private float field_28248;
	
	public BlockPosEventTransferParticle(ClientWorld clientWorld, BlockPosEventTransfer blockPosEventTransfer, int maxAge) {
		super(clientWorld, ((float) blockPosEventTransfer.getOrigin().getX() + 0.5F), ((float) blockPosEventTransfer.getOrigin().getY() + 0.5F), ((float) blockPosEventTransfer.getOrigin().getZ() + 0.5F), 0.0D, 0.0D, 0.0D);
		this.scale = 0.3F;
		this.blockPosEventTransfer = blockPosEventTransfer;
		this.maxAge = maxAge;
	}
