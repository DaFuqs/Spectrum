...
public class ExperienceTransferParticle extends SpriteBillboardParticle {
	
	private final ExperienceTransfer experienceTransfer;
	private float field_28250;
	private float field_28248;
	
	public ExperienceTransferParticle(ClientWorld clientWorld, ExperienceTransfer experienceTransfer, int i) {
		super(clientWorld, ((float) experienceTransfer.getOrigin().getX() + 0.5F), ((float) experienceTransfer.getOrigin().getY() + 0.5F), ((float) experienceTransfer.getOrigin().getZ() + 0.5F), 0.0D, 0.0D, 0.0D);
		this.scale = 0.3F;
