...
public class MoonstoneStrikeParticle extends NoRenderParticle {
	...
	public void tick() {
		...
		ParticleHelper.playParticleWithPatternAndVelocityClient(this.world, new Vec3d(this.x, this.y, this.z), SpectrumParticleTypes.SHOOTING_STAR, VectorPattern.EIGHT, 0.5F);
