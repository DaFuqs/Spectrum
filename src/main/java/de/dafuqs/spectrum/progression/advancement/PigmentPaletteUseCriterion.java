...
public class PigmentPaletteUseCriterion extends AbstractCriterion<PigmentPaletteUseCriterion.Conditions> {
	...
	public PigmentPaletteUseCriterion.Conditions conditionsFromJson(JsonObject jsonObject, EntityPredicate.Extended extended, AdvancementEntityPredicateDeserializer advancementEntityPredicateDeserializer) {
		...
		return new PigmentPaletteUseCriterion.Conditions(extended, blackRange, cyanRange, magentaRange, whiteRange, yellowRange, changeRange);
	}
	...
	public static PigmentPaletteUseCriterion.@NotNull Conditions create(LongRange blackRange, LongRange cyanRange, LongRange magentaRange, LongRange whiteRange, LongRange yellowRange, LongRange changeRange) {
		return new PigmentPaletteUseCriterion.Conditions(EntityPredicate.Extended.EMPTY, blackRange, cyanRange, magentaRange, whiteRange, yellowRange, changeRange);
	}
