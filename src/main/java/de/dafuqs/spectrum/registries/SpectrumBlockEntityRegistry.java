...
import de.dafuqs.spectrum.blocks.particle_spawner.ParticleSpawnerBlockEntityRenderer;
...
public class SpectrumBlockEntityRegistry<T extends BlockEntity> {
    ...
    public static void registerClient() {
        ...
        BlockEntityRendererRegistry.INSTANCE.register(SpectrumBlockEntityRegistry.PARTICLE_SPAWNER, ParticleSpawnerBlockEntityRenderer::new);
    ...
    public static void registerTextureAtlasCallback() {
        ...
        ClientSpriteRegistryCallback.event(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE).register((texture, registry) -> {
            registry.register(new Identifier(SpectrumCommon.MOD_ID, "entity/particle_spawner"));
        });
    }
