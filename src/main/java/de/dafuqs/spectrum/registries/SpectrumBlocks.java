...
public class SpectrumBlocks {
	...
	// CRYSTALLARIEUM
	public static final Block SMALL_COAL_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.COAL_BLOCK.getDefaultMapColor()).requiresTool());
	public static final Block MEDIUM_COAL_BUD = new Block(FabricBlockSettings.copyOf(SMALL_COAL_BUD));
	public static final Block LARGE_COAL_BUD = new Block(FabricBlockSettings.copyOf(SMALL_COAL_BUD));
	public static final Block COAL_CLUSTER = new Block(FabricBlockSettings.copyOf(SMALL_COAL_BUD));
	public static final Block SMALL_COPPER_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.COPPER_BLOCK.getDefaultMapColor()).requiresTool());
	public static final Block MEDIUM_COPPER_BUD = new Block(FabricBlockSettings.copyOf(SMALL_COPPER_BUD));
	public static final Block LARGE_COPPER_BUD = new Block(FabricBlockSettings.copyOf(SMALL_COPPER_BUD));
	public static final Block COPPER_CLUSTER = new Block(FabricBlockSettings.copyOf(SMALL_COPPER_BUD));
	public static final Block SMALL_DIAMOND_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.DIAMOND_BLOCK.getDefaultMapColor()).requiresTool());
	public static final Block MEDIUM_DIAMOND_BUD = new Block(FabricBlockSettings.copyOf(SMALL_DIAMOND_BUD));
	public static final Block LARGE_DIAMOND_BUD = new Block(FabricBlockSettings.copyOf(SMALL_DIAMOND_BUD));
	public static final Block DIAMOND_CLUSTER = new Block(FabricBlockSettings.copyOf(SMALL_DIAMOND_BUD));
	public static final Block SMALL_EMERALD_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.EMERALD_BLOCK.getDefaultMapColor()).requiresTool());
	public static final Block MEDIUM_EMERALD_BUD = new Block(FabricBlockSettings.copyOf(SMALL_EMERALD_BUD));
	public static final Block LARGE_EMERALD_BUD = new Block(FabricBlockSettings.copyOf(SMALL_EMERALD_BUD));
	public static final Block EMERALD_CLUSTER = new Block(FabricBlockSettings.copyOf(SMALL_EMERALD_BUD));
	public static final Block SMALL_GLOWSTONE_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.GLOWSTONE.getDefaultMapColor()).requiresTool());
	public static final Block MEDIUM_GLOWSTONE_BUD = new Block(FabricBlockSettings.copyOf(SMALL_GLOWSTONE_BUD));
	public static final Block LARGE_GLOWSTONE_BUD = new Block(FabricBlockSettings.copyOf(SMALL_GLOWSTONE_BUD));
	public static final Block GLOWSTONE_CLUSTER = new Block(FabricBlockSettings.copyOf(SMALL_GLOWSTONE_BUD));
	public static final Block SMALL_GOLD_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.GOLD_BLOCK.getDefaultMapColor()).requiresTool());
	public static final Block MEDIUM_GOLD_BUD = new Block(FabricBlockSettings.copyOf(SMALL_GOLD_BUD));
	public static final Block LARGE_GOLD_BUD = new Block(FabricBlockSettings.copyOf(SMALL_GOLD_BUD));
	public static final Block GOLD_CLUSTER = new Block(FabricBlockSettings.copyOf(SMALL_GOLD_BUD));
	public static final Block SMALL_IRON_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.IRON_BLOCK.getDefaultMapColor()).requiresTool());
	public static final Block MEDIUM_IRON_BUD = new Block(FabricBlockSettings.copyOf(SMALL_IRON_BUD));
	public static final Block LARGE_IRON_BUD = new Block(FabricBlockSettings.copyOf(SMALL_IRON_BUD));
	public static final Block IRON_CLUSTER = new Block(FabricBlockSettings.copyOf(SMALL_IRON_BUD));
	public static final Block SMALL_LAPIS_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.LAPIS_BLOCK.getDefaultMapColor()).requiresTool());
	public static final Block MEDIUM_LAPIS_BUD = new Block(FabricBlockSettings.copyOf(SMALL_LAPIS_BUD));
	public static final Block LARGE_LAPIS_BUD = new Block(FabricBlockSettings.copyOf(SMALL_LAPIS_BUD));
	public static final Block LAPIS_CLUSTER = new Block(FabricBlockSettings.copyOf(SMALL_LAPIS_BUD));
	public static final Block SMALL_NETHERITE_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.NETHERITE_BLOCK.getDefaultMapColor()).requiresTool());
	public static final Block MEDIUM_NETHERITE_BUD = new Block(FabricBlockSettings.copyOf(SMALL_NETHERITE_BUD));
	public static final Block LARGE_NETHERITE_BUD = new Block(FabricBlockSettings.copyOf(SMALL_NETHERITE_BUD));
	public static final Block NETHERITE_CLUSTER = new Block(FabricBlockSettings.copyOf(SMALL_NETHERITE_BUD));
	public static final Block SMALL_PRISMARINE_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.PRISMARINE_BRICKS.getDefaultMapColor()).requiresTool());
	public static final Block MEDIUM_PRISMARINE_BUD = new Block(FabricBlockSettings.copyOf(SMALL_PRISMARINE_BUD));
	public static final Block LARGE_PRISMARINE_BUD = new Block(FabricBlockSettings.copyOf(SMALL_PRISMARINE_BUD));
	public static final Block PRISMARINE_CLUSTER = new Block(FabricBlockSettings.copyOf(SMALL_PRISMARINE_BUD));
	public static final Block SMALL_QUARTZ_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.QUARTZ_BLOCK.getDefaultMapColor()).requiresTool());
	public static final Block MEDIUM_QUARTZ_BUD = new Block(FabricBlockSettings.copyOf(SMALL_QUARTZ_BUD));
	public static final Block LARGE_QUARTZ_BUD = new Block(FabricBlockSettings.copyOf(SMALL_QUARTZ_BUD));
	public static final Block QUARTZ_CLUSTER = new Block(FabricBlockSettings.copyOf(SMALL_QUARTZ_BUD));
	public static final Block SMALL_REDSTONE_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.REDSTONE_BLOCK.getDefaultMapColor()).requiresTool());
	public static final Block MEDIUM_REDSTONE_BUD = new Block(FabricBlockSettings.copyOf(SMALL_REDSTONE_BUD));
	public static final Block LARGE_REDSTONE_BUD = new Block(FabricBlockSettings.copyOf(SMALL_REDSTONE_BUD));
	public static final Block REDSTONE_CLUSTER = new Block(FabricBlockSettings.copyOf(SMALL_REDSTONE_BUD));
	public static final Block SMALL_CERTUS_QUARTZ_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(MapColor.TERRACOTTA_WHITE).requiresTool());
	public static final Block MEDIUM_CERTUS_QUARTZ_BUD = new Block(FabricBlockSettings.copyOf(SMALL_CERTUS_QUARTZ_BUD));
	public static final Block LARGE_CERTUS_QUARTZ_BUD = new Block(FabricBlockSettings.copyOf(SMALL_CERTUS_QUARTZ_BUD));
	public static final Block CERTUS_QUARTZ_CLUSTER = new Block(FabricBlockSettings.copyOf(SMALL_CERTUS_QUARTZ_BUD));
	public static final Block SMALL_FLUIX_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.PURPLE_CONCRETE.getDefaultMapColor()).requiresTool());
	public static final Block MEDIUM_FLUIX_BUD = new Block(FabricBlockSettings.copyOf(SMALL_FLUIX_BUD));
	public static final Block LARGE_FLUIX_BUD = new Block(FabricBlockSettings.copyOf(SMALL_FLUIX_BUD));
	public static final Block FLUIX_CLUSTER = new Block(FabricBlockSettings.copyOf(SMALL_FLUIX_BUD));
	public static final Block SMALL_GLOBETTE_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.BLUE_CONCRETE.getDefaultMapColor()).requiresTool());
	public static final Block MEDIUM_GLOBETTE_BUD = new Block(FabricBlockSettings.copyOf(SMALL_GLOBETTE_BUD));
	public static final Block LARGE_GLOBETTE_BUD = new Block(FabricBlockSettings.copyOf(SMALL_GLOBETTE_BUD));
	public static final Block GLOBETTE_CLUSTER = new Block(FabricBlockSettings.copyOf(SMALL_GLOBETTE_BUD));
	public static final Block SMALL_GLOBETTE_NETHER_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.RED_CONCRETE.getDefaultMapColor()).requiresTool());
	public static final Block MEDIUM_GLOBETTE_NETHER_BUD = new Block(FabricBlockSettings.copyOf(SMALL_GLOBETTE_NETHER_BUD));
	public static final Block LARGE_GLOBETTE_NETHER_BUD = new Block(FabricBlockSettings.copyOf(SMALL_GLOBETTE_NETHER_BUD));
	public static final Block GLOBETTE_NETHER_CLUSTER = new Block(FabricBlockSettings.copyOf(SMALL_GLOBETTE_NETHER_BUD));
	public static final Block SMALL_GLOBETTE_END_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.GREEN_CONCRETE.getDefaultMapColor()).requiresTool());
	public static final Block MEDIUM_GLOBETTE_END_BUD = new Block(FabricBlockSettings.copyOf(SMALL_GLOBETTE_END_BUD));
	public static final Block LARGE_GLOBETTE_END_BUD = new Block(FabricBlockSettings.copyOf(SMALL_GLOBETTE_END_BUD));
	public static final Block GLOBETTE_END_CLUSTER = new Block(FabricBlockSettings.copyOf(SMALL_GLOBETTE_END_BUD));
