...
public class SpectrumBlocks {
	...
	public static final DeferredBlock<Block> SEMI_PERMEABLE_GLASS = register(parented(blockWithItem("semi_permeable_glass", () -> new SemiPermeableGlassBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GLASS), Blocks.GLASS, false), InkColors.WHITE), b -> Blocks.GLASS));
	public static final DeferredBlock<Block> TINTED_SEMI_PERMEABLE_GLASS = register(parented(blockWithItem("tinted_semi_permeable_glass", () -> new SemiPermeableGlassBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.TINTED_GLASS), Blocks.TINTED_GLASS, true), InkColors.BLACK), b -> Blocks.TINTED_GLASS));
	public static final DeferredBlock<Block> RADIANT_SEMI_PERMEABLE_GLASS = register(parented(blockWithItem("radiant_semi_permeable_glass", () -> new SemiPermeableGlassBlock(BlockBehaviour.Properties.ofFullCopy(RADIANT_GLASS.get()), RADIANT_GLASS.get(), false), InkColors.YELLOW), b -> RADIANT_GLASS.get()));
	public static final DeferredBlock<Block> TOPAZ_SEMI_PERMEABLE_GLASS = register(parented(blockWithItem("topaz_semi_permeable_glass", () -> new SemiPermeableGemstoneGlassBlock(BlockBehaviour.Properties.ofFullCopy(TOPAZ_GLASS.get()), BuiltinGemstoneColor.CYAN), InkColors.CYAN), b -> TOPAZ_GLASS.get()));
	public static final DeferredBlock<Block> AMETHYST_SEMI_PERMEABLE_GLASS = register(parented(blockWithItem("amethyst_semi_permeable_glass", () -> new SemiPermeableGemstoneGlassBlock(BlockBehaviour.Properties.ofFullCopy(AMETHYST_GLASS.get()), BuiltinGemstoneColor.MAGENTA), InkColors.MAGENTA), b -> AMETHYST_GLASS.get()));
	public static final DeferredBlock<Block> CITRINE_SEMI_PERMEABLE_GLASS = register(parented(blockWithItem("citrine_semi_permeable_glass", () -> new SemiPermeableGemstoneGlassBlock(BlockBehaviour.Properties.ofFullCopy(CITRINE_GLASS.get()), BuiltinGemstoneColor.YELLOW), InkColors.YELLOW), b -> CITRINE_GLASS.get()));
	public static final DeferredBlock<Block> ONYX_SEMI_PERMEABLE_GLASS = register(parented(blockWithItem("onyx_semi_permeable_glass", () -> new SemiPermeableGemstoneGlassBlock(BlockBehaviour.Properties.ofFullCopy(ONYX_GLASS.get()), BuiltinGemstoneColor.BLACK), InkColors.BLACK), b -> ONYX_GLASS.get()));
	public static final DeferredBlock<Block> MOONSTONE_SEMI_PERMEABLE_GLASS = register(parented(blockWithItem("moonstone_semi_permeable_glass", () -> new SemiPermeableGemstoneGlassBlock(BlockBehaviour.Properties.ofFullCopy(MOONSTONE_GLASS.get()), BuiltinGemstoneColor.WHITE), InkColors.WHITE), b -> MOONSTONE_GLASS.get()));
	...
	public static final DeferredBlock<Block> PURE_AZURITE_BLOCK = register(defaultUpFacing(blockWithItem("pure_azurite_block", () -> new SpectrumFacingBlock(BlockBehaviour.Properties.ofFullCopy(LAPIS_BLOCK).mapColor(MapColor.COLOR_BLUE)), InkColors.BLUE), TexturedModel.CUBE_TOP_BOTTOM));
	...
	public static final DeferredBlock<Block> PURE_MALACHITE_BLOCK = register(defaultUpFacing(blockWithItem("pure_malachite_block", () -> new SpectrumFacingBlock(gemstoneBlock(MapColor.EMERALD, SoundType.CHAIN)), () -> IS.of(Rarity.UNCOMMON), InkColors.GREEN), TexturedModel.COLUMN_ALT));
	...
	public static final DeferredBlock<Block> PURE_BLOODSTONE_BLOCK = register(defaultUpFacing(blockWithItem("pure_bloodstone_block", () -> new SpectrumFacingBlock(gemstoneBlock(MapColor.COLOR_RED, SpectrumSoundTypes.ONYX_CLUSTER)), () -> IS.of(Rarity.UNCOMMON), InkColors.RED), TexturedModel.COLUMN));
	...
	public static DeferredBlock<ColoredLogBlock> registerColoredLog(String name, Supplier<? extends ColoredStrippedSpectrumLogBlock> strippedBlock, InkColor color, ResourceKey<LootTable> strippingLootTableKey) {
		return register(log(blockWithItem(name, () -> new ColoredLogBlock(copyWithMapColor(OAK_LOG, color.getDyeColor().orElse(DyeColor.LIME).getMapColor()), strippedBlock, color, strippingLootTableKey), color)));
	}
	...
	public static DeferredBlock<ColoredWoodBlock> registerColoredWood(String name, Supplier<? extends ColoredStrippedWoodBlockSpectrum> strippedBlock, DeferredBlock<ColoredLogBlock> logBlock, InkColor color, ResourceKey<LootTable> strippingLootTableKey) {
		return register(blockWithItem(name, () -> new ColoredWoodBlock(copyWithMapColor(OAK_WOOD, logBlock.get().defaultMapColor()), strippedBlock, color, strippingLootTableKey), color));
	}
	...
	public static final DeferredBlock<Block> SLUDGE_CAULDRON = register(simple(block("sludge_cauldron", () -> new SpectrumCauldronBlock(SpectrumFluids.SLUDGE, CauldronInteraction.newInteractionMap(SpectrumCauldronInteractions.SLUDGE_INTERACTION), BlockBehaviour.Properties.ofFullCopy(Blocks.CAULDRON)))));
	...
	public static final DeferredBlock<Block> AZURITE_BRICKS = register(simple(blockWithItem("azurite_bricks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(PURE_AZURITE_BLOCK.get())), InkColors.BLUE)));
	public static final DeferredBlock<Block> MALACHITE_BRICKS = register(simple(blockWithItem("malachite_bricks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(PURE_MALACHITE_BLOCK.get())), InkColors.GREEN)));
	public static final DeferredBlock<Block> BLOODSTONE_BRICKS = register(simple(blockWithItem("bloodstone_bricks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(PURE_BLOODSTONE_BLOCK.get())), InkColors.RED)));
	public static final DeferredBlock<Block> MIXED_REFINED_CRYSTAL_BRICKS = register(simple(blockWithItem("mixed_refined_crystal_bricks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(PURE_AZURITE_BLOCK.get())), InkColors.BLUE)));
