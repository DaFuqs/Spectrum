...
public class SpectrumBlocks {
	...
	public static final Block PRESERVATION_CONTROLLER = new PreservationControllerBlock(FabricBlockSettings.of(Material.STONE).strength(-1.0F).dropsNothing().luminance(value -> 1).emissiveLighting(SpectrumBlocks::always).postProcess(SpectrumBlocks::always));
	public static final Block DIKE_GATE = new DikeGateBlock(FabricBlockSettings.of(Material.GLASS).strength(-1.0F).dropsNothing().luminance(value -> 3).sounds(BlockSoundGroup.GLASS).nonOpaque().allowsSpawning(SpectrumBlocks::never).solidBlock(SpectrumBlocks::never).suffocates(SpectrumBlocks::never).blockVision(SpectrumBlocks::never));
	...
	public static final Block STUCK_LIGHTNING_STONE = new LightningStoneBlock(FabricBlockSettings.of(Material.SNOW_LAYER, MapColor.PALE_YELLOW).noCollision().breakInstantly().sounds(BlockSoundGroup.SMALL_AMETHYST_BUD));
	public static final Block DEEPER_DOWN_PORTAL = new DeeperDownPortalBlock(FabricBlockSettings.copyOf(Blocks.END_PORTAL));
	
	public static final Block UPGRADE_SPEED = new UpgradeBlock(FabricBlockSettings.copyOf(SpectrumBlocks.POLISHED_BASALT), Upgradeable.UpgradeType.SPEED, 0.5F);
	public static final Block UPGRADE_SPEED2 = new UpgradeBlock(FabricBlockSettings.copyOf(SpectrumBlocks.POLISHED_BASALT), Upgradeable.UpgradeType.SPEED, 2.0F);
	public static final Block UPGRADE_SPEED3 = new UpgradeBlock(FabricBlockSettings.copyOf(SpectrumBlocks.POLISHED_BASALT), Upgradeable.UpgradeType.SPEED, 8.0F);
	public static final Block UPGRADE_EFFICIENCY = new UpgradeBlock(FabricBlockSettings.copyOf(SpectrumBlocks.POLISHED_BASALT), Upgradeable.UpgradeType.EFFICIENCY, 0.05F);
	public static final Block UPGRADE_EFFICIENCY2 = new UpgradeBlock(FabricBlockSettings.copyOf(SpectrumBlocks.POLISHED_BASALT), Upgradeable.UpgradeType.EFFICIENCY, 0.25F);
	public static final Block UPGRADE_YIELD = new UpgradeBlock(FabricBlockSettings.copyOf(SpectrumBlocks.POLISHED_BASALT), Upgradeable.UpgradeType.YIELD, 0.05F);
	public static final Block UPGRADE_YIELD2 = new UpgradeBlock(FabricBlockSettings.copyOf(SpectrumBlocks.POLISHED_BASALT), Upgradeable.UpgradeType.YIELD, 0.25F);
	public static final Block UPGRADE_EXPERIENCE = new UpgradeBlock(FabricBlockSettings.copyOf(SpectrumBlocks.POLISHED_BASALT), Upgradeable.UpgradeType.EXPERIENCE, 1.0F);
	public static final Block UPGRADE_EXPERIENCE2 = new UpgradeBlock(FabricBlockSettings.copyOf(SpectrumBlocks.POLISHED_BASALT), Upgradeable.UpgradeType.EXPERIENCE, 4.0F);
	...
	public static void register() {
		...
		registerBlockWithItem("radiating_ender", RADIATING_ENDER, worldgenItemSettings, DyeColor.PURPLE);
	...
	private static void registerOreBlocks(FabricItemSettings fabricItemSettings, FabricItemSettings fabricItemSettingsFireProof) {
		...
		registerBlockWithItem("stratine_ore", STRATINE_ORE, new FloatBlockItem(STRATINE_ORE, fabricItemSettingsFireProof, 1.01F), DyeColor.RED);
		registerBlockWithItem("paltaeria_ore", PALETUR_ORE, new FloatBlockItem(PALETUR_ORE, fabricItemSettings, 0.99F), DyeColor.CYAN);
	...
	private static void registerPlayerOnlyGlass(FabricItemSettings fabricItemSettings) {
		registerBlockWithItem("vanilla_semi_permeable_glass", VANILLA_SEMI_PERMEABLE_GLASS, fabricItemSettings, DyeColor.WHITE);
		registerBlockWithItem("tinted_semi_permeable_glass", TINTED_SEMI_PERMEABLE_GLASS, fabricItemSettings, DyeColor.BLACK);
		registerBlockWithItem("glowing_semi_permeable_glass", RADIANT_SEMI_PERMEABLE_GLASS, fabricItemSettings, DyeColor.YELLOW);
		
		registerBlockWithItem("topaz_semi_permeable_glass", TOPAZ_SEMI_PERMEABLE_GLASS, fabricItemSettings, DyeColor.CYAN);
		registerBlockWithItem("amethyst_semi_permeable_glass", AMETHYST_SEMI_PERMEABLE_GLASS, fabricItemSettings, DyeColor.MAGENTA);
		registerBlockWithItem("citrine_semi_permeable_glass", CITRINE_SEMI_PERMEABLE_GLASS, fabricItemSettings, DyeColor.YELLOW);
		registerBlockWithItem("onyx_semi_permeable_glass", ONYX_SEMI_PERMEABLE_GLASS, fabricItemSettings, DyeColor.BLACK);
		registerBlockWithItem("moonstone_semi_permeable_glass", MOONSTONE_SEMI_PERMEABLE_GLASS, fabricItemSettings, DyeColor.WHITE);
	}
	...
	private static void registerColoredWood(FabricItemSettings fabricItemSettings) {
		...
		registerBlockWithItem("white_stairs", WHITE_STAIRS, fabricItemSettings, DyeColor.WHITE);
		registerBlockWithItem("orange_stairs", ORANGE_STAIRS, fabricItemSettings, DyeColor.ORANGE);
		registerBlockWithItem("magenta_stairs", MAGENTA_STAIRS, fabricItemSettings, DyeColor.MAGENTA);
		registerBlockWithItem("light_blue_stairs", LIGHT_BLUE_STAIRS, fabricItemSettings, DyeColor.LIGHT_BLUE);
		registerBlockWithItem("yellow_stairs", YELLOW_STAIRS, fabricItemSettings, DyeColor.YELLOW);
		registerBlockWithItem("lime_stairs", LIME_STAIRS, fabricItemSettings, DyeColor.LIME);
		registerBlockWithItem("pink_stairs", PINK_STAIRS, fabricItemSettings, DyeColor.PINK);
		registerBlockWithItem("gray_stairs", GRAY_STAIRS, fabricItemSettings, DyeColor.GRAY);
		registerBlockWithItem("light_gray_stairs", LIGHT_GRAY_STAIRS, fabricItemSettings, DyeColor.LIGHT_GRAY);
		registerBlockWithItem("cyan_stairs", CYAN_STAIRS, fabricItemSettings, DyeColor.CYAN);
		registerBlockWithItem("purple_stairs", PURPLE_STAIRS, fabricItemSettings, DyeColor.PURPLE);
		registerBlockWithItem("blue_stairs", BLUE_STAIRS, fabricItemSettings, DyeColor.BLUE);
		registerBlockWithItem("brown_stairs", BROWN_STAIRS, fabricItemSettings, DyeColor.BROWN);
		registerBlockWithItem("green_stairs", GREEN_STAIRS, fabricItemSettings, DyeColor.GREEN);
		registerBlockWithItem("red_stairs", RED_STAIRS, fabricItemSettings, DyeColor.RED);
		registerBlockWithItem("black_stairs", BLACK_STAIRS, fabricItemSettings, DyeColor.BLACK);
		
		registerBlockWithItem("white_pressure_plate", WHITE_PRESSURE_PLATE, fabricItemSettings, DyeColor.WHITE);
		registerBlockWithItem("orange_pressure_plate", ORANGE_PRESSURE_PLATE, fabricItemSettings, DyeColor.ORANGE);
		registerBlockWithItem("magenta_pressure_plate", MAGENTA_PRESSURE_PLATE, fabricItemSettings, DyeColor.MAGENTA);
		registerBlockWithItem("light_blue_pressure_plate", LIGHT_BLUE_PRESSURE_PLATE, fabricItemSettings, DyeColor.LIGHT_BLUE);
		registerBlockWithItem("yellow_pressure_plate", YELLOW_PRESSURE_PLATE, fabricItemSettings, DyeColor.YELLOW);
		registerBlockWithItem("lime_pressure_plate", LIME_PRESSURE_PLATE, fabricItemSettings, DyeColor.LIME);
		registerBlockWithItem("pink_pressure_plate", PINK_PRESSURE_PLATE, fabricItemSettings, DyeColor.PINK);
		registerBlockWithItem("gray_pressure_plate", GRAY_PRESSURE_PLATE, fabricItemSettings, DyeColor.GRAY);
		registerBlockWithItem("light_gray_pressure_plate", LIGHT_GRAY_PRESSURE_PLATE, fabricItemSettings, DyeColor.LIGHT_GRAY);
		registerBlockWithItem("cyan_pressure_plate", CYAN_PRESSURE_PLATE, fabricItemSettings, DyeColor.CYAN);
		registerBlockWithItem("purple_pressure_plate", PURPLE_PRESSURE_PLATE, fabricItemSettings, DyeColor.PURPLE);
		registerBlockWithItem("blue_pressure_plate", BLUE_PRESSURE_PLATE, fabricItemSettings, DyeColor.BLUE);
		registerBlockWithItem("brown_pressure_plate", BROWN_PRESSURE_PLATE, fabricItemSettings, DyeColor.BROWN);
		registerBlockWithItem("green_pressure_plate", GREEN_PRESSURE_PLATE, fabricItemSettings, DyeColor.GREEN);
		registerBlockWithItem("red_pressure_plate", RED_PRESSURE_PLATE, fabricItemSettings, DyeColor.RED);
		registerBlockWithItem("black_pressure_plate", BLACK_PRESSURE_PLATE, fabricItemSettings, DyeColor.BLACK);
		
		registerBlockWithItem("white_fence", WHITE_FENCE, fabricItemSettings, DyeColor.WHITE);
		registerBlockWithItem("orange_fence", ORANGE_FENCE, fabricItemSettings, DyeColor.ORANGE);
		registerBlockWithItem("magenta_fence", MAGENTA_FENCE, fabricItemSettings, DyeColor.MAGENTA);
		registerBlockWithItem("light_blue_fence", LIGHT_BLUE_FENCE, fabricItemSettings, DyeColor.LIGHT_BLUE);
		registerBlockWithItem("yellow_fence", YELLOW_FENCE, fabricItemSettings, DyeColor.YELLOW);
		registerBlockWithItem("lime_fence", LIME_FENCE, fabricItemSettings, DyeColor.LIME);
		registerBlockWithItem("pink_fence", PINK_FENCE, fabricItemSettings, DyeColor.PINK);
		registerBlockWithItem("gray_fence", GRAY_FENCE, fabricItemSettings, DyeColor.GRAY);
		registerBlockWithItem("light_gray_fence", LIGHT_GRAY_FENCE, fabricItemSettings, DyeColor.LIGHT_GRAY);
		registerBlockWithItem("cyan_fence", CYAN_FENCE, fabricItemSettings, DyeColor.CYAN);
		registerBlockWithItem("purple_fence", PURPLE_FENCE, fabricItemSettings, DyeColor.PURPLE);
		registerBlockWithItem("blue_fence", BLUE_FENCE, fabricItemSettings, DyeColor.BLUE);
		registerBlockWithItem("brown_fence", BROWN_FENCE, fabricItemSettings, DyeColor.BROWN);
		registerBlockWithItem("green_fence", GREEN_FENCE, fabricItemSettings, DyeColor.GREEN);
		registerBlockWithItem("red_fence", RED_FENCE, fabricItemSettings, DyeColor.RED);
		registerBlockWithItem("black_fence", BLACK_FENCE, fabricItemSettings, DyeColor.BLACK);
		
		registerBlockWithItem("white_fence_gate", WHITE_FENCE_GATE, fabricItemSettings, DyeColor.WHITE);
		registerBlockWithItem("orange_fence_gate", ORANGE_FENCE_GATE, fabricItemSettings, DyeColor.ORANGE);
		registerBlockWithItem("magenta_fence_gate", MAGENTA_FENCE_GATE, fabricItemSettings, DyeColor.MAGENTA);
		registerBlockWithItem("light_blue_fence_gate", LIGHT_BLUE_FENCE_GATE, fabricItemSettings, DyeColor.LIGHT_BLUE);
		registerBlockWithItem("yellow_fence_gate", YELLOW_FENCE_GATE, fabricItemSettings, DyeColor.YELLOW);
		registerBlockWithItem("lime_fence_gate", LIME_FENCE_GATE, fabricItemSettings, DyeColor.LIME);
		registerBlockWithItem("pink_fence_gate", PINK_FENCE_GATE, fabricItemSettings, DyeColor.PINK);
		registerBlockWithItem("gray_fence_gate", GRAY_FENCE_GATE, fabricItemSettings, DyeColor.GRAY);
		registerBlockWithItem("light_gray_fence_gate", LIGHT_GRAY_FENCE_GATE, fabricItemSettings, DyeColor.LIGHT_GRAY);
		registerBlockWithItem("cyan_fence_gate", CYAN_FENCE_GATE, fabricItemSettings, DyeColor.CYAN);
		registerBlockWithItem("purple_fence_gate", PURPLE_FENCE_GATE, fabricItemSettings, DyeColor.PURPLE);
		registerBlockWithItem("blue_fence_gate", BLUE_FENCE_GATE, fabricItemSettings, DyeColor.BLUE);
		registerBlockWithItem("brown_fence_gate", BROWN_FENCE_GATE, fabricItemSettings, DyeColor.BROWN);
		registerBlockWithItem("green_fence_gate", GREEN_FENCE_GATE, fabricItemSettings, DyeColor.GREEN);
		registerBlockWithItem("red_fence_gate", RED_FENCE_GATE, fabricItemSettings, DyeColor.RED);
		registerBlockWithItem("black_fence_gate", BLACK_FENCE_GATE, fabricItemSettings, DyeColor.BLACK);
		
		registerBlockWithItem("white_button", WHITE_BUTTON, fabricItemSettings, DyeColor.WHITE);
		registerBlockWithItem("orange_button", ORANGE_BUTTON, fabricItemSettings, DyeColor.ORANGE);
		registerBlockWithItem("magenta_button", MAGENTA_BUTTON, fabricItemSettings, DyeColor.MAGENTA);
		registerBlockWithItem("light_blue_button", LIGHT_BLUE_BUTTON, fabricItemSettings, DyeColor.LIGHT_BLUE);
		registerBlockWithItem("yellow_button", YELLOW_BUTTON, fabricItemSettings, DyeColor.YELLOW);
		registerBlockWithItem("lime_button", LIME_BUTTON, fabricItemSettings, DyeColor.LIME);
		registerBlockWithItem("pink_button", PINK_BUTTON, fabricItemSettings, DyeColor.PINK);
		registerBlockWithItem("gray_button", GRAY_BUTTON, fabricItemSettings, DyeColor.GRAY);
		registerBlockWithItem("light_gray_button", LIGHT_GRAY_BUTTON, fabricItemSettings, DyeColor.LIGHT_GRAY);
		registerBlockWithItem("cyan_button", CYAN_BUTTON, fabricItemSettings, DyeColor.CYAN);
		registerBlockWithItem("purple_button", PURPLE_BUTTON, fabricItemSettings, DyeColor.PURPLE);
		registerBlockWithItem("blue_button", BLUE_BUTTON, fabricItemSettings, DyeColor.BLUE);
		registerBlockWithItem("brown_button", BROWN_BUTTON, fabricItemSettings, DyeColor.BROWN);
		registerBlockWithItem("green_button", GREEN_BUTTON, fabricItemSettings, DyeColor.GREEN);
		registerBlockWithItem("red_button", RED_BUTTON, fabricItemSettings, DyeColor.RED);
		registerBlockWithItem("black_button", BLACK_BUTTON, fabricItemSettings, DyeColor.BLACK);
		
		registerBlockWithItem("white_slab", WHITE_SLAB, fabricItemSettings, DyeColor.WHITE);
		registerBlockWithItem("orange_slab", ORANGE_SLAB, fabricItemSettings, DyeColor.ORANGE);
		registerBlockWithItem("magenta_slab", MAGENTA_SLAB, fabricItemSettings, DyeColor.MAGENTA);
		registerBlockWithItem("light_blue_slab", LIGHT_BLUE_SLAB, fabricItemSettings, DyeColor.LIGHT_BLUE);
		registerBlockWithItem("yellow_slab", YELLOW_SLAB, fabricItemSettings, DyeColor.YELLOW);
		registerBlockWithItem("lime_slab", LIME_SLAB, fabricItemSettings, DyeColor.LIME);
		registerBlockWithItem("pink_slab", PINK_SLAB, fabricItemSettings, DyeColor.PINK);
		registerBlockWithItem("gray_slab", GRAY_SLAB, fabricItemSettings, DyeColor.GRAY);
		registerBlockWithItem("light_gray_slab", LIGHT_GRAY_SLAB, fabricItemSettings, DyeColor.LIGHT_GRAY);
		registerBlockWithItem("cyan_slab", CYAN_SLAB, fabricItemSettings, DyeColor.CYAN);
		registerBlockWithItem("purple_slab", PURPLE_SLAB, fabricItemSettings, DyeColor.PURPLE);
		registerBlockWithItem("blue_slab", BLUE_SLAB, fabricItemSettings, DyeColor.BLUE);
		registerBlockWithItem("brown_slab", BROWN_SLAB, fabricItemSettings, DyeColor.BROWN);
		registerBlockWithItem("green_slab", GREEN_SLAB, fabricItemSettings, DyeColor.GREEN);
		registerBlockWithItem("red_slab", RED_SLAB, fabricItemSettings, DyeColor.RED);
		registerBlockWithItem("black_slab", BLACK_SLAB, fabricItemSettings, DyeColor.BLACK);
	}
