...
public class SpectrumBlocks {
	...
	public static final Block PEDESTAL_BASIC_TOPAZ = register(pedestal(blockWithItem("pedestal_basic_topaz", new PedestalBlock(craftingBlock(MapColor.DIAMOND, SpectrumBlockSoundGroups.TOPAZ_BLOCK), BuiltinPedestalVariant.BASIC_TOPAZ), block -> new PedestalBlockItem(block, IS.of(), BuiltinPedestalVariant.BASIC_TOPAZ, "item.spectrum.pedestal.tooltip.basic_topaz"), InkColors.WHITE)));
	...
	public static final Block PEDESTAL_BASIC_CITRINE = register(pedestal(blockWithItem("pedestal_basic_citrine", new PedestalBlock(craftingBlock(MapColor.COLOR_YELLOW, SpectrumBlockSoundGroups.CITRINE_BLOCK), BuiltinPedestalVariant.BASIC_CITRINE), block -> new PedestalBlockItem(block, IS.of(), BuiltinPedestalVariant.BASIC_CITRINE, "item.spectrum.pedestal.tooltip.basic_citrine"), InkColors.WHITE)));
	...
	public static final Block PEDESTAL_ONYX = register(pedestal(blockWithItem("pedestal_onyx", new PedestalBlock(craftingBlock(MapColor.COLOR_BLACK, SpectrumBlockSoundGroups.ONYX_BLOCK), BuiltinPedestalVariant.ONYX), block -> new PedestalBlockItem(block, IS.of(), BuiltinPedestalVariant.ONYX, "item.spectrum.pedestal.tooltip.onyx"), InkColors.WHITE)));
	public static final Block PEDESTAL_MOONSTONE = register(pedestal(blockWithItem("pedestal_moonstone", new PedestalBlock(craftingBlock(MapColor.SNOW, SpectrumBlockSoundGroups.MOONSTONE_BLOCK), BuiltinPedestalVariant.MOONSTONE), block -> new PedestalBlockItem(block, IS.of(), BuiltinPedestalVariant.MOONSTONE, "item.spectrum.pedestal.tooltip.moonstone"), InkColors.WHITE)));
	
	public static final Block FUSION_SHRINE_BASALT = register(cutout(singleton(blockWithItem("fusion_shrine_basalt", new FusionShrineBlock(craftingBlock(MapColor.COLOR_BLACK, SoundType.BASALT).lightLevel(value -> value.getValue(FusionShrineBlock.LIGHT_LEVEL))), IS.of(), InkColors.GRAY), SpectrumTexturedModels.FUSION_SHRINE)));
	public static final Block FUSION_SHRINE_CALCITE = register(cutout(singleton(blockWithItem("fusion_shrine_calcite", new FusionShrineBlock(craftingBlock(MapColor.TERRACOTTA_WHITE, SoundType.CALCITE).lightLevel(value -> value.getValue(FusionShrineBlock.LIGHT_LEVEL))), IS.of(), InkColors.GRAY), SpectrumTexturedModels.FUSION_SHRINE)));
	
	public static final Block ENCHANTER = register(cutout(singletonWithSoup(blockWithItem("enchanter", new EnchanterBlock(craftingBlock(MapColor.TERRACOTTA_WHITE, SoundType.CALCITE)), IS.of(), InkColors.PURPLE), ModelLocationUtils::getModelLocation)));
	public static final Block ITEM_BOWL_BASALT = register(cutout(singleton(blockWithItem("item_bowl_basalt", new ItemBowlBlock(craftingBlock(MapColor.COLOR_BLACK, SoundType.BASALT)), IS.of(), InkColors.PINK), TexturedModel.createDefault(b -> new TextureMapping().put(TextureSlot.TEXTURE, locate("block/item_bowl_basalt")).put(TextureSlot.SIDE, locate("block/polished_basalt_pillar_side")).put(SpectrumTextureKeys.BASE, locate("block/polished_basalt")), SpectrumModels.BOWL))));
	public static final Block ITEM_BOWL_CALCITE = register(cutout(singleton(blockWithItem("item_bowl_calcite", new ItemBowlBlock(craftingBlock(MapColor.TERRACOTTA_WHITE, SoundType.CALCITE)), IS.of(), InkColors.PINK), TexturedModel.createDefault(b -> new TextureMapping().put(TextureSlot.TEXTURE, locate("block/item_bowl_calcite")).put(TextureSlot.SIDE, locate("block/polished_calcite_pillar_side")).put(SpectrumTextureKeys.BASE, locate("block/polished_calcite")), SpectrumModels.BOWL))));
	public static final Block ITEM_ROUNDEL = register(singleton(blockWithItem("item_roundel", new ItemRoundelBlock(craftingBlock(MapColor.TERRACOTTA_WHITE, SoundType.CALCITE)), IS.of(), InkColors.PINK), SpectrumTexturedModels.ROUNDEL));
	public static final Block POTION_WORKSHOP = register(translucent(defaultNorthHorizontalFacing(blockWithItem("potion_workshop", new PotionWorkshopBlock(craftingBlock(MapColor.TERRACOTTA_WHITE, SoundType.CALCITE)), IS.of(), InkColors.PURPLE), ModelLocationUtils::getModelLocation)));
	public static final Block SPIRIT_INSTILLER = register(singletonWithSoup(cutout(blockWithItem("spirit_instiller", new SpiritInstillerBlock(craftingBlock(MapColor.TERRACOTTA_WHITE, SoundType.CALCITE)), IS.of(), InkColors.WHITE)), ModelLocationUtils::getModelLocation).withPredefinedItemModel());
	public static final CrystallarieumBlock CRYSTALLARIEUM = register(cutout(singletonWithSoup(blockWithItem("crystallarieum", new CrystallarieumBlock(craftingBlock(MapColor.TERRACOTTA_WHITE, SoundType.CALCITE)), IS.of(), InkColors.BROWN), ModelLocationUtils::getModelLocation)).withPredefinedItemModel());
	public static final Block CINDERHEARTH = register(defaultNorthHorizontalFacing(blockWithItem("cinderhearth", new CinderhearthBlock(craftingBlock(MapColor.TERRACOTTA_WHITE, SoundType.CALCITE)), IS.of().fireResistant(), InkColors.ORANGE), ModelLocationUtils::getModelLocation));
	
	public static final Block COLOR_PICKER = register(cutout(defaultWestHorizontalFacing(blockWithItem("color_picker", new ColorPickerBlock(craftingBlock(MapColor.TERRACOTTA_WHITE, SoundType.CALCITE)), IS.of(), InkColors.GREEN), ModelLocationUtils::getModelLocation)));
	public static final Block CRYSTAL_APOTHECARY = register(singletonWithSoup(blockWithItem("crystal_apothecary", new CrystalApothecaryBlock(craftingBlock(MapColor.TERRACOTTA_WHITE, SoundType.CALCITE)), IS.of(), InkColors.GREEN), (ModelLocationUtils::getModelLocation)));
	...
	public static <T extends SpectrumClusterBlock> BlockRegistrar<T> cluster(BlockRegistrar<T> registrar, ModelTemplate model) {
		return cutout(registrar).withBlockModel((ctx, block) -> MultiVariantGenerator.multiVariant(block, createModelVariant(TexturedModel.createDefault(TextureMapping::cross, model).create(block, ctx.modelOutput))).with(SpectrumModelHelper.createUpDefaultFacingVariantMap())).withBlockItemModel((ctx, block) -> {
	...
	public static final SpectrumGemstoneBlock TOPAZ_BLOCK = register(simple(blockWithItem("topaz_block", new SpectrumGemstoneBlock(gemstoneBlock(MapColor.COLOR_CYAN, SpectrumBlockSoundGroups.TOPAZ_BLOCK), SpectrumSoundEvents.BLOCK_TOPAZ_BLOCK_HIT, SpectrumSoundEvents.BLOCK_TOPAZ_BLOCK_CHIME), InkColors.CYAN)));
	...
	public static final SpectrumGemstoneBlock CITRINE_BLOCK = register(simple(blockWithItem("citrine_block", new SpectrumGemstoneBlock(gemstoneBlock(MapColor.COLOR_YELLOW, SpectrumBlockSoundGroups.CITRINE_BLOCK), SpectrumSoundEvents.BLOCK_CITRINE_BLOCK_HIT, SpectrumSoundEvents.BLOCK_CITRINE_BLOCK_CHIME), InkColors.YELLOW)));
	...
	public static final SpectrumGemstoneBlock ONYX_BLOCK = register(simple(blockWithItem("onyx_block", new SpectrumGemstoneBlock(gemstoneBlock(MapColor.COLOR_BLACK, SpectrumBlockSoundGroups.ONYX_BLOCK), SpectrumSoundEvents.BLOCK_ONYX_BLOCK_HIT, SpectrumSoundEvents.BLOCK_ONYX_BLOCK_CHIME), InkColors.BLACK)));
	...
	public static final SpectrumGemstoneBlock MOONSTONE_BLOCK = register(simple(blockWithItem("moonstone_block", new SpectrumGemstoneBlock(gemstoneBlock(MapColor.SNOW, SpectrumBlockSoundGroups.MOONSTONE_BLOCK), SpectrumSoundEvents.BLOCK_MOONSTONE_BLOCK_HIT, SpectrumSoundEvents.BLOCK_MOONSTONE_BLOCK_CHIME), InkColors.WHITE)));
	
	public static final ColoredFallingBlock TOPAZ_POWDER_BLOCK = register(simple(blockWithItem("topaz_powder_block", new ColoredFallingBlock(new ColorRGBA(DyeColor.CYAN.getFireworkColor()), BlockBehaviour.Properties.ofFullCopy(Blocks.SAND).mapColor(MapColor.COLOR_CYAN)), InkColors.CYAN)));
	public static final ColoredFallingBlock AMETHYST_POWDER_BLOCK = register(simple(blockWithItem("amethyst_powder_block", new ColoredFallingBlock(new ColorRGBA(DyeColor.MAGENTA.getFireworkColor()), BlockBehaviour.Properties.ofFullCopy(Blocks.SAND).mapColor(MapColor.COLOR_MAGENTA)), InkColors.MAGENTA)));
	public static final ColoredFallingBlock CITRINE_POWDER_BLOCK = register(simple(blockWithItem("citrine_powder_block", new ColoredFallingBlock(new ColorRGBA(DyeColor.YELLOW.getFireworkColor()), BlockBehaviour.Properties.ofFullCopy(Blocks.SAND).mapColor(MapColor.COLOR_YELLOW)), InkColors.YELLOW)));
	public static final ColoredFallingBlock ONYX_POWDER_BLOCK = register(simple(blockWithItem("onyx_powder_block", new ColoredFallingBlock(new ColorRGBA(DyeColor.BLACK.getFireworkColor()), BlockBehaviour.Properties.ofFullCopy(Blocks.SAND).mapColor(MapColor.COLOR_BLACK)), InkColors.BLACK)));
	public static final ColoredFallingBlock MOONSTONE_POWDER_BLOCK = register(simple(blockWithItem("moonstone_powder_block", new ColoredFallingBlock(new ColorRGBA(DyeColor.WHITE.getFireworkColor()), BlockBehaviour.Properties.ofFullCopy(Blocks.SAND).mapColor(MapColor.SNOW)), InkColors.WHITE)));
	...
	public static final Block NEOLITH_BLOCK = register(simple(blockWithItem("neolith_block", new Block(settings(MapColor.COLOR_PURPLE, SoundType.COPPER, 6.0F).requiresCorrectToolForDrops().instrument(NoteBlockInstrument.BASEDRUM).lightLevel(state -> 13).hasPostProcess(SpectrumBlocks::always).emissiveRendering(SpectrumBlocks::always)), InkColors.PINK)));
	...
	public static final Block BLACKSLAG_TILE_STAIRS = register(blockWithItem("blackslag_tile_stairs", new StairBlock(BLACKSLAG_TILES.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(BLACKSLAG_TILES)), InkColors.BLACK));
	public static final Block BLACKSLAG_TILE_SLAB = register(blockWithItem("blackslag_tile_slab", new SlabBlock(BlockBehaviour.Properties.ofFullCopy(BLACKSLAG_TILES)), InkColors.BLACK));
	public static final Block BLACKSLAG_TILE_WALL = register(blockWithItem("blackslag_tile_wall", new WallBlock(BlockBehaviour.Properties.ofFullCopy(BLACKSLAG_TILES)), InkColors.BLACK));
	public static final Block CRACKED_BLACKSLAG_TILES = register(blockWithItem("cracked_blackslag_tiles", new Block(BlockBehaviour.Properties.ofFullCopy(BLACKSLAG_TILES)), InkColors.BLACK));
	...
	public static final Block BLACKSLAG_BRICK_STAIRS = register(blockWithItem("blackslag_brick_stairs", new StairBlock(BLACKSLAG_BRICKS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(BLACKSLAG_BRICKS)), InkColors.BLACK));
	public static final Block BLACKSLAG_BRICK_SLAB = register(blockWithItem("blackslag_brick_slab", new SlabBlock(BlockBehaviour.Properties.ofFullCopy(BLACKSLAG_BRICKS)), InkColors.BLACK));
	public static final Block BLACKSLAG_BRICK_WALL = register(blockWithItem("blackslag_brick_wall", new WallBlock(BlockBehaviour.Properties.ofFullCopy(BLACKSLAG_BRICKS)), InkColors.BLACK));
	public static final Block CRACKED_BLACKSLAG_BRICKS = register(blockWithItem("cracked_blackslag_bricks", new Block(BlockBehaviour.Properties.ofFullCopy(BLACKSLAG_BRICKS)), InkColors.BLACK));
	...
	public static final Block POLISHED_BLACKSLAG_STAIRS = register(blockWithItem("polished_blackslag_stairs", new StairBlock(POLISHED_BLACKSLAG.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(POLISHED_BLACKSLAG)), InkColors.BLACK));
	public static final Block POLISHED_BLACKSLAG_SLAB = register(blockWithItem("polished_blackslag_slab", new SlabBlock(BlockBehaviour.Properties.ofFullCopy(POLISHED_BLACKSLAG)), InkColors.BLACK));
	public static final Block POLISHED_BLACKSLAG_WALL = register(blockWithItem("polished_blackslag_wall", new WallBlock(BlockBehaviour.Properties.ofFullCopy(POLISHED_BLACKSLAG)), InkColors.BLACK));
	public static final Block POLISHED_BLACKSLAG_BUTTON = register(blockWithItem("polished_blackslag_button", new ButtonBlock(SpectrumBlockSetTypes.POLISHED_BLACKSLAG, 5, BlockBehaviour.Properties.of().pushReaction(PushReaction.DESTROY).noCollission().strength(0.5F)), InkColors.BLACK));
	public static final Block POLISHED_BLACKSLAG_PRESSURE_PLATE = register(blockWithItem("polished_blackslag_pressure_plate", new PressurePlateBlock(SpectrumBlockSetTypes.POLISHED_BLACKSLAG, BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BLACK).requiresCorrectToolForDrops().noCollission().strength(0.5F)), InkColors.BLACK));
	...
	public static final Block POLISHED_BLACKSLAG_PILLAR = register(axisRotated(blockWithItem("polished_blackslag_pillar", new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(BLACKSLAG_BRICKS)), InkColors.BLACK), TexturedModel.createDefault(b -> SpectrumTextureMaps.sideEnd(b, "", CHISELED_POLISHED_BLACKSLAG, ""), ModelTemplates.CUBE_COLUMN)));
	...
	public static final Block TILLED_SHALE_CLAY = register(singleton(blockWithItem("tilled_shale_clay", new ImmutableFarmlandBlock(BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY), SHALE_CLAY.defaultBlockState()), InkColors.BROWN), SpectrumTexturedModels.farmland(b -> SHALE_CLAY, "_side", b -> b, "")));
	
	public static final Block POLISHED_SHALE_CLAY = register(blockWithItem("polished_shale_clay", new WeatheringBlock(Weathering.WeatheringLevel.UNAFFECTED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final Block POLISHED_SHALE_CLAY_STAIRS = register(blockWithItem("polished_shale_clay_stairs", new WeatheringStairsBlock(Weathering.WeatheringLevel.UNAFFECTED, POLISHED_SHALE_CLAY.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final Block POLISHED_SHALE_CLAY_SLAB = register(blockWithItem("polished_shale_clay_slab", new WeatheringSlabBlock(Weathering.WeatheringLevel.UNAFFECTED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	...
	public static final Block EXPOSED_POLISHED_SHALE_CLAY = register(blockWithItem("exposed_polished_shale_clay", new WeatheringBlock(Weathering.WeatheringLevel.EXPOSED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final Block EXPOSED_POLISHED_SHALE_CLAY_STAIRS = register(blockWithItem("exposed_polished_shale_clay_stairs", new WeatheringStairsBlock(Weathering.WeatheringLevel.EXPOSED, EXPOSED_POLISHED_SHALE_CLAY.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final Block EXPOSED_POLISHED_SHALE_CLAY_SLAB = register(blockWithItem("exposed_polished_shale_clay_slab", new WeatheringSlabBlock(Weathering.WeatheringLevel.EXPOSED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	...
	public static final Block WEATHERED_POLISHED_SHALE_CLAY = register(blockWithItem("weathered_polished_shale_clay", new WeatheringBlock(Weathering.WeatheringLevel.WEATHERED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final Block WEATHERED_POLISHED_SHALE_CLAY_STAIRS = register(blockWithItem("weathered_polished_shale_clay_stairs", new WeatheringStairsBlock(Weathering.WeatheringLevel.WEATHERED, WEATHERED_POLISHED_SHALE_CLAY.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final Block WEATHERED_POLISHED_SHALE_CLAY_SLAB = register(blockWithItem("weathered_polished_shale_clay_slab", new WeatheringSlabBlock(Weathering.WeatheringLevel.WEATHERED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	...
	public static final Block SHALE_CLAY_BRICKS = register(blockWithItem("shale_clay_bricks", new WeatheringBlock(Weathering.WeatheringLevel.UNAFFECTED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final Block SHALE_CLAY_BRICK_STAIRS = register(blockWithItem("shale_clay_brick_stairs", new WeatheringStairsBlock(Weathering.WeatheringLevel.UNAFFECTED, SHALE_CLAY_BRICKS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final Block SHALE_CLAY_BRICK_SLAB = register(blockWithItem("shale_clay_brick_slab", new WeatheringSlabBlock(Weathering.WeatheringLevel.UNAFFECTED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	...
	public static final Block EXPOSED_SHALE_CLAY_BRICKS = register(blockWithItem("exposed_shale_clay_bricks", new WeatheringBlock(Weathering.WeatheringLevel.EXPOSED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final Block EXPOSED_SHALE_CLAY_BRICK_STAIRS = register(blockWithItem("exposed_shale_clay_brick_stairs", new WeatheringStairsBlock(Weathering.WeatheringLevel.EXPOSED, EXPOSED_SHALE_CLAY_BRICKS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final Block EXPOSED_SHALE_CLAY_BRICK_SLAB = register(blockWithItem("exposed_shale_clay_brick_slab", new WeatheringSlabBlock(Weathering.WeatheringLevel.EXPOSED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	...
	public static final Block WEATHERED_SHALE_CLAY_BRICKS = register(blockWithItem("weathered_shale_clay_bricks", new WeatheringBlock(Weathering.WeatheringLevel.WEATHERED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final Block WEATHERED_SHALE_CLAY_BRICK_STAIRS = register(blockWithItem("weathered_shale_clay_brick_stairs", new WeatheringStairsBlock(Weathering.WeatheringLevel.WEATHERED, WEATHERED_SHALE_CLAY_BRICKS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final Block WEATHERED_SHALE_CLAY_BRICK_SLAB = register(blockWithItem("weathered_shale_clay_brick_slab", new WeatheringSlabBlock(Weathering.WeatheringLevel.WEATHERED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	...
	public static final Block SHALE_CLAY_TILES = register(blockWithItem("shale_clay_tiles", new WeatheringBlock(Weathering.WeatheringLevel.UNAFFECTED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final Block SHALE_CLAY_TILE_STAIRS = register(blockWithItem("shale_clay_tile_stairs", new WeatheringStairsBlock(Weathering.WeatheringLevel.UNAFFECTED, SHALE_CLAY_TILES.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final Block SHALE_CLAY_TILE_SLAB = register(blockWithItem("shale_clay_tile_slab", new WeatheringSlabBlock(Weathering.WeatheringLevel.UNAFFECTED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	...
	public static final Block EXPOSED_SHALE_CLAY_TILES = register(blockWithItem("exposed_shale_clay_tiles", new WeatheringBlock(Weathering.WeatheringLevel.EXPOSED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final Block EXPOSED_SHALE_CLAY_TILE_STAIRS = register(blockWithItem("exposed_shale_clay_tile_stairs", new WeatheringStairsBlock(Weathering.WeatheringLevel.EXPOSED, EXPOSED_SHALE_CLAY_TILES.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final Block EXPOSED_SHALE_CLAY_TILE_SLAB = register(blockWithItem("exposed_shale_clay_tile_slab", new WeatheringSlabBlock(Weathering.WeatheringLevel.EXPOSED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	...
	public static final Block WEATHERED_SHALE_CLAY_TILES = register(blockWithItem("weathered_shale_clay_tiles", new WeatheringBlock(Weathering.WeatheringLevel.WEATHERED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final Block WEATHERED_SHALE_CLAY_TILE_STAIRS = register(blockWithItem("weathered_shale_clay_tile_stairs", new WeatheringStairsBlock(Weathering.WeatheringLevel.WEATHERED, WEATHERED_SHALE_CLAY_TILES.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final Block WEATHERED_SHALE_CLAY_TILE_SLAB = register(blockWithItem("weathered_shale_clay_tile_slab", new WeatheringSlabBlock(Weathering.WeatheringLevel.WEATHERED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	...
	public static final Block PYRITE_SLAB = register(blockWithItem("pyrite_slab", new SlabBlock(BlockBehaviour.Properties.ofFullCopy(PYRITE)), InkColors.BROWN));
	public static final Block PYRITE_STAIRS = register(blockWithItem("pyrite_stairs", new StairBlock(PYRITE.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(PYRITE)), InkColors.BROWN));
	public static final Block PYRITE_WALL = register(blockWithItem("pyrite_wall", new WallBlock(BlockBehaviour.Properties.ofFullCopy(PYRITE)), InkColors.BROWN));
	...
	public static final Block PYRITE_PILE = register(axisRotated(blockWithItem("pyrite_pile", new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(PYRITE)), InkColors.BROWN), TexturedModel.COLUMN));
	public static final Block PYRITE_PLATING = register(simple(blockWithItem("pyrite_plating", new Block(BlockBehaviour.Properties.ofFullCopy(PYRITE)), InkColors.BROWN)));
	public static final Block PYRITE_TUBING = register(axisRotated(blockWithItem("pyrite_tubing", new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(PYRITE)), InkColors.BROWN), TexturedModel.COLUMN));
	public static final Block PYRITE_RELIEF = register(axisRotated(blockWithItem("pyrite_relief", new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(PYRITE)), InkColors.BROWN), SpectrumTexturedModels.cubeColumn(b -> b, "_side", b -> PYRITE_TUBING, "_top")));
	public static final Block PYRITE_STACK = register(simple(blockWithItem("pyrite_stack", new Block(BlockBehaviour.Properties.ofFullCopy(PYRITE)), InkColors.BROWN)));
	public static final Block PYRITE_PANELING = register(singleton(blockWithItem("pyrite_paneling", new Block(BlockBehaviour.Properties.ofFullCopy(PYRITE)), InkColors.BROWN), SpectrumTexturedModels.cubeColumn(b -> b, "", b -> PYRITE_PLATING, "")));
	public static final Block PYRITE_VENT = register(singleton(blockWithItem("pyrite_vent", new Block(BlockBehaviour.Properties.ofFullCopy(PYRITE)), InkColors.BROWN), SpectrumTexturedModels.cubeColumn(b -> b, "", b -> PYRITE_PLATING, "")));
	public static final Block PYRITE_RIPPER = register(mippedCutout(blockWithItem("pyrite_ripper", new PyriteRipperBlock(BlockBehaviour.Properties.ofFullCopy(PYRITE).noOcclusion().isValidSpawn(SpectrumBlocks::never).isViewBlocking(SpectrumBlocks::never)), InkColors.BROWN)).withBlockModel((ctx, block) -> MultiVariantGenerator.multiVariant(block).with(PropertyDispatch.properties(BlockStateProperties.FACING, PyriteRipperBlock.MIRRORED)
			.select(Direction.EAST, false, createModelVariant(block, "").with(VariantProperties.X_ROT, VariantProperties.Rotation.R90).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90))
			.select(Direction.NORTH, false, createModelVariant(block, "").with(VariantProperties.X_ROT, VariantProperties.Rotation.R90))
			.select(Direction.SOUTH, false, createModelVariant(block, "").with(VariantProperties.X_ROT, VariantProperties.Rotation.R270))
			.select(Direction.WEST, false, createModelVariant(block, "").with(VariantProperties.X_ROT, VariantProperties.Rotation.R90).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270))
			.select(Direction.UP, false, createModelVariant(block, ""))
			.select(Direction.DOWN, false, createModelVariant(block, "").with(VariantProperties.X_ROT, VariantProperties.Rotation.R180))
			.select(Direction.EAST, true, createModelVariant(block, "_mirrored").with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180))
			.select(Direction.NORTH, true, createModelVariant(block, "_mirrored").with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90))
			.select(Direction.SOUTH, true, createModelVariant(block, "_mirrored").with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270))
			.select(Direction.WEST, true, createModelVariant(block, "_mirrored"))
			.select(Direction.UP, true, createModelVariant(block, "").with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90))
			.select(Direction.DOWN, true, createModelVariant(block, "").with(VariantProperties.X_ROT, VariantProperties.Rotation.R180).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)))));
	...
	public static <T extends Block> BlockRegistrar<T> infested(BlockRegistrar<T> registrar, Block normal) {
		return singleton(registrar.withBlockItemModel((ctx, block) -> SpectrumModelHelper.registerParentedItemModel(ctx, block, normal)),
				TexturedModel.createDefault(infested -> SpectrumTextureMaps.infested(infested, normal), ModelTemplates.CUBE));
	}
	
	public static final Block SPLINTERSPAWN_INFESTED_PYRITE = register(infested(blockWithItem("splinterspawn_infested_pyrite", new RotatedPillarSplinterspawnInfestedBlock(PYRITE, BlockBehaviour.Properties.ofFullCopy(PYRITE)), InkColors.BROWN), PYRITE));
	public static final Block SPLINTERSPAWN_INFESTED_SHALE_CLAY = register(infested(blockWithItem("splinterspawn_infested_shale_clay", new SplinterspawnInfestedBlock(SHALE_CLAY, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN), SHALE_CLAY));
	...
	public static final Block POLISHED_BONE_ASH_STAIRS = register(blockWithItem("polished_bone_ash_stairs", new StairBlock(POLISHED_BONE_ASH.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(POLISHED_BONE_ASH)), InkColors.CYAN));
	public static final Block POLISHED_BONE_ASH_SLAB = register(blockWithItem("polished_bone_ash_slab", new SlabBlock(BlockBehaviour.Properties.ofFullCopy(POLISHED_BONE_ASH)), InkColors.CYAN));
	public static final Block POLISHED_BONE_ASH_WALL = register(blockWithItem("polished_bone_ash_wall", new WallBlock(BlockBehaviour.Properties.ofFullCopy(POLISHED_BONE_ASH)), InkColors.CYAN));
	...
	public static final Block BONE_ASH_BRICK_STAIRS = register(blockWithItem("bone_ash_brick_stairs", new StairBlock(BONE_ASH_BRICKS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(BONE_ASH_BRICKS)), InkColors.CYAN));
	public static final Block BONE_ASH_BRICK_SLAB = register(blockWithItem("bone_ash_brick_slab", new SlabBlock(BlockBehaviour.Properties.ofFullCopy(BONE_ASH_BRICKS)), InkColors.CYAN));
	public static final Block BONE_ASH_BRICK_WALL = register(blockWithItem("bone_ash_brick_wall", new WallBlock(BlockBehaviour.Properties.ofFullCopy(BONE_ASH_BRICKS)), InkColors.CYAN));
	...
	public static final Block BONE_ASH_TILE_STAIRS = register(blockWithItem("bone_ash_tile_stairs", new StairBlock(BONE_ASH_TILES.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(BONE_ASH_TILES)), InkColors.CYAN));
	public static final Block BONE_ASH_TILE_SLAB = register(blockWithItem("bone_ash_tile_slab", new SlabBlock(BlockBehaviour.Properties.ofFullCopy(BONE_ASH_TILES)), InkColors.CYAN));
	public static final Block BONE_ASH_TILE_WALL = register(blockWithItem("bone_ash_tile_wall", new WallBlock(BlockBehaviour.Properties.ofFullCopy(BONE_ASH_TILES)), InkColors.CYAN));
	...
	public static final Block SLUSH = register(simple(blockWithItem("slush", new SlushBlock(blackslag(SoundType.MUDDY_MANGROVE_ROOTS)), InkColors.BROWN)));
	public static final Block OVERGROWN_SLUSH = register(snowy(blockWithItem("overgrown_slush", new OvergrownSlushBlock(blackslag(SoundType.MUDDY_MANGROVE_ROOTS)), InkColors.BROWN), SpectrumTexturedModels.cubeBottomTopParticle(b -> b, "_side", b -> b, "_top", b -> SLUSH, "", b -> b, "_top"), SpectrumTexturedModels.cubeBottomTopParticle(b -> b, "_snow_side", b -> b, "_snow_top", b -> SLUSH, "", b -> b, "_snow_top")));
	public static final Block TILLED_SLUSH = register(singleton(blockWithItem("tilled_slush", new TilledSlushBlock(BlockBehaviour.Properties.ofFullCopy(SLUSH), SLUSH.defaultBlockState()), InkColors.BROWN), SpectrumTexturedModels.farmland(b -> SLUSH, "", b -> b, "")));
	...
	public static final Block BLACK_SLUDGE = register(simple(blockWithItem("black_sludge", new Block(settings(MapColor.TERRACOTTA_BLACK, SoundType.SAND, 0.5F).instrument(NoteBlockInstrument.SNARE)), InkColors.GRAY)));
	public static final Block SAG_LEAF = register(cross(block("sag_leaf", new BlackSludgePlantBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.SHORT_GRASS).mapColor(MapColor.TERRACOTTA_BLACK)))));
	public static final Block SAG_BUBBLE = register(cross(block("sag_bubble", new BlackSludgePlantBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.SHORT_GRASS).mapColor(MapColor.TERRACOTTA_BLACK)))));
	public static final Block SMALL_SAG_BUBBLE = register(cross(block("small_sag_bubble", new BlackSludgePlantBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.SHORT_GRASS).mapColor(MapColor.TERRACOTTA_BLACK)))));
	...
	public static final PrimordialFireBlock PRIMORDIAL_FIRE = register(cutout(block("primordial_fire", new PrimordialFireBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.FIRE).mapColor(MapColor.COLOR_PURPLE).lightLevel((state) -> 10)))).withBlockModel((ctx, block) -> {
		...
		return MultiPartGenerator.multiPart(block)
				.with(noSides, createModelVariant(SpectrumModels.FIRE_FLOOR.createWithSuffix(block, "_floor0", fire0, ctx.modelOutput)), createModelVariant(SpectrumModels.FIRE_FLOOR.createWithSuffix(block, "_floor1", fire1, ctx.modelOutput)))
				.with(Condition.condition().term(PrimordialFireBlock.UP, true), createModelVariant(SpectrumModels.FIRE_UP.createWithSuffix(block, "_up0", fire0, ctx.modelOutput)), createModelVariant(SpectrumModels.FIRE_UP.createWithSuffix(block, "_up1", fire1, ctx.modelOutput)), createModelVariant(SpectrumModels.FIRE_UP_ALT.createWithSuffix(block, "_up_alt0", fire0, ctx.modelOutput)), createModelVariant(SpectrumModels.FIRE_UP_ALT.createWithSuffix(block, "_up_alt1", fire1, ctx.modelOutput)))
	...
	public static final Block PRIMORDIAL_WALL_TORCH = register(cutout(defaultEastHorizontalFacing(block("primordial_wall_torch", new WallTorchBlock(SpectrumParticleTypes.PRIMORDIAL_FLAME, BlockBehaviour.Properties.ofFullCopy(Blocks.SOUL_WALL_TORCH).lightLevel(s -> 13))), ModelLocationUtils::getModelLocation)));
	...
	public static final Block SMOOTH_BASALT_STAIRS = register(blockWithItem("smooth_basalt_stairs", new StairBlock(Blocks.BASALT.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.BASALT)), InkColors.BROWN));
	public static final Block SMOOTH_BASALT_SLAB = register(blockWithItem("smooth_basalt_slab", new SlabBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BASALT)), InkColors.BROWN));
	public static final Block SMOOTH_BASALT_WALL = register(blockWithItem("smooth_basalt_wall", new WallBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BASALT)), InkColors.BROWN));
	...
	public static final Block POLISHED_BASALT_BUTTON = register(blockWithItem("polished_basalt_button", new ButtonBlock(SpectrumBlockSetTypes.POLISHED_BASALT, 5, BlockBehaviour.Properties.of().noCollission().strength(0.5F).pushReaction(PushReaction.DESTROY)), InkColors.BROWN));
	...
	public static final Block NOTCHED_POLISHED_BASALT = register(simple((blockWithItem("notched_polished_basalt", new Block(BlockBehaviour.Properties.ofFullCopy(POLISHED_BASALT)), InkColors.BROWN))));
	...
	public static final Block CALCITE_STAIRS = register(blockWithItem("calcite_stairs", new StairBlock(Blocks.CALCITE.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.CALCITE)), InkColors.BROWN));
	public static final Block CALCITE_SLAB = register(blockWithItem("calcite_slab", new SlabBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CALCITE)), InkColors.BROWN));
	public static final Block CALCITE_WALL = register(blockWithItem("calcite_wall", new WallBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CALCITE)), InkColors.BROWN));
	...
	public static final Block POLISHED_CALCITE_BUTTON = register(blockWithItem("polished_calcite_button", new ButtonBlock(SpectrumBlockSetTypes.POLISHED_CALCITE, 5, BlockBehaviour.Properties.of().noCollission().strength(0.5F).pushReaction(PushReaction.DESTROY)), InkColors.BROWN));
	...
	public static final Block NOTCHED_POLISHED_CALCITE = register(simple(blockWithItem("notched_polished_calcite", new Block(BlockBehaviour.Properties.ofFullCopy(POLISHED_CALCITE)), InkColors.BROWN)));
	...
	public static final Block AMETHYST_BASALT_LIGHT = registerGemstoneLight("amethyst_basalt_light", Blocks.AMETHYST_BLOCK, POLISHED_BASALT, SpectrumTextures.BASALT_CAP, InkColors.MAGENTA);
	...
	public static final Block AMETHYST_CALCITE_LIGHT = registerGemstoneLight("amethyst_calcite_light", Blocks.AMETHYST_BLOCK, POLISHED_CALCITE, SpectrumTextures.CALCITE_CAP, InkColors.MAGENTA);
	...
	public static final Block AMETHYST_CHIME = register(translucent(singleton(blockWithItem("amethyst_chime", new GemstoneChimeBlock(chime(Blocks.AMETHYST_CLUSTER), SoundEvents.AMETHYST_BLOCK_CHIME, ColoredSparkleRisingParticleEffect.MAGENTA), InkColors.MAGENTA), SpectrumTexturedModels.CHIME)));
	...
	public static final Block AMETHYST_PYLON = register(pylon(blockWithItem("amethyst_pylon", new PylonBlock(pylon(Blocks.AMETHYST_BLOCK)), InkColors.MAGENTA)));
	...
	public static final Block SEMI_PERMEABLE_GLASS = register(translucent(parented(blockWithItem("semi_permeable_glass", new AlternatePlayerOnlyGlassBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GLASS), Blocks.GLASS, false), InkColors.WHITE), b -> Blocks.GLASS)));
	public static final Block TINTED_SEMI_PERMEABLE_GLASS = register(translucent(parented(blockWithItem("tinted_semi_permeable_glass", new AlternatePlayerOnlyGlassBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.TINTED_GLASS), Blocks.TINTED_GLASS, true), InkColors.BLACK), b -> Blocks.TINTED_GLASS)));
	...
	public static final Block PRESENT = register(cutout(blockWithItem("present", new PresentBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.WHITE_WOOL)), block -> new PresentBlockItem(block, IS.of().component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)), InkColors.LIGHT_GRAY)).withBlockModel((ctx, block) -> MultiVariantGenerator.multiVariant(block).with(PropertyDispatch.property(PresentBlock.VARIANT).generate(variant -> createModelVariant(SpectrumModels.PRESENT.createWithSuffix(block, "_" + variant.getSerializedName(), new TextureMapping().put(TextureSlot.TEXTURE, TextureMapping.getBlockTexture(block, "_" + variant.getSerializedName())).put(TextureSlot.PARTICLE, TextureMapping.getBlockTexture(variant.woolBase)), ctx.modelOutput))))).withPredefinedItemModel());
	public static final Block TITRATION_BARREL = register(blockWithItem("titration_barrel", new TitrationBarrelBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS).mapColor(MapColor.COLOR_RED)), InkColors.MAGENTA).withBlockModel((ctx, block) -> MultiVariantGenerator.multiVariant(block).with(SpectrumModelHelper.createUpDefaultHorizontalFacingVariantMap()).with(PropertyDispatch.property(TitrationBarrelBlock.BARREL_STATE).generate(state -> createModelVariant(SpectrumTexturedModels.cubeBottomTop(b -> b, "_side", b -> b, "_top_" + state.getSerializedName(), b -> b, "_bottom").createWithSuffix(block, state == TitrationBarrelBlock.BarrelState.EMPTY ? "" : "_" + state.getSerializedName(), ctx.modelOutput))))));
	
	public static final Block PARAMETRIC_MINING_DEVICE = register(defaultUpFacingGetter(blockWithItem("parametric_mining_device", new ParametricMiningDeviceBlock(BlockBehaviour.Properties.ofFullCopy(BLACKSLAG).noOcclusion().instabreak()), block -> new ParametricMiningDeviceItem(block, IS.of(16)), InkColors.RED), ModelLocationUtils::getModelLocation).withItemModel(SpectrumModelHelper::registerItemModel));
	public static final Block THREAT_CONFLUX = register(blockWithItem("threat_conflux", new ThreatConfluxBlock(BlockBehaviour.Properties.ofFullCopy(BLACKSLAG).noOcclusion().instabreak()), block -> new ThreatConfluxItem(block, IS.of(16)), InkColors.RED).withBlockModel((ctx, block) -> MultiVariantGenerator.multiVariant(block).with(PropertyDispatch.property(ThreatConfluxBlock.ARMED).generate(armed -> createModelVariant(block, armed == ThreatConfluxBlock.ArmedState.NOT_ARMED ? "" : "_armed")))));
	...
	public static final Block ROTTEN_GROUND = register(blockWithItem("rotten_ground", new RottenGroundBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.MUD).mapColor(MapColor.STONE).sound(SoundType.HONEY_BLOCK).jumpFactor(0.9F).strength(5F, 15F)), InkColors.GRAY).withBlockModel((ctx, block) -> MultiVariantGenerator.multiVariant(block, createModelVariant(TexturedModel.CUBE.create(block, ctx.modelOutput)).with(VariantProperties.WEIGHT, 4), createModelVariant(SpectrumTexturedModels.cubeAll(b -> b, "_bony").createWithSuffix(block, "_bony", ctx.modelOutput)), createModelVariant(SpectrumTexturedModels.cubeAll(b -> b, "_boil").createWithSuffix(block, "_boil", ctx.modelOutput)))));
	...
	public static final Block ASHEN_BLACKSLAG = register(singleton(blockWithItem("ashen_blackslag", new RotatedPillarBlock(blackslag(SoundType.DEEPSLATE).mapColor(MapColor.QUARTZ)), InkColors.LIGHT_GRAY), SpectrumTexturedModels.cubeBottomTopParticle(b -> b, "_side", b -> b, "_top", b -> BLACKSLAG, "_top", b -> b, "_top")));
	public static final Block ASH = register(blockWithItem("ash", new AshBlock(ash(SoundType.POWDER_SNOW)), InkColors.GRAY).withBlockModel((ctx, block) -> MultiVariantGenerator.multiVariant(block, createModelVariant(SpectrumTexturedModels.cubeAll(b -> b, "").createWithSuffix(block, "", ctx.modelOutput)), createModelVariant(SpectrumTexturedModels.cubeAll(b -> b, "2").createWithSuffix(block, "2", ctx.modelOutput)), createModelVariant(SpectrumTexturedModels.cubeAll(b -> b, "3").createWithSuffix(block, "3", ctx.modelOutput)), createModelVariant(SpectrumTexturedModels.cubeAll(b -> b, "4").createWithSuffix(block, "4", ctx.modelOutput)))));
	...
	public static final Block VARIA_SPROUT = register(cutout(blockWithItem("varia_sprout", new AshFloraBlock(settings(MapColor.SNOW, SoundType.STEM, 0F).instabreak().lightLevel(state -> 11).offsetType(BlockBehaviour.OffsetType.XZ).dynamicShape().noCollission().hasPostProcess(SpectrumBlocks::always).emissiveRendering(SpectrumBlocks::always)), InkColors.WHITE)).withBlockItemModel(SpectrumModelHelper::registerBlockTexturedItemModel).withBlockModel((ctx, block) -> MultiVariantGenerator.multiVariant(block,
			createModelVariant(SpectrumTexturedModels.cross(b -> b, "").createWithSuffix(block, "", ctx.modelOutput)),
			createModelVariant(SpectrumTexturedModels.cross(b -> b, "_2").createWithSuffix(block, "_2", ctx.modelOutput)),
			createModelVariant(SpectrumTexturedModels.cross(b -> b, "_3").createWithSuffix(block, "_3", ctx.modelOutput)),
			createModelVariant(SpectrumTexturedModels.cross(b -> b, "_4").createWithSuffix(block, "_4", ctx.modelOutput)),
			createModelVariant(SpectrumTexturedModels.cross(b -> b, "_5").createWithSuffix(block, "_5", ctx.modelOutput)),
			createModelVariant(SpectrumTexturedModels.cross(b -> b, "_6").createWithSuffix(block, "_6", ctx.modelOutput)))));
	...
	public static FungusBlock registerNoxshroom(String name, ResourceKey<ConfiguredFeature<?, ?>> feature, MapColor mapColor) {
		return register(cutout(blockWithItem(name, new FungusBlock(feature, SHIMMEL, settings(mapColor, SoundType.FUNGUS, 0.0F).noCollission()), InkColors.LIME))
				.withBlockItemModel((ctx, block) -> ModelTemplates.FLAT_ITEM.create(ModelLocationUtils.getModelLocation(block.asItem()), SpectrumTextureMaps.layer0(block, "_type_1"), ctx.output)).withBlockModel((ctx, block) -> MultiVariantGenerator.multiVariant(block,
						createModelVariant(SpectrumTexturedModels.cross(b -> b, "_type_1").createWithSuffix(block, "_type_1", ctx.modelOutput)),
						createModelVariant(SpectrumTexturedModels.cross(b -> b, "_type_2").createWithSuffix(block, "_type_2", ctx.modelOutput)),
						createModelVariant(SpectrumTexturedModels.cross(b -> b, "_type_3").createWithSuffix(block, "_type_3", ctx.modelOutput)))));
	}
	...
	public static final FlowerPotBlock POTTED_SLATE_NOXSHROOM = register(pottedPlantWithCustomTexture(block("potted_slate_noxshroom", new FlowerPotBlock(SLATE_NOXSHROOM, pottedPlant())), "_type_1"));
	public static final FlowerPotBlock POTTED_EBONY_NOXSHROOM = register(pottedPlantWithCustomTexture(block("potted_ebony_noxshroom", new FlowerPotBlock(EBONY_NOXSHROOM, pottedPlant())), "_type_1"));
	public static final FlowerPotBlock POTTED_IVORY_NOXSHROOM = register(pottedPlantWithCustomTexture(block("potted_ivory_noxshroom", new FlowerPotBlock(IVORY_NOXSHROOM, pottedPlant())), "_type_1"));
	public static final FlowerPotBlock POTTED_CHESTNUT_NOXSHROOM = register(pottedPlantWithCustomTexture(block("potted_chestnut_noxshroom", new FlowerPotBlock(CHESTNUT_NOXSHROOM, pottedPlant())), "_type_1"));
	...
	public static <T extends FlexLanternBlock> T registerNoxwoodLantern(String name, T flexLanternBlock, InkColor color) {
		return register(cutout(blockWithItem(name, flexLanternBlock, color)).withItemModel((ctx, item) -> SpectrumModelHelper.registerItemModel(ctx, item, "_item")).withBlockModel((ctx, block) -> MultiVariantGenerator.multiVariant(block).with(PropertyDispatch.properties(BlockStateProperties.HANGING, DiagonalBlock.DIAGONAL, FlexLanternBlock.TALL).generate((hanging, diagonal, tall) -> {
			...
			return createModelVariant(SpectrumModels.noxwoodLantern(suffix).createWithSuffix(block, suffix, TextureMapping.cube(block), ctx.modelOutput));
		}))));
	}
	...
	public static final Block SLATE_NOXWOOD_LANTERN = registerNoxwoodLantern("slate_noxwood_lantern", new FlexLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LANTERN).lightLevel(s -> 13).pushReaction(PushReaction.DESTROY)), InkColors.LIME);
	...
	public static final Block EBONY_NOXWOOD_LANTERN = registerNoxwoodLantern("ebony_noxwood_lantern", new FlexLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LANTERN).lightLevel(s -> 13).pushReaction(PushReaction.DESTROY)), InkColors.LIME);
	...
	public static final BlockFamily EBONY_NOXWOOD_FAMILY = SpectrumModelHelper.registerBlockFamilyWithImprovedModels(new BlockFamily.Builder(EBONY_NOXWOOD_PLANKS).stairs(EBONY_NOXWOOD_STAIRS).slab(EBONY_NOXWOOD_SLAB).fence(EBONY_NOXWOOD_FENCE).fenceGate(EBONY_NOXWOOD_FENCE_GATE).door(EBONY_NOXWOOD_DOOR).trapdoor(EBONY_NOXWOOD_TRAPDOOR).button(EBONY_NOXWOOD_BUTTON).pressurePlate(EBONY_NOXWOOD_PRESSURE_PLATE).getFamily());
	...
	public static final Block IVORY_NOXWOOD_LANTERN = registerNoxwoodLantern("ivory_noxwood_lantern", new FlexLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LANTERN).lightLevel(s -> 13).pushReaction(PushReaction.DESTROY)), InkColors.LIME);
	...
	public static final Block CHESTNUT_NOXWOOD_LANTERN = registerNoxwoodLantern("chestnut_noxwood_lantern", new FlexLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LANTERN).lightLevel(s -> 13).pushReaction(PushReaction.DESTROY)), InkColors.LIME);
	...
	public static final BlockFamily CHESTNUT_NOXWOOD_FAMILY = SpectrumModelHelper.registerBlockFamilyWithImprovedModels(new BlockFamily.Builder(CHESTNUT_NOXWOOD_PLANKS).stairs(CHESTNUT_NOXWOOD_STAIRS).slab(CHESTNUT_NOXWOOD_SLAB).fence(CHESTNUT_NOXWOOD_FENCE).fenceGate(CHESTNUT_NOXWOOD_FENCE_GATE).door(CHESTNUT_NOXWOOD_DOOR).trapdoor(CHESTNUT_NOXWOOD_TRAPDOOR).button(CHESTNUT_NOXWOOD_BUTTON).pressurePlate(CHESTNUT_NOXWOOD_PRESSURE_PLATE).getFamily());
	...
	public static final Block WEEPING_GALA_LEAVES = register(singleton(blockWithItem("weeping_gala_leaves", new LeavesBlock(copyWithMapColor(Blocks.OAK_LEAVES, MapColor.WARPED_WART_BLOCK)), InkColors.LIME), TexturedModel.LEAVES));
	...
	public static final Block WEEPING_GALA_FRONDS_PLANT = register(cutout(block("weeping_gala_fronds_plant", new WeepingGalaFrondsTipBlock(BlockBehaviour.Properties.ofFullCopy(WEEPING_GALA_LEAVES).noCollission().lightLevel(s -> s.getValue(WeepingGalaFrondsTipBlock.FORM).getLuminance())))).withBlockModel((ctx, block) -> MultiVariantGenerator.multiVariant(block).with(PropertyDispatch.property(WeepingGalaFrondsTipBlock.FORM)
			.select(WeepingGalaFrondsTipBlock.Form.TIP, createModelVariant(SpectrumTexturedModels.cross(b -> WEEPING_GALA_FRONDS, "_tip").create(block, ctx.modelOutput)))
			.select(WeepingGalaFrondsTipBlock.Form.SPRIG, createModelVariant(SpectrumTexturedModels.cross(b -> WEEPING_GALA_FRONDS, "_sprig").createWithSuffix(block, "_sprig", ctx.modelOutput)))
			.select(WeepingGalaFrondsTipBlock.Form.RESIN, createModelVariant(SpectrumTexturedModels.cross(b -> WEEPING_GALA_FRONDS, "_sprig_resin").createWithSuffix(block, "_resin", ctx.modelOutput))))));
	...
	public static final BlockFamily WEEPING_GALA_FAMILY = SpectrumModelHelper.registerBlockFamilyWithImprovedModels(new BlockFamily.Builder(WEEPING_GALA_PLANKS).stairs(WEEPING_GALA_STAIRS).slab(WEEPING_GALA_SLAB).fence(WEEPING_GALA_FENCE).fenceGate(WEEPING_GALA_FENCE_GATE).door(WEEPING_GALA_DOOR).trapdoor(WEEPING_GALA_TRAPDOOR).button(WEEPING_GALA_BUTTON).pressurePlate(WEEPING_GALA_PRESSURE_PLATE).getFamily());
	...
	public static final Block BASAL_MARBLE_TILE_STAIRS = register(blockWithItem("basal_marble_tile_stairs", new StairBlock(BASAL_MARBLE_TILES.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(BASAL_MARBLE_TILES)), InkColors.BROWN));
	public static final Block BASAL_MARBLE_TILE_SLAB = register(blockWithItem("basal_marble_tile_slab", new SlabBlock(BlockBehaviour.Properties.ofFullCopy(BASAL_MARBLE_TILES)), InkColors.BROWN));
	public static final Block BASAL_MARBLE_TILE_WALL = register(blockWithItem("basal_marble_tile_wall", new WallBlock(BlockBehaviour.Properties.ofFullCopy(BASAL_MARBLE_TILES)), InkColors.BROWN));
	...
	public static final Block BASAL_MARBLE_BRICK_STAIRS = register(blockWithItem("basal_marble_brick_stairs", new StairBlock(BASAL_MARBLE_BRICKS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(BASAL_MARBLE_BRICKS)), InkColors.BROWN));
	public static final Block BASAL_MARBLE_BRICK_SLAB = register(blockWithItem("basal_marble_brick_slab", new SlabBlock(BlockBehaviour.Properties.ofFullCopy(BASAL_MARBLE_BRICKS)), InkColors.BROWN));
	public static final Block BASAL_MARBLE_BRICK_WALL = register(blockWithItem("basal_marble_brick_wall", new WallBlock(BlockBehaviour.Properties.ofFullCopy(BASAL_MARBLE_BRICKS)), InkColors.BROWN));
	...
	public static TallDragonjagBlock registerTallDragonjagBlock(String name, Dragonjag.Variant variant) {
		return register(cutout(block(name, new TallDragonjagBlock(settings(variant.getMapColor(), SoundType.GRASS, 1.0F), variant))).withBlockModel((ctx, block) -> MultiVariantGenerator.multiVariant(block).with(PropertyDispatch.properties(DoublePlantBlock.HALF, TallDragonjagBlock.DEAD).generate((half, dead) -> {
			...
			return createModelVariant((half == DoubleBlockHalf.UPPER ? SpectrumTexturedModels.cross(b -> b, suffix) : SpectrumTexturedModels.doubleCross(b -> b, suffix)).createWithSuffix(block, suffix, ctx.modelOutput));
		}))));
	}
	...
	//Flora
	public static final Block ALOE = register(cutout(block("aloe", new AloeBlock(settings(MapColor.PLANT, SoundType.GRASS, 1.0F).noCollission().randomTicks().noOcclusion()))).withBlockModel((ctx, block) -> MultiVariantGenerator.multiVariant(block).with(PropertyDispatch.property(BlockStateProperties.AGE_4).generate(age -> createModelVariant(SpectrumTexturedModels.cross(b -> b, age.toString()).createWithSuffix(block, age.toString(), ctx.modelOutput))))));
	public static final Block SAWBLADE_HOLLY_BUSH = register(cutout(block("sawblade_holly_bush", new SawbladeHollyBushBlock(settings(MapColor.TERRACOTTA_GREEN, SoundType.GRASS, 0.0F).noCollission().randomTicks().noOcclusion().lightLevel(s -> s.getValue(SawbladeHollyBushBlock.AGE) == SawbladeHollyBushBlock.MAX_AGE ? 10 : 0)))).withBlockModel((ctx, block) -> MultiVariantGenerator.multiVariant(block).with(PropertyDispatch.property(BlockStateProperties.AGE_7)
			.select(0, createModelVariant(SpectrumTexturedModels.cross(b -> b, "0").createWithSuffix(block, "_stage0", ctx.modelOutput)))
			.select(1, createModelVariant(SpectrumTexturedModels.cross(b -> b, "1").createWithSuffix(block, "_stage1", ctx.modelOutput)))
			.select(2, createModelVariant(block, "_stage1"))
			.select(3, createModelVariant(SpectrumTexturedModels.cross(b -> b, "2").createWithSuffix(block, "_stage2", ctx.modelOutput)))
			.select(4, createModelVariant(block, "_stage2")).select(5, createModelVariant(block, "_stage2"))
			.select(6, createModelVariant(block, "_stage2"))
			.select(7, createModelVariant(SpectrumTexturedModels.cross(b -> b, "3").createWithSuffix(block, "_stage3", ctx.modelOutput))))));
	public static final Block BRISTLE_SPROUTS = register(cutout(blockWithItem("bristle_sprouts", new BristleSproutsBlock(settings(MapColor.GRASS, SoundType.GRASS, 0.0F).noCollission().noOcclusion().offsetType(BlockBehaviour.OffsetType.XZ).replaceable()), InkColors.LIME)).withBlockItemModel((ctx, block) -> SpectrumModelHelper.registerBlockTexturedItemModel(ctx, block, "_1")).withBlockModel((ctx, block) -> MultiVariantGenerator.multiVariant(block, createModelVariant(SpectrumTexturedModels.cross(b -> b, "_1").createWithSuffix(block, "_1", ctx.modelOutput)), createModelVariant(SpectrumTexturedModels.cross(b -> b, "_2").createWithSuffix(block, "_2", ctx.modelOutput)), createModelVariant(SpectrumTexturedModels.cross(b -> b, "_3").createWithSuffix(block, "_3", ctx.modelOutput)), createModelVariant(SpectrumTexturedModels.cross(b -> b, "_4").createWithSuffix(block, "_4", ctx.modelOutput)))));
	...
	public static final Block ABYSSAL_VINES = register(cutout(block("abyssal_vines", new AbyssalVineBlock(settings(MapColor.PLANT, SoundType.CAVE_VINES, 2.0F).noCollission().offsetType(BlockBehaviour.OffsetType.XYZ).randomTicks().noOcclusion().lightLevel(state -> state.getValue(BlockStateProperties.BERRIES) ? 13 : 0))))
		...
		String suffix = (stage == TriStateVineBlock.LifeStage.STALK ? "" : "_tip") + (berries ? "_fruiting" : "");
				...
				return createModelVariant(SpectrumTexturedModels.cross(b -> b, suffix).createWithSuffix(block, suffix, ctx.modelOutput));
	}))));
	...
	public static final Block SWEET_PEA = register(simplePlant(blockWithItem("sweet_pea", new FlowerBlock(MobEffects.NIGHT_VISION, 5, settings(MapColor.COLOR_MAGENTA, SoundType.GRASS, 0.0F).offsetType(BlockBehaviour.OffsetType.XZ).noCollission().noOcclusion().lightLevel(s -> 11).hasPostProcess(SpectrumBlocks::always).emissiveRendering(SpectrumBlocks::always)), InkColors.YELLOW)));
	public static final Block APRICOTTI = register(simplePlant(blockWithItem("apricotti", new FlowerBlock(MobEffects.GLOWING, 5, settings(MapColor.COLOR_ORANGE, SoundType.GRASS, 0.0F).offsetType(BlockBehaviour.OffsetType.XZ).noCollission().noOcclusion().lightLevel(s -> 11).hasPostProcess(SpectrumBlocks::always).emissiveRendering(SpectrumBlocks::always)), InkColors.YELLOW)));
	public static final Block HUMMING_BELL = register(simplePlant(blockWithItem("humming_bell", new FlowerBlock(SpectrumStatusEffects.LIGHTWEIGHT, 5, settings(MapColor.COLOR_LIGHT_BLUE, SoundType.GRASS, 0.0F).offsetType(BlockBehaviour.OffsetType.XZ).noCollission().noOcclusion().lightLevel(s -> 9).hasPostProcess(SpectrumBlocks::always).emissiveRendering(SpectrumBlocks::always)), InkColors.LIME)));
	...
	public static final Block HUMMINGSTONE_GLASS_PANE = register(glassPane(blockWithItem("hummingstone_glass_pane", new IronBarsBlock(BlockBehaviour.Properties.ofFullCopy(HUMMINGSTONE_GLASS)), InkColors.LIGHT_BLUE), HUMMINGSTONE_GLASS));
	public static final Block HUMMINGSTONE = register(translucent(blockWithItem("hummingstone", new HummingstoneBlock(BlockBehaviour.Properties.ofFullCopy(HUMMINGSTONE_GLASS).lightLevel((state) -> 14)), InkColors.LIGHT_BLUE)).withBlockModel((ctx, block) -> MultiVariantGenerator.multiVariant(block).with(SpectrumModelHelper.createBooleanModelMap(HummingstoneBlock.HUMMING, SpectrumTexturedModels.cubeAll(b -> b, "_humming").createWithSuffix(block, "_humming", ctx.modelOutput), TexturedModel.CUBE.create(block, ctx.modelOutput)))));
	public static final Block WAXED_HUMMINGSTONE = register(translucent(parented(blockWithItem("waxed_hummingstone", new TransparentBlock(BlockBehaviour.Properties.ofFullCopy(HUMMINGSTONE)), InkColors.LIGHT_BLUE), b -> HUMMINGSTONE)));
	
	public static final Block MOSS_BALL = register(cutout(blockWithItem("moss_ball", new MossBallBlock(settings(MapColor.PLANT, SoundType.WET_GRASS, 1F).noCollission().noOcclusion().offsetType(BlockBehaviour.OffsetType.XYZ)), InkColors.GREEN)).withBlockModel((ctx, block) -> {
	...
	public static final Block GIANT_MOSS_BALL = register(blockWithItem("giant_moss_ball", new GiantMossBallBlock(settings(MapColor.PLANT, SoundType.WET_GRASS, 10F).noCollission().noOcclusion().offsetType(BlockBehaviour.OffsetType.XYZ)), InkColors.GREEN).withBlockModel((ctx, block) -> SpectrumModelHelper.createVariantsSupplier(block, ModelLocationUtils.getModelLocation(block))));
	
	public static final Block RESPLENDENT_BLOCK = register(defaultUpFacing(blockWithItem("resplendent_block", new CushionedFacingBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.RED_WOOL)), IS.of(Rarity.UNCOMMON), InkColors.YELLOW), TexturedModel.CUBE_TOP_BOTTOM));
	public static final Block RESPLENDENT_CUSHION = register(singleton(blockWithItem("resplendent_cushion", new CushionBlock(BlockBehaviour.Properties.ofFullCopy(RESPLENDENT_BLOCK).noOcclusion().isValidSpawn(SpectrumBlocks::never)), IS.of(Rarity.UNCOMMON), InkColors.YELLOW), SpectrumTexturedModels.CUSHION));
	public static final Block RESPLENDENT_CARPET = register(singleton(blockWithItem("resplendent_carpet", new CushionedCarpetBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.RED_CARPET)), IS.of(Rarity.UNCOMMON), InkColors.YELLOW), TexturedModel.CARPET));
	public static final Block RESPLENDENT_BED = register(cutout(blockWithItem("resplendent_bed", new SpectrumBedBlock(DyeColor.RED, BlockBehaviour.Properties.ofFullCopy(Blocks.RED_BED)), IS.of(1, Rarity.UNCOMMON), InkColors.YELLOW)).withPredefinedItemModel().withBlockModel((ctx, block) -> MultiVariantGenerator.multiVariant(block).with(SpectrumModelHelper.createSouthDefaultHorizontalFacingVariantMap()).with(PropertyDispatch.property(BedBlock.PART).select(BedPart.HEAD, createModelVariant(block, "_head")).select(BedPart.FOOT, createModelVariant(block, "_foot")))));
	...
	public static final Block NEPHRITE_BLOSSOM_LEAVES = register(cutout(blockWithItem("nephrite_blossom_leaves", new NephriteBlossomLeavesBlock(settings(MapColor.COLOR_PINK, SoundType.GRASS, 0.2F).noOcclusion().randomTicks().lightLevel(state -> 13)), InkColors.PINK)).withBlockModel((ctx, block) -> MultiVariantGenerator.multiVariant(block).with(PropertyDispatch.property(BlockStateProperties.AGE_2).generate(age -> {
		...
		return createModelVariant(SpectrumTexturedModels.leaves(b -> b, suffix).createWithSuffix(block, suffix, ctx.modelOutput));
	}))));
	public static final Block NEPHRITE_BLOSSOM_BULB = register(cross(blockWithItem("nephrite_blossom_bulb", new NephriteBlossomBulbBlock(BlockBehaviour.Properties.ofFullCopy(NEPHRITE_BLOSSOM_STEM)), IS.of(), InkColors.PINK)).withItemModel(SpectrumModelHelper::registerItemModel));
	...
	public static final Block JADEITE_LOTUS_FLOWER = register(cutout(defaultUpFacingGetter(blockWithItem("jadeite_lotus_flower", new JadeiteLotusFlowerBlock(settings(MapColor.SNOW, SoundType.WOOL, 2.0F).lightLevel(state -> 14).hasPostProcess(SpectrumBlocks::always).emissiveRendering(SpectrumBlocks::always)), IS.of(), InkColors.LIME), ModelLocationUtils::getModelLocation)));
	public static final Block JADEITE_LOTUS_BULB = register(cross(blockWithItem("jadeite_lotus_bulb", new JadeiteLotusBulbBlock(BlockBehaviour.Properties.ofFullCopy(JADEITE_LOTUS_STEM).noOcclusion()), IS.of(), InkColors.LIME)).withItemModel(SpectrumModelHelper::registerItemModel));
	...
	public static final Block SHIMMERSTONE_ORE = register(simple(blockWithItem("shimmerstone_ore", new ShimmerstoneOreBlock(UniformInt.of(2, 4), ore().randomTicks(), SpectrumAdvancements.REVEAL_SHIMMERSTONE, Blocks.STONE.defaultBlockState()), InkColors.YELLOW)));
	public static final Block DEEPSLATE_SHIMMERSTONE_ORE = register(simple(blockWithItem("deepslate_shimmerstone_ore", new ShimmerstoneOreBlock(UniformInt.of(2, 4), deepslateOre().randomTicks(), SpectrumAdvancements.REVEAL_SHIMMERSTONE, Blocks.DEEPSLATE.defaultBlockState()), InkColors.YELLOW)));
	...
	public static final Block RAW_AZURITE_BLOCK = register(simple(blockWithItem("raw_azurite_block", new AzuriteBlock(ore().mapColor(MapColor.COLOR_BLUE)), InkColors.BLUE)));
	public static final Block DEEPSLATE_AZURITE_ORE = register(simpleMirrored(blockWithItem("deepslate_azurite_ore", new AzuriteOreBlock(UniformInt.of(4, 7), deepslateOre().randomTicks(), SpectrumAdvancements.REVEAL_AZURITE, Blocks.DEEPSLATE.defaultBlockState()), InkColors.BLUE)));
	...
	public static final Block AZURITE_BLOCK = register(defaultUpFacing(blockWithItem("azurite_block", new AzuriteBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LAPIS_BLOCK).mapColor(MapColor.COLOR_BLUE)), InkColors.BLUE), TexturedModel.CUBE_TOP_BOTTOM));
	...
	public static final Block MALACHITE_ORE = register(simple(blockWithItem("malachite_ore", new CloakedOreBlock(UniformInt.of(7, 11), ore(), SpectrumAdvancements.REVEAL_MALACHITE, Blocks.STONE.defaultBlockState()), IS.of(Rarity.UNCOMMON), InkColors.GREEN)));
	public static final Block RAW_MALACHITE_BLOCK = register(simple(blockWithItem("raw_malachite_block", new Block(ore().mapColor(MapColor.EMERALD)), InkColors.GREEN)));
	public static final Block DEEPSLATE_MALACHITE_ORE = register(simple(blockWithItem("deepslate_malachite_ore", new CloakedOreBlock(UniformInt.of(7, 11), deepslateOre(), SpectrumAdvancements.REVEAL_MALACHITE, Blocks.DEEPSLATE.defaultBlockState()), IS.of(Rarity.UNCOMMON), InkColors.GREEN)));
	...
	public static final Block RAW_BLOODSTONE_BLOCK = register(simple(blockWithItem("raw_bloodstone_block", new Block(ore().mapColor(MapColor.COLOR_RED).sound(SpectrumBlockSoundGroups.ONYX_CLUSTER)), InkColors.RED)));
	...
	public static <T extends Block> BlockRegistrar<T> paltaeria(BlockRegistrar<T> registrar, TexturedModel.Provider factory) {
		return registrar.withBlockModel((ctx, block) ->
				SpectrumModelHelper.createVariantsSupplier(block, factory.create(block, SpectrumModelHelper.paltaeriaModifier(ctx.modelOutput, 0.25f))));
	}
	
	public static <T extends Block> BlockRegistrar<T> simpal(BlockRegistrar<T> registrar) {
	...
	public static final Block CREATIVE_PARTICLE_SPAWNER = register(cutout(singletonWithSoup(blockWithItem("creative_particle_spawner", new CreativeParticleSpawnerBlock(BlockBehaviour.Properties.ofFullCopy(PARTICLE_SPAWNER).strength(-1.0F, 3600000.8F).noLootTable()), block -> new BlockItem(block, IS.of(Rarity.EPIC)), InkColors.PINK), b -> ModelLocationUtils.getModelLocation(PARTICLE_SPAWNER))).withBlockItemModel((ctx, block) -> SpectrumModelHelper.registerParentedItemModel(ctx, block, PARTICLE_SPAWNER, "_off")));
	public static final Block BEDROCK_ANVIL = register(defaultSouthHorizontalFacing(blockWithItem("bedrock_anvil", new BedrockAnvilBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.ANVIL).requiresCorrectToolForDrops().strength(8.0F, 8.0F).sound(SoundType.METAL)), InkColors.BLACK), ModelLocationUtils::getModelLocation));
	
	// SOLID LIQUID CRYSTAL
	public static final Block FROSTBITE_CRYSTAL = register(simple(blockWithItem("frostbite_crystal", new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.GLOWSTONE).mapColor(MapColor.CLAY)), InkColors.LIGHT_BLUE)));
	public static final Block BLAZING_CRYSTAL = register(simple(blockWithItem("blazing_crystal", new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.GLOWSTONE).mapColor(MapColor.COLOR_ORANGE)), IS.of().fireResistant(), InkColors.ORANGE)));
	...
	public static final Block RADIATING_ENDER = register(blockWithItem("radiating_ender", new RadiatingEnderBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.EMERALD_BLOCK).mapColor(MapColor.COLOR_PURPLE)), InkColors.PURPLE).withBlockModel((ctx, block) -> MultiVariantGenerator.multiVariant(block, createModelVariant(TexturedModel.CUBE_TOP_BOTTOM.create(block, ctx.modelOutput))).with(SpectrumModelHelper.createUpDefaultFacingVariantMap())));
	...
	public static final Block CRACKED_END_PORTAL_FRAME = register(blockWithItem("cracked_end_portal_frame", new CrackedEndPortalFrameBlock(settings(MapColor.ICE, SoundType.GLASS, -1.0F, 3600000.0F).instrument(NoteBlockInstrument.BASEDRUM).lightLevel((state) -> 1)), IS.of().fireResistant(), InkColors.PURPLE).withBlockItemModel((ctx, block) -> SpectrumModelHelper.registerParentedItemModel(ctx, block, block, "_none")).withBlockModel((ctx, block) -> MultiVariantGenerator.multiVariant(block).with(PropertyDispatch.property(CrackedEndPortalFrameBlock.FACING_VERTICAL).select(false, net.minecraft.data.models.blockstates.Variant.variant()).select(true, net.minecraft.data.models.blockstates.Variant.variant().with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90))).with(PropertyDispatch.property(CrackedEndPortalFrameBlock.EYE_TYPE).generate(type -> createModelVariant(ModelLocationUtils.getModelLocation(block, "_" + type.getSerializedName()))))));
	public static final Block LAVA_SPONGE = register(simple(blockWithItem("lava_sponge", new LavaSpongeBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.SPONGE).mapColor(MapColor.COLOR_ORANGE)), IS.of().fireResistant(), InkColors.ORANGE)));
	public static final Block WET_LAVA_SPONGE = register(simple(burnable(blockWithItem("wet_lava_sponge", new WetLavaSpongeBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.WET_SPONGE).mapColor(MapColor.COLOR_ORANGE).lightLevel(s -> 9).emissiveRendering(SpectrumBlocks::always).hasPostProcess(SpectrumBlocks::always)), block -> new WetLavaSpongeItem(block, IS.of(1).fireResistant().craftRemainder(LAVA_SPONGE.asItem())), InkColors.ORANGE), 12800)));
	
	public static final Block LIGHT_LEVEL_DETECTOR = register(detector(blockWithItem("light_level_detector", new BlockLightDetectorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.DAYLIGHT_DETECTOR)), InkColors.RED)));
	public static final Block WEATHER_DETECTOR = register(detector(blockWithItem("weather_detector", new WeatherDetectorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.DAYLIGHT_DETECTOR)), InkColors.RED)));
	public static final Block ITEM_DETECTOR = register(detector(blockWithItem("item_detector", new ItemDetectorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.DAYLIGHT_DETECTOR)), InkColors.RED)));
	public static final Block PLAYER_DETECTOR = register(detector(blockWithItem("player_detector", new PlayerDetectorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.DAYLIGHT_DETECTOR)), InkColors.RED)));
	public static final Block CREATURE_DETECTOR = register(detector(blockWithItem("creature_detector", new EntityDetectorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.DAYLIGHT_DETECTOR)), InkColors.RED)));
	public static final Block REDSTONE_TIMER = register(cutout(blockWithItem("redstone_timer", new RedstoneTimerBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.REPEATER)), InkColors.RED)).withPredefinedItemModel().withBlockModel((ctx, block) -> {
	...
	public static final Block REDSTONE_CALCULATOR = register(cutout(blockWithItem("redstone_calculator", new RedstoneCalculatorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.REPEATER)), InkColors.RED)).withPredefinedItemModel().withBlockModel((ctx, block) -> {
		MultiPartGenerator multipart = MultiPartGenerator.multiPart(block);
		for (Direction direction : Direction.Plane.HORIZONTAL) {
			VariantProperties.Rotation rotation = SpectrumModelHelper.getSouthDefaultRotation(direction);
	...
	public static final Block REDSTONE_TRANSCEIVER = register(cutout(blockWithItem("redstone_transceiver", new RedstoneTransceiverBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.REPEATER)), InkColors.RED)).withPredefinedItemModel().withBlockModel((ctx, block) -> {
		MultiPartGenerator multipart = MultiPartGenerator.multiPart(block);
		...
		for (DyeColor color : DyeColor.values()) {
			...
			multipart.with(Condition.condition().term(RedstoneTransceiverBlock.CHANNEL, color), createModelVariant(channel));
		}
		return multipart;
	}));
	public static final Block BLOCK_PLACER = register(blockWithItem("block_placer", new BlockPlacerBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.DISPENSER)), InkColors.CYAN).withBlockModel((ctx, block) -> SpectrumModelHelper.createVariantsSupplier(ctx, block, SpectrumTexturedModels.complexOrientable(b -> b, "_side", b -> b, "_top", b -> NOTCHED_POLISHED_CALCITE, "", b -> b, "_front", b -> b, "_back", b -> b, "_side")).with(SpectrumModelHelper.createUpNorthDefaultOrientationVariantMap())));
	public static final Block BLOCK_DETECTOR = register(blockWithItem("block_detector", new BlockDetectorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.DISPENSER)), InkColors.CYAN).withBlockModel((ctx, block) -> MultiVariantGenerator.multiVariant(block).with(SpectrumModelHelper.createUpNorthDefaultOrientationVariantMap()).with(SpectrumModelHelper.createBooleanModelMap(BlockStateProperties.TRIGGERED, SpectrumTexturedModels.complexOrientable(b -> b, "_side", b -> b, "_top", b -> NOTCHED_POLISHED_BASALT, "", b -> b, "_front", b -> b, "_back_active", b -> b, "_side").createWithSuffix(block, "_active", ctx.modelOutput), SpectrumTexturedModels.complexOrientable(b -> b, "_side", b -> b, "_top", b -> NOTCHED_POLISHED_BASALT, "", b -> b, "_front", b -> b, "_back", b -> b, "_side").create(block, ctx.modelOutput)))));
	...
	public static final Block ENDER_HOPPER = register(singletonWithSoup(blockWithItem("ender_hopper", new EnderHopperBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.HOPPER).mapColor(MapColor.COLOR_GRAY).requiresCorrectToolForDrops().strength(15F, 60.0F)), InkColors.PURPLE), ModelLocationUtils::getModelLocation).withItemModel(SpectrumModelHelper::registerItemModel));
	
	public static final Block OMINOUS_SAPLING = register(simplePlant(blockWithItem("ominous_sapling", new OminousSaplingBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SAPLING)), block -> new OminousSaplingBlockItem(block, IS.of()), InkColors.GREEN)));
	
	public static final Block SPIRIT_SALLOW_LEAVES = register(singleton(blockWithItem("spirit_sallow_leaves", new SpiritSallowLeavesBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LEAVES).mapColor(MapColor.QUARTZ).lightLevel((state) -> 8)), InkColors.GREEN), TexturedModel.LEAVES));
	public static final Block SPIRIT_SALLOW_LOG = register(log(blockWithItem("spirit_sallow_log", new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WOOD).mapColor(MapColor.COLOR_GRAY)), InkColors.GREEN)));
	public static final Block SPIRIT_SALLOW_ROOTS = register(blockWithItem("spirit_sallow_roots", new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WOOD).mapColor(MapColor.COLOR_GRAY)), InkColors.GREEN).withBlockModel((ctx, block) -> {
	...
	public static final Block SPIRIT_SALLOW_HEART = register(singleton(blockWithItem("spirit_sallow_heart", new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WOOD).mapColor(MapColor.COLOR_GRAY).lightLevel(s -> 11)), InkColors.GREEN), SpectrumTexturedModels.cubeColumn(b -> b, "", b -> SPIRIT_SALLOW_LOG, "_top")));
	
	public static final Block SACRED_SOIL = register(blockWithItem("sacred_soil", new ExtraTickFarmlandBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.FARMLAND).mapColor(MapColor.CLAY), Blocks.DIRT.defaultBlockState()), InkColors.LIME).withBlockModel((ctx, block) -> MultiVariantGenerator.multiVariant(block).with(PropertyDispatch.property(BlockStateProperties.MOISTURE).generate(moisture -> createModelVariant(block, moisture == 7 ? "_moist" : "")))));
	...
	public static final Block UPGRADE_SPEED = register(parented(blockWithItem("upgrade_speed", new UpgradeBlock(upgrade(), Upgradeable.UpgradeType.SPEED, 1, InkColors.MAGENTA_COLOR, "upgrade_speed"), block -> new BlockItem(block, IS.of()), InkColors.LIGHT_GRAY), b -> b));
	public static final Block UPGRADE_SPEED2 = register(parented(blockWithItem("upgrade_speed2", new UpgradeBlock(upgrade(), Upgradeable.UpgradeType.SPEED, 2, InkColors.MAGENTA_COLOR, "upgrade_speed2"), block -> new BlockItem(block, IS.of(Rarity.UNCOMMON)), InkColors.LIGHT_GRAY), b -> UPGRADE_SPEED));
	public static final Block UPGRADE_SPEED3 = register(parented(blockWithItem("upgrade_speed3", new UpgradeBlock(upgrade(), Upgradeable.UpgradeType.SPEED, 8, InkColors.MAGENTA_COLOR, "upgrade_speed3"), block -> new BlockItem(block, IS.of(Rarity.RARE)), InkColors.LIGHT_GRAY), b -> UPGRADE_SPEED));
	public static final Block UPGRADE_EFFICIENCY = register(parented(blockWithItem("upgrade_efficiency", new UpgradeBlock(upgrade(), Upgradeable.UpgradeType.EFFICIENCY, 1, InkColors.YELLOW_COLOR, "upgrade_efficiency"), block -> new BlockItem(block, IS.of(Rarity.UNCOMMON)), InkColors.LIGHT_GRAY), b -> b));
	public static final Block UPGRADE_EFFICIENCY2 = register(parented(blockWithItem("upgrade_efficiency2", new UpgradeBlock(upgrade(), Upgradeable.UpgradeType.EFFICIENCY, 4, InkColors.YELLOW_COLOR, "upgrade_efficiency2"), block -> new BlockItem(block, IS.of(Rarity.RARE)), InkColors.LIGHT_GRAY), b -> UPGRADE_EFFICIENCY));
	public static final Block UPGRADE_YIELD = register(parented(blockWithItem("upgrade_yield", new UpgradeBlock(upgrade(), Upgradeable.UpgradeType.YIELD, 1, InkColors.CYAN_COLOR, "upgrade_yield"), block -> new BlockItem(block, IS.of(Rarity.UNCOMMON)), InkColors.LIGHT_GRAY), b -> b));
	public static final Block UPGRADE_YIELD2 = register(parented(blockWithItem("upgrade_yield2", new UpgradeBlock(upgrade(), Upgradeable.UpgradeType.YIELD, 4, InkColors.CYAN_COLOR, "upgrade_yield2"), block -> new BlockItem(block, IS.of(Rarity.RARE)), InkColors.LIGHT_GRAY), b -> UPGRADE_YIELD));
	public static final Block UPGRADE_EXPERIENCE = register(parented(blockWithItem("upgrade_experience", new UpgradeBlock(upgrade(), Upgradeable.UpgradeType.EXPERIENCE, 1, InkColors.PURPLE_COLOR, "upgrade_experience"), block -> new BlockItem(block, IS.of()), InkColors.LIGHT_GRAY), b -> b));
	public static final Block UPGRADE_EXPERIENCE2 = register(parented(blockWithItem("upgrade_experience2", new UpgradeBlock(upgrade(), Upgradeable.UpgradeType.EXPERIENCE, 4, InkColors.PURPLE_COLOR, "upgrade_experience2"), block -> new BlockItem(block, IS.of(Rarity.UNCOMMON)), InkColors.LIGHT_GRAY), b -> UPGRADE_EXPERIENCE));
	
	public static final Block REDSTONE_SAND = register(powered(blockWithItem("redstone_sand", new RedstoneSandBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.SAND).mapColor(MapColor.FIRE)), InkColors.RED)));
	public static final Block ENDER_GLASS = register(translucent(blockWithItem("ender_glass", new EnderGlassBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GLASS).mapColor(MapColor.COLOR_PURPLE).noOcclusion().isRedstoneConductor(SpectrumBlocks::never).isValidSpawn((state, world, pos, entityType) -> state.getValue(EnderGlassBlock.TRANSPARENCY_STATE) == EnderGlassBlock.TransparencyState.SOLID).isSuffocating((state, world, pos) -> state.getValue(EnderGlassBlock.TRANSPARENCY_STATE) == EnderGlassBlock.TransparencyState.SOLID).isViewBlocking((state, world, pos) -> state.getValue(EnderGlassBlock.TRANSPARENCY_STATE) == EnderGlassBlock.TransparencyState.SOLID)), InkColors.PURPLE)).withBlockItemModel((ctx, block) -> SpectrumModelHelper.registerParentedItemModel(ctx, block, block, "_solid")).withBlockModel((ctx, block) ->
			MultiVariantGenerator.multiVariant(block).with(PropertyDispatch.property(EnderGlassBlock.TRANSPARENCY_STATE)
					.generate(transparency -> createModelVariant(SpectrumTexturedModels.cubeAll(b -> b, "_" + transparency.getSerializedName()).createWithSuffix(block, "_" + transparency.getSerializedName(), ctx.modelOutput))))));
	public static final Block CLOVER = register(singletonWithSoup(cutout(blockWithItem("clover", new CloverBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.SHORT_GRASS).offsetType(BlockBehaviour.OffsetType.XZ)), IS.of(), InkColors.LIME)), ModelLocationUtils::getModelLocation).withItemModel(SpectrumModelHelper::registerItemModel));
	...
	public static final Block TOPAZ_ORE = register(simple(blockWithItem("topaz_ore", new GemstoneOreBlock(gemOreExperienceProvider, ore(), BuiltinGemstoneColor.CYAN, SpectrumAdvancements.COLLECT_TOPAZ, Blocks.STONE.defaultBlockState()), InkColors.CYAN)));
	public static final Block AMETHYST_ORE = register(simple(blockWithItem("amethyst_ore", new GemstoneOreBlock(gemOreExperienceProvider, ore(), BuiltinGemstoneColor.MAGENTA, SpectrumAdvancements.COLLECT_AMETHYST, Blocks.STONE.defaultBlockState()), InkColors.MAGENTA)));
	public static final Block CITRINE_ORE = register(simple(blockWithItem("citrine_ore", new GemstoneOreBlock(gemOreExperienceProvider, ore(), BuiltinGemstoneColor.YELLOW, SpectrumAdvancements.COLLECT_CITRINE, Blocks.STONE.defaultBlockState()), InkColors.YELLOW)));
	public static final Block ONYX_ORE = register(simple(blockWithItem("onyx_ore", new GemstoneOreBlock(gemOreExperienceProvider, ore(), BuiltinGemstoneColor.BLACK, SpectrumAdvancements.CREATE_ONYX, Blocks.STONE.defaultBlockState()), InkColors.BLACK)));
	public static final Block MOONSTONE_ORE = register(simple(blockWithItem("moonstone_ore", new GemstoneOreBlock(gemOreExperienceProvider, ore(), BuiltinGemstoneColor.WHITE, SpectrumAdvancements.COLLECT_MOONSTONE, Blocks.STONE.defaultBlockState()), InkColors.WHITE)));
	
	public static final Block DEEPSLATE_TOPAZ_ORE = register(simple(blockWithItem("deepslate_topaz_ore", new GemstoneOreBlock(gemOreExperienceProvider, deepslateOre(), BuiltinGemstoneColor.CYAN, SpectrumAdvancements.COLLECT_TOPAZ, Blocks.DEEPSLATE.defaultBlockState()), InkColors.CYAN)));
	public static final Block DEEPSLATE_AMETHYST_ORE = register(simple(blockWithItem("deepslate_amethyst_ore", new GemstoneOreBlock(gemOreExperienceProvider, deepslateOre(), BuiltinGemstoneColor.MAGENTA, SpectrumAdvancements.COLLECT_AMETHYST, Blocks.DEEPSLATE.defaultBlockState()), InkColors.MAGENTA)));
	public static final Block DEEPSLATE_CITRINE_ORE = register(simple(blockWithItem("deepslate_citrine_ore", new GemstoneOreBlock(gemOreExperienceProvider, deepslateOre(), BuiltinGemstoneColor.YELLOW, SpectrumAdvancements.COLLECT_CITRINE, Blocks.DEEPSLATE.defaultBlockState()), InkColors.YELLOW)));
	public static final Block DEEPSLATE_ONYX_ORE = register(simple(blockWithItem("deepslate_onyx_ore", new GemstoneOreBlock(gemOreExperienceProvider, deepslateOre(), BuiltinGemstoneColor.BLACK, SpectrumAdvancements.CREATE_ONYX, Blocks.DEEPSLATE.defaultBlockState()), InkColors.BLACK)));
	public static final Block DEEPSLATE_MOONSTONE_ORE = register(simple(blockWithItem("deepslate_moonstone_ore", new GemstoneOreBlock(gemOreExperienceProvider, deepslateOre(), BuiltinGemstoneColor.WHITE, SpectrumAdvancements.COLLECT_MOONSTONE, Blocks.DEEPSLATE.defaultBlockState()), InkColors.WHITE)));
	...
	public static final Block POLISHED_TOPAZ = register(simple(blockWithItem("polished_topaz", new Block(polishedGemBlock(MapColor.COLOR_CYAN, SpectrumBlockSoundGroups.TOPAZ_BLOCK)), InkColors.CYAN)));
	public static final Block POLISHED_AMETHYST = register(simple(blockWithItem("polished_amethyst", new Block(polishedGemBlock(MapColor.COLOR_MAGENTA, SoundType.AMETHYST)), InkColors.MAGENTA)));
	public static final Block POLISHED_CITRINE = register(simple(blockWithItem("polished_citrine", new Block(polishedGemBlock(MapColor.COLOR_YELLOW, SpectrumBlockSoundGroups.CITRINE_BLOCK)), InkColors.YELLOW)));
	public static final Block POLISHED_ONYX = register(simple(blockWithItem("polished_onyx", new Block(polishedGemBlock(MapColor.COLOR_BLACK, SpectrumBlockSoundGroups.ONYX_BLOCK)), InkColors.BLACK)));
	public static final Block POLISHED_MOONSTONE = register(simple(blockWithItem("polished_moonstone", new Block(polishedGemBlock(MapColor.SNOW, SpectrumBlockSoundGroups.MOONSTONE_BLOCK)), InkColors.WHITE)));
	
	public static final Block TOPAZ_PILLAR = register(singleton(blockWithItem("topaz_pillar", new Block(polishedGemBlock(MapColor.COLOR_CYAN, SpectrumBlockSoundGroups.TOPAZ_BLOCK)), InkColors.CYAN), TexturedModel.TOP_BOTTOM_WITH_WALL));
	public static final Block AMETHYST_PILLAR = register(singleton(blockWithItem("amethyst_pillar", new Block(polishedGemBlock(MapColor.COLOR_MAGENTA, SoundType.AMETHYST)), InkColors.MAGENTA), TexturedModel.TOP_BOTTOM_WITH_WALL));
	public static final Block CITRINE_PILLAR = register(singleton(blockWithItem("citrine_pillar", new Block(polishedGemBlock(MapColor.COLOR_YELLOW, SpectrumBlockSoundGroups.CITRINE_BLOCK)), InkColors.YELLOW), TexturedModel.TOP_BOTTOM_WITH_WALL));
	public static final Block ONYX_PILLAR = register(singleton(blockWithItem("onyx_pillar", new Block(polishedGemBlock(MapColor.COLOR_BLACK, SpectrumBlockSoundGroups.ONYX_BLOCK)), InkColors.BLACK), TexturedModel.TOP_BOTTOM_WITH_WALL));
	public static final Block MOONSTONE_PILLAR = register(singleton(blockWithItem("moonstone_pillar", new Block(polishedGemBlock(MapColor.SNOW, SpectrumBlockSoundGroups.MOONSTONE_BLOCK)), InkColors.WHITE), TexturedModel.TOP_BOTTOM_WITH_WALL));
	...
	public static final ResonantLilyBlock RESONANT_LILY = register(simplePlant(blockWithItem("resonant_lily", new ResonantLilyBlock(MobEffects.REGENERATION, 5, BlockBehaviour.Properties.ofFullCopy(Blocks.POPPY).mapColor(MapColor.SNOW)), InkColors.GREEN)));
	...
	public static final Block POTTED_SWEET_PEA = register(pottedPlantWithCustomTexture(block("potted_sweet_pea", new FlowerPotBlock(SWEET_PEA, pottedPlant().lightLevel(s -> 11).hasPostProcess(SpectrumBlocks::always).emissiveRendering(SpectrumBlocks::always))), "_potted"));
	public static final Block POTTED_APRICOTTI = register(pottedPlantWithCustomTexture(block("potted_apricotti", new FlowerPotBlock(APRICOTTI, pottedPlant().lightLevel(s -> 11).hasPostProcess(SpectrumBlocks::always).emissiveRendering(SpectrumBlocks::always))), "_potted"));
	public static final Block POTTED_HUMMING_BELL = register(pottedPlantWithCustomTexture(block("potted_humming_bell", new FlowerPotBlock(HUMMING_BELL, pottedPlant().lightLevel(s -> 9).hasPostProcess(SpectrumBlocks::always).emissiveRendering(SpectrumBlocks::always))), "_potted"));
	public static final Block POTTED_VARIA_SPROUT = register(pottedPlant(block("potted_varia_sprout", new FlowerPotBlock(VARIA_SPROUT, pottedPlant().lightLevel(s -> 11).hasPostProcess(SpectrumBlocks::always).emissiveRendering(SpectrumBlocks::always))), false));
	...
	public static ColoredWoodBlock registerColoredWood(String name, ColoredLogBlock logBlock) {
		return register(wood(blockWithItem(name, new ColoredWoodBlock(copyWithMapColor(Blocks.OAK_WOOD, logBlock.defaultMapColor()), logBlock.getColor()), logBlock.getColor()), logBlock));
	}
	...
	public static ColoredStrippedWoodBlock registerColoredStrippedWood(String name, ColoredStrippedLogBlock logBlock) {
		return register(wood(blockWithItem(name, new ColoredStrippedWoodBlock(copyWithMapColor(Blocks.STRIPPED_OAK_WOOD, logBlock.defaultMapColor()), logBlock.getColor()), logBlock.getColor()), logBlock));
	}
	...
	public static final Block GRANITE_SHIMMERSTONE_LIGHT = registerShimmerstoneLight("granite_shimmerstone_light", SoundType.STONE, () -> ModelLocationUtils.getModelLocation(Blocks.POLISHED_GRANITE));
	public static final Block DIORITE_SHIMMERSTONE_LIGHT = registerShimmerstoneLight("diorite_shimmerstone_light", SoundType.STONE, () -> ModelLocationUtils.getModelLocation(Blocks.POLISHED_DIORITE));
	public static final Block ANDESITE_SHIMMERSTONE_LIGHT = registerShimmerstoneLight("andesite_shimmerstone_light", SoundType.STONE, () -> ModelLocationUtils.getModelLocation(Blocks.POLISHED_ANDESITE));
	...
	public static final Block SMALL_COAL_BUD = register(cluster(blockWithItem("small_coal_bud", new SpectrumClusterBlock(crystallarieumGrowable(Blocks.COAL_BLOCK), SpectrumClusterBlock.GrowthStage.SMALL), InkColors.BROWN), SpectrumModels.CRYSTALLARIEUM_FARMABLE));
	...
	public static final Block SMALL_IRON_BUD = register(cluster(blockWithItem("small_iron_bud", new SpectrumClusterBlock(crystallarieumGrowable(Blocks.IRON_BLOCK), SpectrumClusterBlock.GrowthStage.SMALL), InkColors.BROWN), SpectrumModels.CRYSTALLARIEUM_FARMABLE));
	...
	public static final Block SMALL_GOLD_BUD = register(cluster(blockWithItem("small_gold_bud", new SpectrumClusterBlock(crystallarieumGrowable(Blocks.GOLD_BLOCK), SpectrumClusterBlock.GrowthStage.SMALL), InkColors.BROWN), SpectrumModels.CRYSTALLARIEUM_FARMABLE));
	...
	public static final Block SMALL_DIAMOND_BUD = register(cluster(blockWithItem("small_diamond_bud", new SpectrumClusterBlock(crystallarieumGrowable(Blocks.DIAMOND_BLOCK), SpectrumClusterBlock.GrowthStage.SMALL), InkColors.CYAN), SpectrumModels.CRYSTALLARIEUM_FARMABLE));
	...
	public static final Block SMALL_EMERALD_BUD = register(cluster(blockWithItem("small_emerald_bud", new SpectrumClusterBlock(crystallarieumGrowable(Blocks.EMERALD_BLOCK), SpectrumClusterBlock.GrowthStage.SMALL), InkColors.CYAN), SpectrumModels.CRYSTALLARIEUM_FARMABLE));
	...
	public static final Block SMALL_REDSTONE_BUD = register(cluster(blockWithItem("small_redstone_bud", new SpectrumClusterBlock(crystallarieumGrowable(Blocks.REDSTONE_BLOCK), SpectrumClusterBlock.GrowthStage.SMALL), InkColors.RED), SpectrumModels.CRYSTALLARIEUM_FARMABLE));
	...
	public static final Block SMALL_LAPIS_BUD = register(cluster(blockWithItem("small_lapis_bud", new SpectrumClusterBlock(crystallarieumGrowable(Blocks.LAPIS_BLOCK), SpectrumClusterBlock.GrowthStage.SMALL), InkColors.PURPLE), SpectrumModels.CRYSTALLARIEUM_FARMABLE));
	...
	public static final Block SMALL_COPPER_BUD = register(cluster(blockWithItem("small_copper_bud", new SpectrumClusterBlock(crystallarieumGrowable(Blocks.COPPER_BLOCK), SpectrumClusterBlock.GrowthStage.SMALL), InkColors.BROWN), SpectrumModels.CRYSTALLARIEUM_FARMABLE));
	...
	public static final Block SMALL_QUARTZ_BUD = register(cluster(blockWithItem("small_quartz_bud", new SpectrumClusterBlock(crystallarieumGrowable(Blocks.QUARTZ_BLOCK), SpectrumClusterBlock.GrowthStage.SMALL), InkColors.BROWN), SpectrumModels.CRYSTALLARIEUM_FARMABLE));
	...
	public static final Block SMALL_NETHERITE_SCRAP_BUD = register(cluster(blockWithItem("small_netherite_scrap_bud", new SpectrumClusterBlock(crystallarieumGrowable(Blocks.ANCIENT_DEBRIS), SpectrumClusterBlock.GrowthStage.SMALL), IS.of().fireResistant(), InkColors.BROWN), SpectrumModels.CRYSTALLARIEUM_FARMABLE));
	...
	public static final Block SMALL_ECHO_BUD = register(cluster(blockWithItem("small_echo_bud", new SpectrumClusterBlock(crystallarieumGrowable(Blocks.SCULK), SpectrumClusterBlock.GrowthStage.SMALL), InkColors.BROWN), SpectrumModels.CRYSTALLARIEUM_FARMABLE));
	...
	public static final Block SMALL_GLOWSTONE_BUD = register(cluster(blockWithItem("small_glowstone_bud", new SpectrumClusterBlock(crystallarieumGrowable(Blocks.GLOWSTONE).lightLevel(state -> 4), SpectrumClusterBlock.GrowthStage.SMALL), InkColors.YELLOW), SpectrumModels.CRYSTALLARIEUM_FARMABLE));
	...
	public static final Block SMALL_PRISMARINE_BUD = register(cluster(blockWithItem("small_prismarine_bud", new SpectrumClusterBlock(crystallarieumGrowable(Blocks.SCULK), SpectrumClusterBlock.GrowthStage.SMALL), InkColors.CYAN), SpectrumModels.CRYSTALLARIEUM_FARMABLE));
	...
	public static final Block PURE_COAL_BLOCK = register(simple(burnable(blockWithItem("pure_coal_block", new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.COAL_BLOCK)), InkColors.BROWN), 32000)));
	public static final Block PURE_IRON_BLOCK = register(simple(blockWithItem("pure_iron_block", new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK)), InkColors.BROWN)));
	public static final Block PURE_GOLD_BLOCK = register(simple(blockWithItem("pure_gold_block", new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.GOLD_BLOCK)), InkColors.BROWN)));
	public static final Block PURE_DIAMOND_BLOCK = register(simple(blockWithItem("pure_diamond_block", new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.DIAMOND_BLOCK)), InkColors.CYAN)));
	public static final Block PURE_EMERALD_BLOCK = register(simple(blockWithItem("pure_emerald_block", new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.EMERALD_BLOCK)), InkColors.CYAN)));
	public static final Block PURE_REDSTONE_BLOCK = register(simple(blockWithItem("pure_redstone_block", new PureRedstoneBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.REDSTONE_BLOCK)), InkColors.RED)));
	public static final Block PURE_LAPIS_BLOCK = register(simple(blockWithItem("pure_lapis_block", new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.LAPIS_BLOCK)), InkColors.PURPLE)));
	public static final Block PURE_COPPER_BLOCK = register(simple(blockWithItem("pure_copper_block", new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.COPPER_BLOCK)), InkColors.BROWN)));
	public static final Block PURE_QUARTZ_BLOCK = register(simple(blockWithItem("pure_quartz_block", new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.QUARTZ_BLOCK)), InkColors.BROWN)));
	public static final Block PURE_GLOWSTONE_BLOCK = register(simple(blockWithItem("pure_glowstone_block", new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.GLOWSTONE)), InkColors.YELLOW)));
	public static final Block PURE_PRISMARINE_BLOCK = register(simple(blockWithItem("pure_prismarine_block", new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.PRISMARINE)), InkColors.CYAN)));
	public static final Block PURE_NETHERITE_SCRAP_BLOCK = register(simple(blockWithItem("pure_netherite_scrap_block", new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.ANCIENT_DEBRIS)), IS.of().fireResistant(), InkColors.BROWN)));
	public static final Block PURE_ECHO_BLOCK = register(simple(blockWithItem("pure_echo_block", new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.DIAMOND_BLOCK)), InkColors.BROWN)));
	...
	public static final Block PRESERVATION_CHEST = register(singletonWithSoup(blockWithItem("preservation_chest", new PreservationChestBlock(preservationBlock()), InkColors.BLUE), ModelLocationUtils::getModelLocation));
	...
	public static final Block SHIMMERING_PRESERVATION_BRICKS = register(blockWithItem("shimmering_preservation_bricks", new Block(preservationBlock().lightLevel(s -> 5)), InkColors.BLUE).withBlockModel((ctx, block) -> MultiVariantGenerator.multiVariant(block, createModelVariant(TexturedModel.CUBE.create(block, ctx.modelOutput)), createModelVariant(SpectrumTexturedModels.cubeAll(b -> b, "_fast").createWithSuffix(block, "_fast", ctx.modelOutput)), createModelVariant(SpectrumTexturedModels.cubeAll(b -> b, "_slow").createWithSuffix(block, "_slow", ctx.modelOutput)))));
	public static final Block COURIER_STATUE = register(cutout(blockWithItem("courier_statue", new StatueBlock(preservationBlock()), InkColors.BLUE)).withBlockItemModel((ctx, block) -> SpectrumModelHelper.registerParentedItemModel(ctx, block, block, "_top")).withBlockModel((ctx, block) -> MultiVariantGenerator.multiVariant(block).with(SpectrumModelHelper.createNorthDefaultHorizontalFacingVariantMap()).with(PropertyDispatch.property(StatueBlock.HALF).select(DoubleBlockHalf.LOWER, createModelVariant(block, "_bottom")).select(DoubleBlockHalf.UPPER, createModelVariant(block, "_top")))));
	public static final Block MANXI = register(singletonWithSoup(block("manxi", new ManxiBlock(preservationBlock().noOcclusion().noCollission().noLootTable())), b -> SpectrumModels.MOB_HEAD));
	...
	public static final Block PRESERVATION_BLOCK_DETECTOR = register(blockWithItem("preservation_block_detector", new PreservationBlockDetectorBlock(preservationBlock()), InkColors.BLUE).withBlockModel((ctx, block) -> MultiVariantGenerator.multiVariant(block, createModelVariant(SpectrumTexturedModels.complexOrientable(b -> b, "_side", b -> b, "_top", b -> PRESERVATION_STONE, "_top_generic", b -> b, "_front", b -> b, "_back", b -> b, "_side").create(block, ctx.modelOutput))).with(SpectrumModelHelper.createNorthDefaultFacingVariantMap())));
	...
	public static final Block STARDUST_BLOCK = register(simple(blockWithItem("stardust_block", new ColoredFallingBlock(new ColorRGBA(DyeColor.PURPLE.getFireworkColor()), BlockBehaviour.Properties.ofFullCopy(Blocks.SAND).mapColor(MapColor.COLOR_PURPLE)), IS.of(Rarity.UNCOMMON), InkColors.BLACK)));
	
	public static final Block INCANDESCENT_AMALGAM = register(cutout(singletonWithSoup(blockWithItem("incandescent_amalgam", new IncandescentAmalgamBlock(BlockBehaviour.Properties.of().instabreak().noOcclusion()), block -> new IncandescentAmalgamItem(block, IS.of().food(SpectrumFoodComponents.INCANDESCENT_AMALGAM)), InkColors.RED), ModelLocationUtils::getModelLocation)).withBlockItemModel(SpectrumModelHelper::registerBlockTexturedItemModel));
	...
	public static <T extends FlowerPotBlock> BlockRegistrar<T> pottedPlantWithCustomTexture(BlockRegistrar<T> registrar, String suffix) {
		return cutout(registrar).withBlockModel((ctx, block) -> SpectrumModelHelper.pottedPlantWithCustomTextureBlockModel(ctx, block, suffix));
	}
	...
	public static PropertyDispatch createPoweredMap(IntegerProperty property, BlockModelGenerators ctx, Block block) {
		...
		v.select(0, createModelVariant(SpectrumTexturedModels.cubeAll(b -> b, "").create(block, ctx.modelOutput)));
		for (int i = 1; i < 16; i++) {
			v.select(i, createModelVariant(SpectrumTexturedModels.cubeAll(b -> b, "_" + i).createWithSuffix(block, "_" + i, ctx.modelOutput)));
		}
		return v;
	}
	...
	public static <T extends Block> BlockRegistrar<T> sugarStick(BlockRegistrar<T> registrar, UnaryOperator<Block> sugarBlock) {
		return registrar.withItemModel(SpectrumModelHelper::registerItemModel).withBlockModel((ctx, block) -> MultiVariantGenerator.multiVariant(block).with(PropertyDispatch.property(BlockStateProperties.AGE_2).generate(age -> createModelVariant(SpectrumTexturedModels.sugarStick(age, sugarBlock).createWithSuffix(block, age.toString(), ctx.modelOutput)))));
	}
