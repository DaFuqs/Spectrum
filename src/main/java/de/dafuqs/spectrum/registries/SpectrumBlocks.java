...
public class SpectrumBlocks {
	...
	//DD FLORA
	public static final Block SAWBLADE_GRASS = new SpectrumSpreadableBlock(AbstractBlock.Settings.copy(Blocks.PODZOL).sounds(BlockSoundGroup.AZALEA_LEAVES).ticksRandomly(), BLACKSLAG, BLACKSLAG);
	public static final Block SHIMMEL = new SpectrumSpreadableBlock(AbstractBlock.Settings.copy(Blocks.MYCELIUM).sounds(BlockSoundGroup.WART_BLOCK).ticksRandomly(), BLACKSLAG, BLACKSLAG);
	public static final Block OVERGROWN_BLACKSLAG = new SpectrumSpreadableBlock(AbstractBlock.Settings.copy(Blocks.PODZOL).sounds(BlockSoundGroup.VINE).velocityMultiplier(0.925F).ticksRandomly(), BLACKSLAG, BLACKSLAG);
