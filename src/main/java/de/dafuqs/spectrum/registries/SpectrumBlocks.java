...
public class SpectrumBlocks {
	...
	public static final Block ENCHANTER = register(cutout(singletonWithSoup(blockWithItem("enchanter", new EnchanterBlock(craftingBlock(MapColor.TERRACOTTA_WHITE, SoundType.CALCITE)), IS.of(1), InkColors.PURPLE), ModelLocationUtils::getModelLocation)));
	public static final Block ITEM_BOWL_BASALT = register(cutout(singleton(blockWithItem("item_bowl_basalt", new ItemBowlBlock(craftingBlock(MapColor.COLOR_BLACK, SoundType.BASALT)), IS.of(16), InkColors.PINK), TexturedModel.createDefault(b -> new TextureMapping().put(TextureSlot.TEXTURE, locate("block/item_bowl_basalt")).put(TextureSlot.SIDE, locate("block/polished_basalt_pillar_side")).put(SpectrumTextureKeys.BASE, locate("block/polished_basalt")), SpectrumModels.BOWL))));
	...
	public static final Block SPIRIT_INSTILLER = register(singletonWithSoup(cutout(blockWithItem("spirit_instiller", new SpiritInstillerBlock(craftingBlock(MapColor.TERRACOTTA_WHITE, SoundType.CALCITE)), IS.of(1), InkColors.WHITE)), ModelLocationUtils::getModelLocation).withPredefinedItemModel());
	...
	public static final Block CRYSTAL_APOTHECARY = register(singletonWithSoup(blockWithItem("crystal_apothecary", new CrystalApothecaryBlock(craftingBlock(MapColor.TERRACOTTA_WHITE, SoundType.CALCITE)), IS.of(8), InkColors.GREEN), (ModelLocationUtils::getModelLocation)));
