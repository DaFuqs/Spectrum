...
public class SpectrumBlocks {
	...
	public static final Block CONNECTION_NODE = register(cutout(defaultUpFacing(blockWithItem("connection_node", new PastelNodeBlock(pastelNode(SoundType.AMETHYST_CLUSTER), PastelNodeType.CONNECTION), IS.of(16), InkColors.LIGHT_GRAY), SpectrumTexturedModels.parented(SpectrumModels.CONNECTION_NODE))).withPredefinedItemModel());
	public static final Block PROVIDER_NODE = register(cutout(defaultUpFacing(blockWithItem("provider_node", new PastelNodeBlock(pastelNode(SoundType.AMETHYST_CLUSTER), PastelNodeType.PROVIDER), IS.of(16), InkColors.MAGENTA), SpectrumTexturedModels.parented(SpectrumModels.PROVIDER_NODE))).withPredefinedItemModel());
	public static final Block STORAGE_NODE = register(cutout(defaultUpFacing(blockWithItem("storage_node", new PastelNodeBlock(pastelNode(SpectrumBlockSoundGroups.TOPAZ_CLUSTER), PastelNodeType.STORAGE), IS.of(16), InkColors.CYAN), SpectrumTexturedModels.parented(SpectrumModels.STORAGE_NODE))).withPredefinedItemModel());
	public static final Block SENDER_NODE = register(cutout(defaultUpFacing(blockWithItem("sender_node", new PastelNodeBlock(pastelNode(SpectrumBlockSoundGroups.CITRINE_CLUSTER), PastelNodeType.SENDER), IS.of(16), InkColors.YELLOW), SpectrumTexturedModels.parented(SpectrumModels.SENDER_NODE))).withPredefinedItemModel());
	public static final Block GATHER_NODE = register(cutout(defaultUpFacing(blockWithItem("gather_node", new PastelNodeBlock(pastelNode(SpectrumBlockSoundGroups.ONYX_CLUSTER), PastelNodeType.GATHER), IS.of(16), InkColors.BLACK), SpectrumTexturedModels.parented(SpectrumModels.GATHER_NODE))).withPredefinedItemModel());
	...
	public static final Block STARDUST_BLOCK = register(simple(blockWithItem("stardust_block", new ColoredFallingBlock(new ColorRGBA(DyeColor.PURPLE.getFireworkColor()), BlockBehaviour.Properties.ofFullCopy(Blocks.SAND).mapColor(MapColor.COLOR_PURPLE)), IS.of(1, Rarity.UNCOMMON), InkColors.BLACK).withBlockItemModel(SpectrumModelHelper::registerBlockTexturedItemModel)));
