...
public class SpectrumBlocks {
	...
	public static final DeferredBlock<Block> BLACKSLAG_STAIRS = register(blockWithItem("blackslag_stairs", new StairBlock(BLACKSLAG.defaultBlockState(), blackslag(SoundType.DEEPSLATE)), InkColors.BLACK));
	...
	public static final DeferredBlock<Block> INFESTED_BLACKSLAG = register(parented(blockWithItem("infested_blackslag", new InfestedBlock(BLACKSLAG, blackslag(SoundType.DEEPSLATE)), InkColors.BLACK), b -> BLACKSLAG));
	...
	public static final DeferredBlock<Block> COBBLED_BLACKSLAG_STAIRS = register(blockWithItem("cobbled_blackslag_stairs", new StairBlock(COBBLED_BLACKSLAG.defaultBlockState(), blackslag(SoundType.DEEPSLATE)), InkColors.BLACK));
	...
	public static final DeferredBlock<Block> BLACKSLAG_TILE_STAIRS = register(blockWithItem("blackslag_tile_stairs", new StairBlock(BLACKSLAG_TILES.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(BLACKSLAG_TILES)), InkColors.BLACK));
	public static final DeferredBlock<Block> BLACKSLAG_TILE_SLAB = register(blockWithItem("blackslag_tile_slab", new SlabBlock(BlockBehaviour.Properties.ofFullCopy(BLACKSLAG_TILES)), InkColors.BLACK));
	public static final DeferredBlock<Block> BLACKSLAG_TILE_WALL = register(blockWithItem("blackslag_tile_wall", new WallBlock(BlockBehaviour.Properties.ofFullCopy(BLACKSLAG_TILES)), InkColors.BLACK));
	public static final DeferredBlock<Block> CRACKED_BLACKSLAG_TILES = register(blockWithItem("cracked_blackslag_tiles", new Block(BlockBehaviour.Properties.ofFullCopy(BLACKSLAG_TILES)), InkColors.BLACK));
	...
	public static final DeferredBlock<Block> BLACKSLAG_BRICK_STAIRS = register(blockWithItem("blackslag_brick_stairs", new StairBlock(BLACKSLAG_BRICKS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(BLACKSLAG_BRICKS)), InkColors.BLACK));
	public static final DeferredBlock<Block> BLACKSLAG_BRICK_SLAB = register(blockWithItem("blackslag_brick_slab", new SlabBlock(BlockBehaviour.Properties.ofFullCopy(BLACKSLAG_BRICKS)), InkColors.BLACK));
	public static final DeferredBlock<Block> BLACKSLAG_BRICK_WALL = register(blockWithItem("blackslag_brick_wall", new WallBlock(BlockBehaviour.Properties.ofFullCopy(BLACKSLAG_BRICKS)), InkColors.BLACK));
	public static final DeferredBlock<Block> CRACKED_BLACKSLAG_BRICKS = register(blockWithItem("cracked_blackslag_bricks", new Block(BlockBehaviour.Properties.ofFullCopy(BLACKSLAG_BRICKS)), InkColors.BLACK));
	...
	public static final DeferredBlock<Block> POLISHED_BLACKSLAG_STAIRS = register(blockWithItem("polished_blackslag_stairs", new StairBlock(POLISHED_BLACKSLAG.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(POLISHED_BLACKSLAG)), InkColors.BLACK));
	public static final DeferredBlock<Block> POLISHED_BLACKSLAG_SLAB = register(blockWithItem("polished_blackslag_slab", new SlabBlock(BlockBehaviour.Properties.ofFullCopy(POLISHED_BLACKSLAG)), InkColors.BLACK));
	public static final DeferredBlock<Block> POLISHED_BLACKSLAG_WALL = register(blockWithItem("polished_blackslag_wall", new WallBlock(BlockBehaviour.Properties.ofFullCopy(POLISHED_BLACKSLAG)), InkColors.BLACK));
	...
	public static final DeferredBlock<Block> POLISHED_BLACKSLAG_PILLAR = register(axisRotated(blockWithItem("polished_blackslag_pillar", new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(BLACKSLAG_BRICKS)), InkColors.BLACK), TexturedModel.createDefault(b -> SpectrumTextureMaps.sideEnd(b, "", CHISELED_POLISHED_BLACKSLAG, ""), ModelTemplates.CUBE_COLUMN)));
	...
	public static final DeferredBlock<Block> TILLED_SHALE_CLAY = register(singleton(blockWithItem("tilled_shale_clay", new TilledShaleClayBlock(BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY), SHALE_CLAY.defaultBlockState()), InkColors.BROWN), SpectrumTexturedModels.farmland(b -> SHALE_CLAY, "_side", b -> b, "")));
	
	public static final DeferredBlock<Block> POLISHED_SHALE_CLAY = register(blockWithItem("polished_shale_clay", new WeatheringBlock(Weathering.WeatheringLevel.UNAFFECTED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final DeferredBlock<Block> POLISHED_SHALE_CLAY_STAIRS = register(blockWithItem("polished_shale_clay_stairs", new WeatheringStairsBlock(Weathering.WeatheringLevel.UNAFFECTED, POLISHED_SHALE_CLAY.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final DeferredBlock<Block> POLISHED_SHALE_CLAY_SLAB = register(blockWithItem("polished_shale_clay_slab", new WeatheringSlabBlock(Weathering.WeatheringLevel.UNAFFECTED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	...
	public static final DeferredBlock<Block> EXPOSED_POLISHED_SHALE_CLAY = register(blockWithItem("exposed_polished_shale_clay", new WeatheringBlock(Weathering.WeatheringLevel.EXPOSED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final DeferredBlock<Block> EXPOSED_POLISHED_SHALE_CLAY_STAIRS = register(blockWithItem("exposed_polished_shale_clay_stairs", new WeatheringStairsBlock(Weathering.WeatheringLevel.EXPOSED, EXPOSED_POLISHED_SHALE_CLAY.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final DeferredBlock<Block> EXPOSED_POLISHED_SHALE_CLAY_SLAB = register(blockWithItem("exposed_polished_shale_clay_slab", new WeatheringSlabBlock(Weathering.WeatheringLevel.EXPOSED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	...
	public static final DeferredBlock<Block> WEATHERED_POLISHED_SHALE_CLAY = register(blockWithItem("weathered_polished_shale_clay", new WeatheringBlock(Weathering.WeatheringLevel.WEATHERED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final DeferredBlock<Block> WEATHERED_POLISHED_SHALE_CLAY_STAIRS = register(blockWithItem("weathered_polished_shale_clay_stairs", new WeatheringStairsBlock(Weathering.WeatheringLevel.WEATHERED, WEATHERED_POLISHED_SHALE_CLAY.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final DeferredBlock<Block> WEATHERED_POLISHED_SHALE_CLAY_SLAB = register(blockWithItem("weathered_polished_shale_clay_slab", new WeatheringSlabBlock(Weathering.WeatheringLevel.WEATHERED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	...
	public static final DeferredBlock<Block> SHALE_CLAY_BRICKS = register(blockWithItem("shale_clay_bricks", new WeatheringBlock(Weathering.WeatheringLevel.UNAFFECTED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final DeferredBlock<Block> SHALE_CLAY_BRICK_STAIRS = register(blockWithItem("shale_clay_brick_stairs", new WeatheringStairsBlock(Weathering.WeatheringLevel.UNAFFECTED, SHALE_CLAY_BRICKS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final DeferredBlock<Block> SHALE_CLAY_BRICK_SLAB = register(blockWithItem("shale_clay_brick_slab", new WeatheringSlabBlock(Weathering.WeatheringLevel.UNAFFECTED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	...
	public static final DeferredBlock<Block> EXPOSED_SHALE_CLAY_BRICKS = register(blockWithItem("exposed_shale_clay_bricks", new WeatheringBlock(Weathering.WeatheringLevel.EXPOSED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final DeferredBlock<Block> EXPOSED_SHALE_CLAY_BRICK_STAIRS = register(blockWithItem("exposed_shale_clay_brick_stairs", new WeatheringStairsBlock(Weathering.WeatheringLevel.EXPOSED, EXPOSED_SHALE_CLAY_BRICKS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final DeferredBlock<Block> EXPOSED_SHALE_CLAY_BRICK_SLAB = register(blockWithItem("exposed_shale_clay_brick_slab", new WeatheringSlabBlock(Weathering.WeatheringLevel.EXPOSED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	...
	public static final DeferredBlock<Block> WEATHERED_SHALE_CLAY_BRICKS = register(blockWithItem("weathered_shale_clay_bricks", new WeatheringBlock(Weathering.WeatheringLevel.WEATHERED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final DeferredBlock<Block> WEATHERED_SHALE_CLAY_BRICK_STAIRS = register(blockWithItem("weathered_shale_clay_brick_stairs", new WeatheringStairsBlock(Weathering.WeatheringLevel.WEATHERED, WEATHERED_SHALE_CLAY_BRICKS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final DeferredBlock<Block> WEATHERED_SHALE_CLAY_BRICK_SLAB = register(blockWithItem("weathered_shale_clay_brick_slab", new WeatheringSlabBlock(Weathering.WeatheringLevel.WEATHERED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	...
	public static final DeferredBlock<Block> SHALE_CLAY_TILES = register(blockWithItem("shale_clay_tiles", new WeatheringBlock(Weathering.WeatheringLevel.UNAFFECTED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final DeferredBlock<Block> SHALE_CLAY_TILE_STAIRS = register(blockWithItem("shale_clay_tile_stairs", new WeatheringStairsBlock(Weathering.WeatheringLevel.UNAFFECTED, SHALE_CLAY_TILES.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final DeferredBlock<Block> SHALE_CLAY_TILE_SLAB = register(blockWithItem("shale_clay_tile_slab", new WeatheringSlabBlock(Weathering.WeatheringLevel.UNAFFECTED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	...
	public static final DeferredBlock<Block> EXPOSED_SHALE_CLAY_TILES = register(blockWithItem("exposed_shale_clay_tiles", new WeatheringBlock(Weathering.WeatheringLevel.EXPOSED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final DeferredBlock<Block> EXPOSED_SHALE_CLAY_TILE_STAIRS = register(blockWithItem("exposed_shale_clay_tile_stairs", new WeatheringStairsBlock(Weathering.WeatheringLevel.EXPOSED, EXPOSED_SHALE_CLAY_TILES.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final DeferredBlock<Block> EXPOSED_SHALE_CLAY_TILE_SLAB = register(blockWithItem("exposed_shale_clay_tile_slab", new WeatheringSlabBlock(Weathering.WeatheringLevel.EXPOSED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	...
	public static final DeferredBlock<Block> WEATHERED_SHALE_CLAY_TILES = register(blockWithItem("weathered_shale_clay_tiles", new WeatheringBlock(Weathering.WeatheringLevel.WEATHERED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final DeferredBlock<Block> WEATHERED_SHALE_CLAY_TILE_STAIRS = register(blockWithItem("weathered_shale_clay_tile_stairs", new WeatheringStairsBlock(Weathering.WeatheringLevel.WEATHERED, WEATHERED_SHALE_CLAY_TILES.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	public static final DeferredBlock<Block> WEATHERED_SHALE_CLAY_TILE_SLAB = register(blockWithItem("weathered_shale_clay_tile_slab", new WeatheringSlabBlock(Weathering.WeatheringLevel.WEATHERED, BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY)), InkColors.BROWN));
	...
	public static final DeferredBlock<Block> PYRITE_SLAB = register(blockWithItem("pyrite_slab", new SlabBlock(BlockBehaviour.Properties.ofFullCopy(PYRITE)), InkColors.BROWN));
	public static final DeferredBlock<Block> PYRITE_STAIRS = register(blockWithItem("pyrite_stairs", new StairBlock(PYRITE.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(PYRITE)), InkColors.BROWN));
	public static final DeferredBlock<Block> PYRITE_WALL = register(blockWithItem("pyrite_wall", new WallBlock(BlockBehaviour.Properties.ofFullCopy(PYRITE)), InkColors.BROWN));
	...
	public static final DeferredBlock<Block> PYRITE_PILE = register(axisRotated(blockWithItem("pyrite_pile", new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(PYRITE)), InkColors.BROWN), TexturedModel.COLUMN));
	public static final DeferredBlock<Block> PYRITE_PLATING = register(simple(blockWithItem("pyrite_plating", new Block(BlockBehaviour.Properties.ofFullCopy(PYRITE)), InkColors.BROWN)));
	public static final DeferredBlock<Block> PYRITE_TUBING = register(axisRotated(blockWithItem("pyrite_tubing", new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(PYRITE)), InkColors.BROWN), TexturedModel.COLUMN));
	public static final DeferredBlock<Block> PYRITE_RELIEF = register(axisRotated(blockWithItem("pyrite_relief", new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(PYRITE)), InkColors.BROWN), SpectrumTexturedModels.cubeColumn(b -> b, "_side", b -> PYRITE_TUBING, "_top")));
	public static final DeferredBlock<Block> PYRITE_STACK = register(simple(blockWithItem("pyrite_stack", new Block(BlockBehaviour.Properties.ofFullCopy(PYRITE)), InkColors.BROWN)));
	public static final DeferredBlock<Block> PYRITE_PANELING = register(singleton(blockWithItem("pyrite_paneling", new Block(BlockBehaviour.Properties.ofFullCopy(PYRITE)), InkColors.BROWN), SpectrumTexturedModels.cubeColumn(b -> b, "", b -> PYRITE_PLATING, "")));
	public static final DeferredBlock<Block> PYRITE_VENT = register(singleton(blockWithItem("pyrite_vent", new Block(BlockBehaviour.Properties.ofFullCopy(PYRITE)), InkColors.BROWN), SpectrumTexturedModels.cubeColumn(b -> b, "", b -> PYRITE_PLATING, "")));
	public static final DeferredBlock<Block> PYRITE_RIPPER = register(mippedCutout(blockWithItem("pyrite_ripper", new PyriteRipperBlock(BlockBehaviour.Properties.ofFullCopy(PYRITE).noOcclusion().isValidSpawn(SpectrumBlocks::never).isViewBlocking(SpectrumBlocks::never)), InkColors.BROWN)).withBlockModel((ctx, block) -> MultiVariantGenerator.multiVariant(block).with(PropertyDispatch.properties(BlockStateProperties.FACING, PyriteRipperBlock.MIRRORED)
	...
	public static final DeferredBlock<Block> PYRITE_PROJECTOR = register(singletonWithSoup(blockWithItem("pyrite_projector", new ProjectorBlock(BlockBehaviour.Properties.ofFullCopy(PYRITE), "pyrite_projector_projection", 16, 14, 1.375F, 1F, 16F), InkColors.BROWN), ModelLocationUtils::getModelLocation));
	
	public static final DeferredBlock<Block> PYRITE_TILES = register(simple(blockWithItem("pyrite_tiles", new Block(BlockBehaviour.Properties.ofFullCopy(PYRITE)), InkColors.BROWN)));
	public static final DeferredBlock<Block> PYRITE_TILE_SLAB = register(blockWithItem("pyrite_tile_slab", new SlabBlock(BlockBehaviour.Properties.ofFullCopy(PYRITE_TILES)), InkColors.BROWN));
	public static final DeferredBlock<Block> PYRITE_TILE_STAIRS = register(blockWithItem("pyrite_tile_stairs", new StairBlock(PYRITE_TILES.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(PYRITE_TILES)), InkColors.BROWN));
	public static final DeferredBlock<Block> PYRITE_TILE_WALL = register(blockWithItem("pyrite_tile_wall", new WallBlock(BlockBehaviour.Properties.ofFullCopy(PYRITE_TILES)), InkColors.BROWN));
	...
	public static final DeferredBlock<Block> POLISHED_BONE_ASH = register(blockWithItem("polished_bone_ash", new Block(BlockBehaviour.Properties.ofFullCopy(CRACKED_DRAGONBONE).destroyTime(1500.0F).mapColor(MapColor.SNOW)), InkColors.CYAN));
	public static final DeferredBlock<Block> POLISHED_BONE_ASH_STAIRS = register(blockWithItem("polished_bone_ash_stairs", new StairBlock(POLISHED_BONE_ASH.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(POLISHED_BONE_ASH)), InkColors.CYAN));
	public static final DeferredBlock<Block> POLISHED_BONE_ASH_SLAB = register(blockWithItem("polished_bone_ash_slab", new SlabBlock(BlockBehaviour.Properties.ofFullCopy(POLISHED_BONE_ASH)), InkColors.CYAN));
	public static final DeferredBlock<Block> POLISHED_BONE_ASH_WALL = register(blockWithItem("polished_bone_ash_wall", new WallBlock(BlockBehaviour.Properties.ofFullCopy(POLISHED_BONE_ASH)), InkColors.CYAN));
	...
	public static final DeferredBlock<Block> POLISHED_BONE_ASH_PILLAR = register(axisRotated(blockWithItem("polished_bone_ash_pillar", new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(POLISHED_BONE_ASH)), InkColors.CYAN), TexturedModel.COLUMN));
	public static final DeferredBlock<Block> BONE_ASH_SHINGLES = register(blockWithItem("bone_ash_shingles", new ShinglesBlock(BlockBehaviour.Properties.ofFullCopy(POLISHED_BONE_ASH).noOcclusion()), InkColors.CYAN).withBlockModel((ctx, block) -> SpectrumModelHelper.createVariantsSupplier(block, ModelLocationUtils.getModelLocation(block)).with(SpectrumModelHelper.createEastDefaultHorizontalFacingVariantMap())));
	
	public static final DeferredBlock<Block> BONE_ASH_BRICKS = register(blockWithItem("bone_ash_bricks", new Block(BlockBehaviour.Properties.ofFullCopy(POLISHED_BONE_ASH)), InkColors.CYAN));
	public static final DeferredBlock<Block> BONE_ASH_BRICK_STAIRS = register(blockWithItem("bone_ash_brick_stairs", new StairBlock(BONE_ASH_BRICKS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(BONE_ASH_BRICKS)), InkColors.CYAN));
	public static final DeferredBlock<Block> BONE_ASH_BRICK_SLAB = register(blockWithItem("bone_ash_brick_slab", new SlabBlock(BlockBehaviour.Properties.ofFullCopy(BONE_ASH_BRICKS)), InkColors.CYAN));
	public static final DeferredBlock<Block> BONE_ASH_BRICK_WALL = register(blockWithItem("bone_ash_brick_wall", new WallBlock(BlockBehaviour.Properties.ofFullCopy(BONE_ASH_BRICKS)), InkColors.CYAN));
	...
	public static final DeferredBlock<Block> BONE_ASH_TILES = register(blockWithItem("bone_ash_tiles", new Block(BlockBehaviour.Properties.ofFullCopy(POLISHED_BONE_ASH)), InkColors.CYAN));
	public static final DeferredBlock<Block> BONE_ASH_TILE_STAIRS = register(blockWithItem("bone_ash_tile_stairs", new StairBlock(BONE_ASH_TILES.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(BONE_ASH_TILES)), InkColors.CYAN));
	public static final DeferredBlock<Block> BONE_ASH_TILE_SLAB = register(blockWithItem("bone_ash_tile_slab", new SlabBlock(BlockBehaviour.Properties.ofFullCopy(BONE_ASH_TILES)), InkColors.CYAN));
	public static final DeferredBlock<Block> BONE_ASH_TILE_WALL = register(blockWithItem("bone_ash_tile_wall", new WallBlock(BlockBehaviour.Properties.ofFullCopy(BONE_ASH_TILES)), InkColors.CYAN));
	...
	public static final DeferredBlock<Block> OVERGROWN_SLUSH = register(snowy(blockWithItem("overgrown_slush", new SlushVegetationBlock(blackslag(SoundType.MUDDY_MANGROVE_ROOTS)), InkColors.BROWN), SpectrumTexturedModels.cubeBottomTopParticle(b -> b, "_side", b -> b, "_top", b -> SLUSH, "", b -> b, "_top"), SpectrumTexturedModels.cubeBottomTopParticle(b -> b, "_snow_side", b -> b, "_snow_top", b -> SLUSH, "", b -> b, "_snow_top")));
	public static final DeferredBlock<Block> TILLED_SLUSH = register(singleton(blockWithItem("tilled_slush", new TilledSlushBlock(BlockBehaviour.Properties.ofFullCopy(SLUSH), SLUSH.defaultBlockState()), InkColors.BROWN), SpectrumTexturedModels.farmland(b -> SLUSH, "", b -> b, "")));
	...
	public static final BlockFamily SMOOTH_BASALT_FAMILY = SpectrumModelHelper.registerBlockFamilyExceptBase(new BlockFamily.Builder(Blocks.SMOOTH_BASALT).stairs(SMOOTH_BASALT_STAIRS).slab(SMOOTH_BASALT_SLAB).wall(SMOOTH_BASALT_WALL).getFamily(), TexturedModel.CUBE);
	...
	public static final DeferredBlock<Block> POLISHED_BASALT_STAIRS = register(blockWithItem("polished_basalt_stairs", new StairBlock(POLISHED_BASALT.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(POLISHED_BASALT)), InkColors.BROWN));
	public static final DeferredBlock<Block> POLISHED_BASALT_SLAB = register(blockWithItem("polished_basalt_slab", new SlabBlock(BlockBehaviour.Properties.ofFullCopy(POLISHED_BASALT)), InkColors.BROWN));
	public static final DeferredBlock<Block> POLISHED_BASALT_WALL = register(blockWithItem("polished_basalt_wall", new WallBlock(BlockBehaviour.Properties.ofFullCopy(POLISHED_BASALT)), InkColors.BROWN));
	...
	public static final DeferredBlock<Block> CHISELED_POLISHED_BASALT = register(blockWithItem("chiseled_polished_basalt", new Block(BlockBehaviour.Properties.ofFullCopy(POLISHED_BASALT)), InkColors.BROWN));
	...
	public static final DeferredBlock<Block> POLISHED_BASALT_PILLAR = register(axisRotated(blockWithItem("polished_basalt_pillar", new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(POLISHED_BASALT)), InkColors.BROWN), TexturedModel.COLUMN));
	public static final DeferredBlock<Block> POLISHED_BASALT_CREST = register(blockWithItem("polished_basalt_crest", new CardinalFacingBlock(BlockBehaviour.Properties.ofFullCopy(POLISHED_BASALT)), InkColors.BROWN).withBlockModel((ctx, block) -> SpectrumModelHelper.createVariantsSupplier(ctx, block, TexturedModel.COLUMN).with(SpectrumModelHelper.createCardinalFacingVariantMap())));
	public static final DeferredBlock<Block> NOTCHED_POLISHED_BASALT = register(singleton(blockWithItem("notched_polished_basalt", new Block(BlockBehaviour.Properties.ofFullCopy(POLISHED_BASALT)), InkColors.BROWN), TexturedModel.COLUMN));
	
	public static final DeferredBlock<Block> BASALT_BRICKS = register(blockWithItem("basalt_bricks", new Block(BlockBehaviour.Properties.ofFullCopy(POLISHED_BASALT)), InkColors.BROWN));
	public static final DeferredBlock<Block> BASALT_BRICK_STAIRS = register(blockWithItem("basalt_brick_stairs", new StairBlock(BASALT_BRICKS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(BASALT_BRICKS)), InkColors.BROWN));
	public static final DeferredBlock<Block> BASALT_BRICK_SLAB = register(blockWithItem("basalt_brick_slab", new SlabBlock(BlockBehaviour.Properties.ofFullCopy(BASALT_BRICKS)), InkColors.BROWN));
	public static final DeferredBlock<Block> BASALT_BRICK_WALL = register(blockWithItem("basalt_brick_wall", new WallBlock(BlockBehaviour.Properties.ofFullCopy(BASALT_BRICKS)), InkColors.BROWN));
	public static final DeferredBlock<Block> CRACKED_BASALT_BRICKS = register(blockWithItem("cracked_basalt_bricks", new Block(BlockBehaviour.Properties.ofFullCopy(BASALT_BRICKS)), InkColors.BROWN));
	...
	public static final DeferredBlock<Block> BASALT_TILES = register(blockWithItem("basalt_tiles", new Block(BlockBehaviour.Properties.ofFullCopy(POLISHED_BASALT)), InkColors.BROWN));
	public static final DeferredBlock<Block> BASALT_TILE_STAIRS = register(blockWithItem("basalt_tile_stairs", new StairBlock(BASALT_TILES.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(BASALT_TILES)), InkColors.BROWN));
	public static final DeferredBlock<Block> BASALT_TILE_SLAB = register(blockWithItem("basalt_tile_slab", new SlabBlock(BlockBehaviour.Properties.ofFullCopy(BASALT_TILES)), InkColors.BROWN));
	public static final DeferredBlock<Block> BASALT_TILE_WALL = register(blockWithItem("basalt_tile_wall", new WallBlock(BlockBehaviour.Properties.ofFullCopy(BASALT_TILES)), InkColors.BROWN));
	public static final DeferredBlock<Block> CRACKED_BASALT_TILES = register(blockWithItem("cracked_basalt_tiles", new Block(BlockBehaviour.Properties.ofFullCopy(BASALT_TILES)), InkColors.BROWN));
	...
	public static final DeferredBlock<Block> TOPAZ_CHISELED_BASALT = register(simple(blockWithItem("topaz_chiseled_basalt", new Block(BlockBehaviour.Properties.ofFullCopy(BASALT_BRICKS).lightLevel(s -> 6)), InkColors.CYAN)));
	public static final DeferredBlock<Block> AMETHYST_CHISELED_BASALT = register(simple(blockWithItem("amethyst_chiseled_basalt", new Block(BlockBehaviour.Properties.ofFullCopy(BASALT_BRICKS).lightLevel(s -> 5)), InkColors.MAGENTA)));
	public static final DeferredBlock<Block> CITRINE_CHISELED_BASALT = register(simple(blockWithItem("citrine_chiseled_basalt", new Block(BlockBehaviour.Properties.ofFullCopy(BASALT_BRICKS).lightLevel(s -> 7)), InkColors.YELLOW)));
	public static final DeferredBlock<Block> ONYX_CHISELED_BASALT = register(simple(blockWithItem("onyx_chiseled_basalt", new Block(BlockBehaviour.Properties.ofFullCopy(BASALT_BRICKS).lightLevel(s -> 3)), InkColors.BLACK)));
	public static final DeferredBlock<Block> MOONSTONE_CHISELED_BASALT = register(moonstoneChiseled(blockWithItem("moonstone_chiseled_basalt", new SpectrumLineFacingBlock(BlockBehaviour.Properties.ofFullCopy(BASALT_BRICKS).lightLevel(s -> 12)), InkColors.WHITE), SpectrumTextures.BASALT_CAP));
	...
	public static final BlockFamily CALCITE_FAMILY = SpectrumModelHelper.registerBlockFamilyExceptBase(new BlockFamily.Builder(Blocks.CALCITE).stairs(CALCITE_STAIRS).slab(CALCITE_SLAB).wall(CALCITE_WALL).getFamily(), TexturedModel.CUBE);
	...
	public static final DeferredBlock<Block> POLISHED_CALCITE_STAIRS = register(blockWithItem("polished_calcite_stairs", new StairBlock(POLISHED_CALCITE.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(POLISHED_CALCITE)), InkColors.BROWN));
	public static final DeferredBlock<Block> POLISHED_CALCITE_SLAB = register(blockWithItem("polished_calcite_slab", new SlabBlock(BlockBehaviour.Properties.ofFullCopy(POLISHED_CALCITE)), InkColors.BROWN));
	public static final DeferredBlock<Block> POLISHED_CALCITE_WALL = register(blockWithItem("polished_calcite_wall", new WallBlock(BlockBehaviour.Properties.ofFullCopy(POLISHED_CALCITE)), InkColors.BROWN));
	...
	public static final DeferredBlock<Block> CHISELED_POLISHED_CALCITE = register(blockWithItem("chiseled_polished_calcite", new Block(BlockBehaviour.Properties.ofFullCopy(POLISHED_CALCITE)), InkColors.BROWN));
	...
	public static final DeferredBlock<Block> POLISHED_CALCITE_PILLAR = register(axisRotated(blockWithItem("polished_calcite_pillar", new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(POLISHED_CALCITE)), InkColors.BROWN), TexturedModel.COLUMN));
	public static final DeferredBlock<Block> POLISHED_CALCITE_CREST = register(blockWithItem("polished_calcite_crest", new CardinalFacingBlock(BlockBehaviour.Properties.ofFullCopy(POLISHED_CALCITE)), InkColors.BROWN).withBlockModel((ctx, block) -> SpectrumModelHelper.createVariantsSupplier(ctx, block, TexturedModel.COLUMN).with(SpectrumModelHelper.createCardinalFacingVariantMap())));
	public static final DeferredBlock<Block> NOTCHED_POLISHED_CALCITE = register(singleton(blockWithItem("notched_polished_calcite", new Block(BlockBehaviour.Properties.ofFullCopy(POLISHED_CALCITE)), InkColors.BROWN), TexturedModel.COLUMN));
	
	public static final DeferredBlock<Block> CALCITE_BRICKS = register(blockWithItem("calcite_bricks", new Block(BlockBehaviour.Properties.ofFullCopy(POLISHED_CALCITE)), InkColors.BROWN));
	public static final DeferredBlock<Block> CALCITE_BRICK_STAIRS = register(blockWithItem("calcite_brick_stairs", new StairBlock(CALCITE_BRICKS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(CALCITE_BRICKS)), InkColors.BROWN));
	public static final DeferredBlock<Block> CALCITE_BRICK_SLAB = register(blockWithItem("calcite_brick_slab", new SlabBlock(BlockBehaviour.Properties.ofFullCopy(CALCITE_BRICKS)), InkColors.BROWN));
	public static final DeferredBlock<Block> CALCITE_BRICK_WALL = register(blockWithItem("calcite_brick_wall", new WallBlock(BlockBehaviour.Properties.ofFullCopy(CALCITE_BRICKS)), InkColors.BROWN));
	public static final DeferredBlock<Block> CRACKED_CALCITE_BRICKS = register(blockWithItem("cracked_calcite_bricks", new Block(BlockBehaviour.Properties.ofFullCopy(CALCITE_BRICKS)), InkColors.BROWN));
	...
	public static final DeferredBlock<Block> CALCITE_TILES = register(blockWithItem("calcite_tiles", new Block(BlockBehaviour.Properties.ofFullCopy(POLISHED_CALCITE)), InkColors.BROWN));
	public static final DeferredBlock<Block> CALCITE_TILE_STAIRS = register(blockWithItem("calcite_tile_stairs", new StairBlock(CALCITE_TILES.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(CALCITE_TILES)), InkColors.BROWN));
	public static final DeferredBlock<Block> CALCITE_TILE_SLAB = register(blockWithItem("calcite_tile_slab", new SlabBlock(BlockBehaviour.Properties.ofFullCopy(CALCITE_TILES)), InkColors.BROWN));
	public static final DeferredBlock<Block> CALCITE_TILE_WALL = register(blockWithItem("calcite_tile_wall", new WallBlock(BlockBehaviour.Properties.ofFullCopy(CALCITE_TILES)), InkColors.BROWN));
	public static final DeferredBlock<Block> CRACKED_CALCITE_TILES = register(blockWithItem("cracked_calcite_tiles", new Block(BlockBehaviour.Properties.ofFullCopy(CALCITE_TILES)), InkColors.BROWN));
	...
	public static final DeferredBlock<Block> TOPAZ_CHISELED_CALCITE = register(simple(blockWithItem("topaz_chiseled_calcite", new Block(BlockBehaviour.Properties.ofFullCopy(CALCITE_BRICKS).lightLevel(s -> 6)), InkColors.CYAN)));
	public static final DeferredBlock<Block> AMETHYST_CHISELED_CALCITE = register(simple(blockWithItem("amethyst_chiseled_calcite", new Block(BlockBehaviour.Properties.ofFullCopy(CALCITE_BRICKS).lightLevel(s -> 5)), InkColors.MAGENTA)));
	public static final DeferredBlock<Block> CITRINE_CHISELED_CALCITE = register(simple(blockWithItem("citrine_chiseled_calcite", new Block(BlockBehaviour.Properties.ofFullCopy(CALCITE_BRICKS).lightLevel(s -> 7)), InkColors.YELLOW)));
	public static final DeferredBlock<Block> ONYX_CHISELED_CALCITE = register(simple(blockWithItem("onyx_chiseled_calcite", new Block(BlockBehaviour.Properties.ofFullCopy(CALCITE_BRICKS).lightLevel(s -> 3)), InkColors.BLACK)));
	public static final DeferredBlock<Block> MOONSTONE_CHISELED_CALCITE = register(moonstoneChiseled(blockWithItem("moonstone_chiseled_calcite", new SpectrumLineFacingBlock(BlockBehaviour.Properties.ofFullCopy(CALCITE_BRICKS).lightLevel(s -> 12)), InkColors.WHITE), SpectrumTextures.CALCITE_CAP));
	...
	public static final DeferredBlock<Block> AMETHYST_BASALT_LIGHT = registerGemstoneLight("amethyst_basalt_light", Blocks.AMETHYST_BLOCK, POLISHED_BASALT, SpectrumTextures.BASALT_CAP, InkColors.MAGENTA);
	...
	public static final DeferredBlock<Block> AMETHYST_CALCITE_LIGHT = registerGemstoneLight("amethyst_calcite_light", Blocks.AMETHYST_BLOCK, POLISHED_CALCITE, SpectrumTextures.CALCITE_CAP, InkColors.MAGENTA);
	...
	public static final DeferredBlock<Block> TOPAZ_GLASS_PANE = register(glassPane(blockWithItem("topaz_glass_pane", new IronBarsBlock(gemstoneGlass(SpectrumBlockSoundGroups.TOPAZ_CLUSTER, MapColor.COLOR_CYAN)), InkColors.CYAN), TOPAZ_GLASS));
	public static final DeferredBlock<Block> AMETHYST_GLASS_PANE = register(glassPane(blockWithItem("amethyst_glass_pane", new IronBarsBlock(gemstoneGlass(SoundType.AMETHYST_CLUSTER, MapColor.COLOR_MAGENTA)), InkColors.MAGENTA), AMETHYST_GLASS));
	public static final DeferredBlock<Block> CITRINE_GLASS_PANE = register(glassPane(blockWithItem("citrine_glass_pane", new IronBarsBlock(gemstoneGlass(SpectrumBlockSoundGroups.CITRINE_CLUSTER, MapColor.COLOR_YELLOW)), InkColors.YELLOW), CITRINE_GLASS));
	public static final DeferredBlock<Block> ONYX_GLASS_PANE = register(glassPane(blockWithItem("onyx_glass_pane", new IronBarsBlock(gemstoneGlass(SpectrumBlockSoundGroups.ONYX_CLUSTER, MapColor.COLOR_BLACK)), InkColors.BLACK), ONYX_GLASS));
	public static final DeferredBlock<Block> MOONSTONE_GLASS_PANE = register(glassPane(blockWithItem("moonstone_glass_pane", new IronBarsBlock(gemstoneGlass(SpectrumBlockSoundGroups.MOONSTONE_CLUSTER, MapColor.SNOW)), InkColors.WHITE), MOONSTONE_GLASS));
	public static final DeferredBlock<Block> RADIANT_GLASS_PANE = register(glassPane(blockWithItem("radiant_glass_pane", new IronBarsBlock(gemstoneGlass(SoundType.GLASS, MapColor.SAND).lightLevel(value -> 12)), InkColors.WHITE), RADIANT_GLASS));
	...
	public static final DeferredBlock<Block> TOPAZ_CHIME = register(translucent(singleton(blockWithItem("topaz_chime", new GemstoneChimeBlock(chime(TOPAZ_CLUSTER), SpectrumSoundEvents.BLOCK_TOPAZ_BLOCK_CHIME, ColoredSparkleRisingParticleEffect.CYAN), InkColors.CYAN), SpectrumTexturedModels.CHIME)));
	...
	public static final DeferredBlock<Block> CITRINE_CHIME = register(translucent(singleton(blockWithItem("citrine_chime", new GemstoneChimeBlock(chime(CITRINE_CLUSTER), SpectrumSoundEvents.BLOCK_CITRINE_BLOCK_CHIME, ColoredSparkleRisingParticleEffect.YELLOW), InkColors.YELLOW), SpectrumTexturedModels.CHIME)));
	public static final DeferredBlock<Block> ONYX_CHIME = register(translucent(singleton(blockWithItem("onyx_chime", new GemstoneChimeBlock(chime(ONYX_CLUSTER), SpectrumSoundEvents.BLOCK_ONYX_BLOCK_CHIME, ColoredSparkleRisingParticleEffect.BLACK), InkColors.BLACK), SpectrumTexturedModels.CHIME)));
	public static final DeferredBlock<Block> MOONSTONE_CHIME = register(translucent(singleton(blockWithItem("moonstone_chime", new GemstoneChimeBlock(chime(MOONSTONE_CLUSTER), SpectrumSoundEvents.BLOCK_MOONSTONE_BLOCK_CHIME, ColoredSparkleRisingParticleEffect.WHITE), InkColors.WHITE), SpectrumTexturedModels.CHIME)));
	...
	public static final DeferredBlock<Block> TOPAZ_PYLON = register(pylon(blockWithItem("topaz_pylon", new PylonBlock(pylon(TOPAZ_BLOCK)), InkColors.CYAN)));
	...
	public static final DeferredBlock<Block> CITRINE_PYLON = register(pylon(blockWithItem("citrine_pylon", new PylonBlock(pylon(CITRINE_BLOCK)), InkColors.YELLOW)));
	public static final DeferredBlock<Block> ONYX_PYLON = register(pylon(blockWithItem("onyx_pylon", new PylonBlock(pylon(ONYX_BLOCK)), InkColors.BLACK)));
	public static final DeferredBlock<Block> MOONSTONE_PYLON = register(pylon(blockWithItem("moonstone_pylon", new PylonBlock(pylon(MOONSTONE_BLOCK)), InkColors.WHITE)));
	...
	public static final DeferredBlock<Block> RADIANT_SEMI_PERMEABLE_GLASS = register(translucent(parented(blockWithItem("radiant_semi_permeable_glass", new AlternatePlayerOnlyGlassBlock(BlockBehaviour.Properties.ofFullCopy(RADIANT_GLASS), RADIANT_GLASS, false), InkColors.YELLOW), b -> RADIANT_GLASS)));
	public static final DeferredBlock<Block> TOPAZ_SEMI_PERMEABLE_GLASS = register(translucent(parented(blockWithItem("topaz_semi_permeable_glass", new GemstonePlayerOnlyGlassBlock(BlockBehaviour.Properties.ofFullCopy(TOPAZ_GLASS), BuiltinGemstoneColor.CYAN), InkColors.CYAN), b -> TOPAZ_GLASS)));
	public static final DeferredBlock<Block> AMETHYST_SEMI_PERMEABLE_GLASS = register(translucent(parented(blockWithItem("amethyst_semi_permeable_glass", new GemstonePlayerOnlyGlassBlock(BlockBehaviour.Properties.ofFullCopy(AMETHYST_GLASS), BuiltinGemstoneColor.MAGENTA), InkColors.MAGENTA), b -> AMETHYST_GLASS)));
	public static final DeferredBlock<Block> CITRINE_SEMI_PERMEABLE_GLASS = register(translucent(parented(blockWithItem("citrine_semi_permeable_glass", new GemstonePlayerOnlyGlassBlock(BlockBehaviour.Properties.ofFullCopy(CITRINE_GLASS), BuiltinGemstoneColor.YELLOW), InkColors.YELLOW), b -> CITRINE_GLASS)));
	public static final DeferredBlock<Block> ONYX_SEMI_PERMEABLE_GLASS = register(translucent(parented(blockWithItem("onyx_semi_permeable_glass", new GemstonePlayerOnlyGlassBlock(BlockBehaviour.Properties.ofFullCopy(ONYX_GLASS), BuiltinGemstoneColor.BLACK), InkColors.BLACK), b -> ONYX_GLASS)));
	public static final DeferredBlock<Block> MOONSTONE_SEMI_PERMEABLE_GLASS = register(translucent(parented(blockWithItem("moonstone_semi_permeable_glass", new GemstonePlayerOnlyGlassBlock(BlockBehaviour.Properties.ofFullCopy(MOONSTONE_GLASS), BuiltinGemstoneColor.WHITE), InkColors.WHITE), b -> MOONSTONE_GLASS)));
	...
	public static final DeferredBlock<Block> PARAMETRIC_MINING_DEVICE = register(blockWithItem("parametric_mining_device", new ParametricMiningDeviceBlock(BlockBehaviour.Properties.ofFullCopy(BLACKSLAG).noOcclusion().instabreak()), block -> new ParametricMiningDeviceItem(block, IS.of(8)), InkColors.RED));
	public static final DeferredBlock<Block> THREAT_CONFLUX = register(blockWithItem("threat_conflux", new ThreatConfluxBlock(BlockBehaviour.Properties.ofFullCopy(BLACKSLAG).noOcclusion().instabreak()), block -> new ThreatConfluxItem(block, IS.of(8)), InkColors.RED).withBlockModel((ctx, block) -> MultiVariantGenerator.multiVariant(block).with(PropertyDispatch.property(ThreatConfluxBlock.ARMED).generate(armed -> SpectrumModelHelper.createModelVariant(block, armed == ThreatConfluxBlock.ArmedState.NOT_ARMED ? "" : "_armed")))));
	...
	public static final DeferredBlock<Block> TRANSIENT_LIGHT = register(parented(block("transient_light", new TransientLightBlock(BlockBehaviour.Properties.ofFullCopy(PERSISTENT_LIGHT).randomTicks())), b -> PERSISTENT_LIGHT));
	...
	public static final DeferredBlock<Block> TOPAZ_SUGAR_STICK = register(sugarStick(blockWithItem("topaz_sugar_stick", new SugarStickBlock(rockCandy(SMALL_TOPAZ_BUD), RockCandy.RockCandyVariant.TOPAZ), InkColors.PINK), b -> TOPAZ_GLASS));
	public static final DeferredBlock<Block> AMETHYST_SUGAR_STICK = register(sugarStick(blockWithItem("amethyst_sugar_stick", new SugarStickBlock(rockCandy(Blocks.SMALL_AMETHYST_BUD), RockCandy.RockCandyVariant.AMETHYST), InkColors.PINK), b -> AMETHYST_GLASS));
	public static final DeferredBlock<Block> CITRINE_SUGAR_STICK = register(sugarStick(blockWithItem("citrine_sugar_stick", new SugarStickBlock(rockCandy(SMALL_CITRINE_BUD), RockCandy.RockCandyVariant.CITRINE), InkColors.PINK), b -> CITRINE_GLASS));
	public static final DeferredBlock<Block> ONYX_SUGAR_STICK = register(sugarStick(blockWithItem("onyx_sugar_stick", new SugarStickBlock(rockCandy(SMALL_ONYX_BUD), RockCandy.RockCandyVariant.ONYX), InkColors.PINK), b -> ONYX_GLASS));
	public static final DeferredBlock<Block> MOONSTONE_SUGAR_STICK = register(sugarStick(blockWithItem("moonstone_sugar_stick", new SugarStickBlock(rockCandy(SMALL_MOONSTONE_BUD), RockCandy.RockCandyVariant.MOONSTONE), InkColors.PINK), b -> MOONSTONE_GLASS));
	...
	public static ColoredStairsBlock registerColoredStairs(String name, ColoredPlankBlock baseBlock) {
		return register(blockWithItem(name, new ColoredStairsBlock(baseBlock.defaultBlockState(), copyWithMapColor(Blocks.OAK_STAIRS, baseBlock.defaultMapColor()), baseBlock.getColor()), baseBlock.getColor()));
	}
	
	public static ColoredPressurePlateBlock registerColoredPressurePlate(String name, ColoredPlankBlock baseBlock) {
		return register(blockWithItem(name, new ColoredPressurePlateBlock(copyWithMapColor(Blocks.OAK_PRESSURE_PLATE, baseBlock.defaultMapColor()), baseBlock.getColor()), baseBlock.getColor()));
	}
	
	public static ColoredFenceBlock registerColoredFence(String name, ColoredPlankBlock baseBlock) {
		return register(burnable(blockWithItem(name, new ColoredFenceBlock(copyWithMapColor(Blocks.OAK_FENCE, baseBlock.defaultMapColor()), baseBlock.getColor()), baseBlock.getColor()), 300));
	}
	
	public static ColoredFenceGateBlock registerColoredFenceGate(String name, ColoredPlankBlock baseBlock) {
		return register(burnable(blockWithItem(name, new ColoredFenceGateBlock(copyWithMapColor(Blocks.OAK_FENCE_GATE, baseBlock.defaultMapColor()), baseBlock.getColor()), baseBlock.getColor()), 300));
	}
	
	public static ColoredWoodenButtonBlock registerColoredButton(String name, ColoredPlankBlock baseBlock) {
		return register(blockWithItem(name, new ColoredWoodenButtonBlock(copyWithMapColor(Blocks.OAK_BUTTON, baseBlock.defaultMapColor()), baseBlock.getColor()), baseBlock.getColor()));
	}
	
	public static ColoredSlabBlock registerColoredSlab(String name, ColoredPlankBlock baseBlock) {
		return register(blockWithItem(name, new ColoredSlabBlock(copyWithMapColor(Blocks.OAK_SLAB, baseBlock.defaultMapColor()), baseBlock.getColor()), baseBlock.getColor()));
	}
	...
	public static final DeferredBlock<Block> ASHEN_BLACKSLAG = register(singleton(blockWithItem("ashen_blackslag", new RotatedPillarBlock(blackslag(SoundType.DEEPSLATE).mapColor(MapColor.QUARTZ)), InkColors.LIGHT_GRAY), SpectrumTexturedModels.cubeBottomTopParticle(b -> b, "_side", b -> b, "_top", b -> BLACKSLAG, "_top", b -> b, "_top")));
