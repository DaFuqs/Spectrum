...
public class SpectrumBlocks {
	...
	// CRYSTALLARIEUM
	public static final Block SMALL_COAL_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.COAL_BLOCK.getDefaultMapColor()));
	...
	public static final Block SMALL_COPPER_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.COPPER_BLOCK.getDefaultMapColor()));
	...
	public static final Block SMALL_DIAMOND_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.DIAMOND_BLOCK.getDefaultMapColor()));
	...
	public static final Block SMALL_EMERALD_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.EMERALD_BLOCK.getDefaultMapColor()));
	...
	public static final Block SMALL_GLOWSTONE_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.GLOWSTONE.getDefaultMapColor()));
	...
	public static final Block SMALL_GOLD_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.GOLD_BLOCK.getDefaultMapColor()));
	...
	public static final Block SMALL_IRON_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.IRON_BLOCK.getDefaultMapColor()));
	...
	public static final Block SMALL_LAPIS_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.LAPIS_BLOCK.getDefaultMapColor()));
	...
	public static final Block SMALL_NETHERITE_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.NETHERITE_BLOCK.getDefaultMapColor()));
	...
	public static final Block SMALL_PRISMARINE_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.PRISMARINE_BRICKS.getDefaultMapColor()));
	...
	public static final Block SMALL_QUARTZ_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.QUARTZ_BLOCK.getDefaultMapColor()));
	...
	public static final Block SMALL_REDSTONE_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.REDSTONE_BLOCK.getDefaultMapColor()));
	...
	public static final Block SMALL_CERTUS_QUARTZ_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(MapColor.TERRACOTTA_WHITE));
	...
	public static final Block SMALL_FLUIX_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.PURPLE_CONCRETE.getDefaultMapColor()));
	...
	public static final Block SMALL_GLOBETTE_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.BLUE_CONCRETE.getDefaultMapColor()));
	...
	public static final Block SMALL_GLOBETTE_NETHER_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.RED_CONCRETE.getDefaultMapColor()));
	...
	public static final Block SMALL_GLOBETTE_END_BUD = new Block(FabricBlockSettings.of(Material.AMETHYST).hardness(1.0f).mapColor(Blocks.GREEN_CONCRETE.getDefaultMapColor()));
