...
public class SpectrumBlocks {
	...
	public static final Block TILLED_SHALE_CLAY = register(singleton(blockWithItem("tilled_shale_clay", new TilledShaleClayBlock(BlockBehaviour.Properties.ofFullCopy(SHALE_CLAY), SHALE_CLAY.defaultBlockState()), InkColors.BROWN), SpectrumTexturedModels.farmland(b -> SHALE_CLAY, "_side", b -> b, "")));
	...
	public static final Block UPGRADE_SPEED = register(parented(blockWithItem("upgrade_speed", new UpgradeBlock(upgrade(), Upgradeable.UpgradeType.SPEED, 1, InkColors.MAGENTA_COLOR), block -> new UpgradeBlockItem(block, IS.of(), "upgrade_speed"), InkColors.LIGHT_GRAY), b -> b));
	public static final Block UPGRADE_SPEED2 = register(parented(blockWithItem("upgrade_speed2", new UpgradeBlock(upgrade(), Upgradeable.UpgradeType.SPEED, 2, InkColors.MAGENTA_COLOR), block -> new UpgradeBlockItem(block, IS.of(Rarity.UNCOMMON), "upgrade_speed2"), InkColors.LIGHT_GRAY), b -> UPGRADE_SPEED));
	public static final Block UPGRADE_SPEED3 = register(parented(blockWithItem("upgrade_speed3", new UpgradeBlock(upgrade(), Upgradeable.UpgradeType.SPEED, 8, InkColors.MAGENTA_COLOR), block -> new UpgradeBlockItem(block, IS.of(Rarity.RARE), "upgrade_speed3"), InkColors.LIGHT_GRAY), b -> UPGRADE_SPEED));
	public static final Block UPGRADE_EFFICIENCY = register(parented(blockWithItem("upgrade_efficiency", new UpgradeBlock(upgrade(), Upgradeable.UpgradeType.EFFICIENCY, 1, InkColors.YELLOW_COLOR), block -> new UpgradeBlockItem(block, IS.of(Rarity.UNCOMMON), "upgrade_efficiency"), InkColors.LIGHT_GRAY), b -> b));
	public static final Block UPGRADE_EFFICIENCY2 = register(parented(blockWithItem("upgrade_efficiency2", new UpgradeBlock(upgrade(), Upgradeable.UpgradeType.EFFICIENCY, 4, InkColors.YELLOW_COLOR), block -> new UpgradeBlockItem(block, IS.of(Rarity.RARE), "upgrade_efficiency2"), InkColors.LIGHT_GRAY), b -> UPGRADE_EFFICIENCY));
	public static final Block UPGRADE_YIELD = register(parented(blockWithItem("upgrade_yield", new UpgradeBlock(upgrade(), Upgradeable.UpgradeType.YIELD, 1, InkColors.CYAN_COLOR), block -> new UpgradeBlockItem(block, IS.of(Rarity.UNCOMMON), "upgrade_yield"), InkColors.LIGHT_GRAY), b -> b));
	public static final Block UPGRADE_YIELD2 = register(parented(blockWithItem("upgrade_yield2", new UpgradeBlock(upgrade(), Upgradeable.UpgradeType.YIELD, 4, InkColors.CYAN_COLOR), block -> new UpgradeBlockItem(block, IS.of(Rarity.RARE), "upgrade_yield2"), InkColors.LIGHT_GRAY), b -> UPGRADE_YIELD));
	public static final Block UPGRADE_EXPERIENCE = register(parented(blockWithItem("upgrade_experience", new UpgradeBlock(upgrade(), Upgradeable.UpgradeType.EXPERIENCE, 1, InkColors.PURPLE_COLOR), block -> new UpgradeBlockItem(block, IS.of(), "upgrade_experience"), InkColors.LIGHT_GRAY), b -> b));
	public static final Block UPGRADE_EXPERIENCE2 = register(parented(blockWithItem("upgrade_experience2", new UpgradeBlock(upgrade(), Upgradeable.UpgradeType.EXPERIENCE, 4, InkColors.PURPLE_COLOR), block -> new UpgradeBlockItem(block, IS.of(Rarity.UNCOMMON), "upgrade_experience2"), InkColors.LIGHT_GRAY), b -> UPGRADE_EXPERIENCE));
