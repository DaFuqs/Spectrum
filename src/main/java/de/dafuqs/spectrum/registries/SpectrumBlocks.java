...
public class SpectrumBlocks {
	...
	public static DeferredBlock<Block> registerNoxwoodLantern(String name, DeferredBlock<Block> flexLanternBlock, InkColor color) {
	...
	public static final DeferredBlock<Block> WEEPING_GALA_SPRIG = register(cross(blockWithItem("weeping_gala_sprig", () -> new WeepingGalaSprigBlock(copyWithMapColor(Blocks.OAK_SAPLING, MapColor.WARPED_WART_BLOCK)), InkColors.LIME)).withItemModel(SpectrumModelHelper::registerItemModel));
	public static final DeferredBlock<Block> POTTED_WEEPING_GALA_SPRIG = register(pottedPlant(block("potted_weeping_gala_sprig", () -> new FlowerPotBlock(WEEPING_GALA_SPRIG.get(), pottedPlant())), false));
	...
	public static final DeferredBlock<Block> WEEPING_GALA_WOOD = register(burnable(wood(blockWithItem("weeping_gala_wood", () -> new RotatedPillarBlock(galaWood(MapColor.COLOR_BROWN)), InkColors.LIME), WEEPING_GALA_LOG.get()), 600));
	public static final DeferredBlock<Block> STRIPPED_WEEPING_GALA_WOOD = register(burnable(wood(blockWithItem("stripped_weeping_gala_wood", () -> new RotatedPillarBlock(galaWood(MapColor.COLOR_BROWN)), InkColors.LIME), STRIPPED_WEEPING_GALA_LOG.get()), 600));
	...
	public static final DeferredBlock<Block> WEEPING_GALA_STAIRS = register(burnable(blockWithItem("weeping_gala_stairs", () -> new StairBlock(WEEPING_GALA_PLANKS.get().defaultBlockState(), galaWood(MapColor.COLOR_BROWN)), InkColors.LIME), 600));
	...
	public static final DeferredBlock<Block> WEEPING_GALA_FENCE_GATE = register(burnable(blockWithItem("weeping_gala_fence_gate", () -> new FenceGateBlock(GALA_WOOD_TYPE, galaWood(MapColor.COLOR_BROWN)), InkColors.LIME), 600));
