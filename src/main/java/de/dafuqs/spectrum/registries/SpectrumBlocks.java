...
public class SpectrumBlocks {
	...
	// ROCK CANDY
	public static final Block SUGAR_STICK = new SugarStickBlock(FabricBlockSettings.copyOf(Blocks.SMALL_AMETHYST_BUD).hardness(1.0F).luminance((state) -> 8 + state.get(Properties.AGE_2) * 3).ticksRandomly(), RockCandy.RockCandyVariant.SUGAR);
	...
	private static void registerNativeOreBlocks(FabricItemSettings settings) {
		registerBlockWithItem("native_coal_block", NATIVE_COAL_BLOCK, settings, DyeColor.BROWN);
		registerBlockWithItem("native_iron_block", NATIVE_IRON_BLOCK, settings, DyeColor.BROWN);
		registerBlockWithItem("native_gold_block", NATIVE_GOLD_BLOCK, settings, DyeColor.BROWN);
		registerBlockWithItem("native_diamond_block", NATIVE_DIAMOND_BLOCK, settings, DyeColor.CYAN);
		registerBlockWithItem("native_emerald_block", NATIVE_EMERALD_BLOCK, settings, DyeColor.CYAN);
		registerBlockWithItem("native_redstone_block", NATIVE_REDSTONE_BLOCK, settings, DyeColor.RED);
		registerBlockWithItem("native_lapis_block", NATIVE_LAPIS_BLOCK, settings, DyeColor.PURPLE);
		registerBlockWithItem("native_copper_block", NATIVE_COPPER_BLOCK, settings, DyeColor.BROWN);
		registerBlockWithItem("native_quartz_block", NATIVE_QUARTZ_BLOCK, settings, DyeColor.BROWN);
		registerBlockWithItem("native_netherite_block", NATIVE_NETHERITE_BLOCK, settings, DyeColor.BROWN);
		
		registerBlockWithItem("native_glowstone_block", NATIVE_GLOWSTONE_BLOCK, settings, DyeColor.YELLOW);
		registerBlockWithItem("native_prismarine_block", NATIVE_PRISMARINE_BLOCK, settings, DyeColor.CYAN);
		
		registerBlockWithItem("native_certus_quartz_block", NATIVE_CERTUS_QUARTZ_BLOCK, settings, DyeColor.YELLOW);
		registerBlockWithItem("native_fluix_block", NATIVE_FLUIX_BLOCK, settings, DyeColor.YELLOW);
		
		registerBlockWithItem("native_globette_block", NATIVE_GLOBETTE_BLOCK, settings, DyeColor.BLUE);
		registerBlockWithItem("native_globette_nether_block", NATIVE_GLOBETTE_NETHER_BLOCK, settings, DyeColor.RED);
		registerBlockWithItem("native_globette_end_block", NATIVE_GLOBETTE_END_BLOCK, settings, DyeColor.GREEN);
	}
