...
public class SpectrumBlocks {
	...
	public static final DeferredBlock<PastelNodeBlock> CONNECTION_NODE = register(blockWithItem("connection_node", () -> new PastelNodeBlock(pastelNode(SoundType.AMETHYST_CLUSTER), PastelNodeType.CONNECTION, Set.of(), List.of(Component.translatable("block.spectrum.connection_node.tooltip"))), () -> IS.of()).withPredefinedItemModel());
	
	public static final DeferredBlock<PastelNodeBlock> INK_NODE = register(blockWithItem("ink_node",
			() -> new PastelNodeBlock(pastelNode(SoundType.AMETHYST_CLUSTER), PastelNodeType.SENDER, Set.of(SpectrumPastelPayloadTypes.INK), List.of(Component.translatable("block.spectrum.ink_node.tooltip").withStyle(ChatFormatting.WHITE), Component.translatable("block.spectrum.ink_pastel_network_nodes.tooltip.placing").withStyle(ChatFormatting.GRAY))), () -> IS.of()).withPredefinedItemModel());
