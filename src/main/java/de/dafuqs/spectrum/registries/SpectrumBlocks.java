...
public class SpectrumBlocks {
	...
	public static final DeferredBlock<Block> CRACKED_DRAGONBONE = register(axisRotated(blockWithItem("cracked_dragonbone", () -> new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(BONE_BLOCK).strength(100.0F, 1200.0F).pushReaction(PushReaction.BLOCK)), () -> IS.of().component(SpectrumDataComponentTypes.DAMAGE_IMMUNE, new DamageImmuneComponent(DamageTypeTags.IS_EXPLOSION)), InkColors.GREEN), TexturedModel.COLUMN));
