...
public class SpectrumDamageTypeTags {
	...
	public static final TagKey<DamageType> ERASER_IMMUNE_TO = of("eraser_immune_to");
	public static final TagKey<DamageType> ERASER_HURTS_EXTRA = of("eraser_hurts_extra");
