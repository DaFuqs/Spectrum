...
public class SpectrumDataComponentTypes {
	...
	public static final Supplier<DataComponentType<ItemEnchantments>> CANVAS_ENCHANTMENTS = register("canvas_enchantments", (builder) -> builder.persistent(ItemEnchantments.CODEC).networkSynchronized(ItemEnchantments.STREAM_CODEC).cacheEncoding()); // TODO: can we use STORED_ENCHANTMENTS instead?
