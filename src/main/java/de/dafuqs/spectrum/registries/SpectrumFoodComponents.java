...
public class SpectrumFoodComponents {
	...
	// TODO
	public static final FoodComponent AQUA_REGIA = new FoodComponent.Builder().hunger(2).saturationModifier(0.6F).build();
	public static final FoodComponent BAGNUN = new FoodComponent.Builder().hunger(10).saturationModifier(1F).statusEffect(new StatusEffectInstance(StatusEffects.STRENGTH, 2000), 1).build();
	public static final FoodComponent BANYASH = new FoodComponent.Builder().hunger(10).saturationModifier(1F).statusEffect(new StatusEffectInstance(StatusEffects.HASTE, 2000), 1).build();
	public static final FoodComponent BERLINER = new FoodComponent.Builder().hunger(9).saturationModifier(1.5F).statusEffect(new StatusEffectInstance(SpectrumStatusEffects.NOURISHING, 2400), 1).build();
	public static final FoodComponent BRISTLE_MEAD = new FoodComponent.Builder().hunger(2).saturationModifier(0.6F).build();
	public static final FoodComponent CHAUVE_SOURIS_AU_VIN = new FoodComponent.Builder().hunger(20).saturationModifier(1F).statusEffect(new StatusEffectInstance(SpectrumStatusEffects.EFFECT_PROLONGING, 6000, 0), 1.0f).build();
	public static final FoodComponent CRAWFISH = new FoodComponent.Builder().hunger(2).saturationModifier(0.6F).snack().build();
	public static final FoodComponent CRAWFISH_COCKTAIL = new FoodComponent.Builder().hunger(6).saturationModifier(0.9F).snack().build();
	public static final FoodComponent CREAM_PASTRY = new FoodComponent.Builder().hunger(4).saturationModifier(1.5F).statusEffect(new StatusEffectInstance(SpectrumStatusEffects.NOURISHING, 3600, 1), 1).build();
	public static final FoodComponent FADED_KOI = new FoodComponent.Builder().hunger(2).saturationModifier(10F).snack().build();
	public static final FoodComponent FISHCAKE = new FoodComponent.Builder().hunger(8).saturationModifier(1F).statusEffect(new StatusEffectInstance(StatusEffects.STRENGTH, 1000, 1), 1).statusEffect(new StatusEffectInstance(SpectrumStatusEffects.SWIFTNESS, 1000, 1), 1).build();
	public static final FoodComponent LIZARD_MEAT = new FoodComponent.Builder().hunger(2).saturationModifier(0.6F).build();
	public static final FoodComponent GOLDEN_BRISTLE_TEA = new FoodComponent.Builder().hunger(1).saturationModifier(1F).statusEffect(new StatusEffectInstance(StatusEffects.INSTANT_HEALTH), 0.5F).statusEffect(new StatusEffectInstance(StatusEffects.STRENGTH, 600, 4), 1).statusEffect(new StatusEffectInstance(StatusEffects.RESISTANCE, 600, 0), 0.5F).build();
	public static final FoodComponent GOLDEN_BRISTLE_TEA_SCONE_BONUS = new FoodComponent.Builder().hunger(1).saturationModifier(0F).statusEffect(new StatusEffectInstance(StatusEffects.INSTANT_HEALTH), 1F).statusEffect(new StatusEffectInstance(SpectrumStatusEffects.MAGIC_ANNULATION, 1200, 1), 2).build();
	public static final FoodComponent HARE_ROAST = new FoodComponent.Builder().hunger(12).saturationModifier(1F).statusEffect(new StatusEffectInstance(SpectrumStatusEffects.NOURISHING, 1200, 1), 1).statusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 1200), 1).build();
	public static final FoodComponent JUNKET = new FoodComponent.Builder().hunger(6).saturationModifier(0.8F).statusEffect(new StatusEffectInstance(StatusEffects.SPEED, 800, 2), 1).statusEffect(new StatusEffectInstance(SpectrumStatusEffects.SWIFTNESS, 800, 2), 1).build();
	public static final FoodComponent KOI_FISH = new FoodComponent.Builder().hunger(4).saturationModifier(0.5F).build();
	public static final FoodComponent MEATLOAF = new FoodComponent.Builder().hunger(20).saturationModifier(2F).statusEffect(new StatusEffectInstance(SpectrumStatusEffects.MAGIC_ANNULATION, 6000, 2), 1.0f).statusEffect(new StatusEffectInstance(SpectrumStatusEffects.TOUGHNESS, 6000, 1), 1.0f).statusEffect(new StatusEffectInstance(StatusEffects.RESISTANCE, 6000, 0), 1.0f).statusEffect(new StatusEffectInstance(StatusEffects.SLOWNESS, 6000, 0), 1.0f).build();
	public static final FoodComponent MEATLOAF_SANDWICH = new FoodComponent.Builder().hunger(9).saturationModifier(1.5F).statusEffect(new StatusEffectInstance(SpectrumStatusEffects.MAGIC_ANNULATION, 600, 2), 1.0f).statusEffect(new StatusEffectInstance(SpectrumStatusEffects.TOUGHNESS, 600, 1), 1.0f).statusEffect(new StatusEffectInstance(StatusEffects.RESISTANCE, 600, 0), 1.0f).build();
	public static final FoodComponent MELLOW_SHALLOT_SOUP = new FoodComponent.Builder().hunger(7).saturationModifier(0.8F).statusEffect(new StatusEffectInstance(SpectrumStatusEffects.EFFECT_PROLONGING, 600, 3), 1.0f).statusEffect(new StatusEffectInstance(SpectrumStatusEffects.IMMUNITY, 600, 0), 1.0f).build();
	public static final FoodComponent MORCHELLA = new FoodComponent.Builder().hunger(2).saturationModifier(0.6F).build();
	public static final FoodComponent NECTERED_VIOGNIER = new FoodComponent.Builder().hunger(2).saturationModifier(0.6F).build();
	public static final FoodComponent PEACHES_FLAMBE = new FoodComponent.Builder().hunger(14).saturationModifier(1.5F).statusEffect(new StatusEffectInstance(SpectrumStatusEffects.TOUGHNESS, 3000, 5), 1.0f).build();
	public static final FoodComponent PEACH_CREAM = new FoodComponent.Builder().hunger(8).saturationModifier(1F).statusEffect(new StatusEffectInstance(SpectrumStatusEffects.TOUGHNESS, 3000, 1), 1.0f).build();
	public static final FoodComponent PEACH_CREAM_SCONE_BONUS = new FoodComponent.Builder().hunger(0).saturationModifier(1F).statusEffect(new StatusEffectInstance(SpectrumStatusEffects.TOUGHNESS, 6000, 3), 1.0f).build();
	public static final FoodComponent PEACH_JAM = new FoodComponent.Builder().hunger(16).saturationModifier(1F).statusEffect(new StatusEffectInstance(SpectrumStatusEffects.STIFFNESS, 1200, 1), 1.0f).statusEffect(new StatusEffectInstance(StatusEffects.NAUSEA, 1200, 0), 1.0f).build();
	public static final FoodComponent RABBIT_CREAM_PIE = new FoodComponent.Builder().hunger(16).saturationModifier(0.8F).statusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 1200, 1), 1.0f).statusEffect(new StatusEffectInstance(StatusEffects.INSTANT_HEALTH, 1, 1), 1.0f).build();
	public static final FoodComponent SEDATIVES = new FoodComponent.Builder().hunger(2).saturationModifier(0.5F).statusEffect(new StatusEffectInstance(SpectrumStatusEffects.STIFFNESS, 300, 4), 1.0f).build();
	public static final FoodComponent SLUSHSLIDE = new FoodComponent.Builder().hunger(9).saturationModifier(0.6F).statusEffect(new StatusEffectInstance(SpectrumStatusEffects.SWIFTNESS, 2400, 1), 1.0f).statusEffect(new StatusEffectInstance(StatusEffects.HASTE, 2400, 1), 1.0f).build();
	public static final FoodComponent SURSTROMMING = new FoodComponent.Builder().hunger(5).saturationModifier(0.6F).statusEffect(new StatusEffectInstance(StatusEffects.NAUSEA, 1728000, 9), 1.0f).build();
