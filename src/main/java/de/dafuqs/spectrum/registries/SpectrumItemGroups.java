...
public class SpectrumItemGroups {
	...
	public static final ItemSubGroup EQUIPMENT = new ItemSubGroup.Builder(MAIN, Text.translatable("itemGroup.spectrum.equipment")).backgroundTexture(TEXTURE).entries((displayContext, entries) -> {
		...
		entries.add(SpectrumItems.MULTITOOL);
		entries.add(SpectrumItems.TENDER_PICKAXE);
		entries.add(SpectrumItems.LUCKY_PICKAXE);
		entries.add(SpectrumItems.RAZOR_FALCHION);
		entries.add(SpectrumItems.OBLIVION_PICKAXE);
		entries.add(SpectrumItems.RESONANT_PICKAXE);
		entries.add(SpectrumItems.DRAGONRENDING_PICKAXE);
		entries.add(SpectrumItems.LAGOON_ROD);
		...
		entries.add(SpectrumItems.BEDROCK_PICKAXE);
		entries.add(SpectrumItems.BEDROCK_AXE);
		entries.add(SpectrumItems.BEDROCK_SHOVEL);
		entries.add(SpectrumItems.BEDROCK_SWORD);
		entries.add(SpectrumItems.BEDROCK_HOE);
		entries.add(SpectrumItems.BEDROCK_BOW);
		entries.add(SpectrumItems.BEDROCK_CROSSBOW);
		entries.add(SpectrumItems.BEDROCK_SHEARS);
		entries.add(SpectrumItems.BEDROCK_FISHING_ROD);
		entries.add(SpectrumItems.BEDROCK_HELMET);
		entries.add(SpectrumItems.BEDROCK_CHESTPLATE);
		entries.add(SpectrumItems.BEDROCK_LEGGINGS);
		entries.add(SpectrumItems.BEDROCK_BOOTS);
		entries.add(SpectrumItems.MALACHITE_WORKSTAFF);
		entries.add(SpectrumItems.MALACHITE_ULTRA_GREATSWORD);
		entries.add(SpectrumItems.MALACHITE_CROSSBOW);
		entries.add(SpectrumItems.MALACHITE_BIDENT);
		entries.add(SpectrumItems.GLASS_CREST_WORKSTAFF);
		entries.add(SpectrumItems.GLASS_CREST_ULTRA_GREATSWORD);
		entries.add(SpectrumItems.FEROCIOUS_GLASS_CREST_BIDENT);
		entries.add(SpectrumItems.FRACTAL_GLASS_CREST_BIDENT);
		entries.add(SpectrumItems.GLASS_CREST_CROSSBOW);
	...
	public static final ItemSubGroup FUNCTIONAL = new ItemSubGroup.Builder(MAIN, Text.translatable("itemGroup.spectrum.functional")).backgroundTexture(TEXTURE).entries((displayContext, entries) -> {
		...
		entries.add(SpectrumBlocks.AXOLOTL_MOB_BLOCK);
		entries.add(SpectrumBlocks.BAT_MOB_BLOCK);
		entries.add(SpectrumBlocks.BEE_MOB_BLOCK);
		entries.add(SpectrumBlocks.BLAZE_MOB_BLOCK);
		entries.add(SpectrumBlocks.CAT_MOB_BLOCK);
		entries.add(SpectrumBlocks.CHICKEN_MOB_BLOCK);
		entries.add(SpectrumBlocks.COW_MOB_BLOCK);
		entries.add(SpectrumBlocks.CREEPER_MOB_BLOCK);
		entries.add(SpectrumBlocks.ENDER_DRAGON_MOB_BLOCK);
		entries.add(SpectrumBlocks.ENDERMAN_MOB_BLOCK);
		entries.add(SpectrumBlocks.ENDERMITE_MOB_BLOCK);
		entries.add(SpectrumBlocks.EVOKER_MOB_BLOCK);
		entries.add(SpectrumBlocks.FISH_MOB_BLOCK);
		entries.add(SpectrumBlocks.FOX_MOB_BLOCK);
		entries.add(SpectrumBlocks.GHAST_MOB_BLOCK);
		entries.add(SpectrumBlocks.GLOW_SQUID_MOB_BLOCK);
		entries.add(SpectrumBlocks.GOAT_MOB_BLOCK);
		entries.add(SpectrumBlocks.GUARDIAN_MOB_BLOCK);
		entries.add(SpectrumBlocks.HORSE_MOB_BLOCK);
		entries.add(SpectrumBlocks.ILLUSIONER_MOB_BLOCK);
		entries.add(SpectrumBlocks.OCELOT_MOB_BLOCK);
		entries.add(SpectrumBlocks.PARROT_MOB_BLOCK);
		entries.add(SpectrumBlocks.PHANTOM_MOB_BLOCK);
		entries.add(SpectrumBlocks.PIG_MOB_BLOCK);
		entries.add(SpectrumBlocks.PIGLIN_MOB_BLOCK);
		entries.add(SpectrumBlocks.POLAR_BEAR_MOB_BLOCK);
		entries.add(SpectrumBlocks.PUFFERFISH_MOB_BLOCK);
		entries.add(SpectrumBlocks.RABBIT_MOB_BLOCK);
		entries.add(SpectrumBlocks.SHEEP_MOB_BLOCK);
		entries.add(SpectrumBlocks.SHULKER_MOB_BLOCK);
		entries.add(SpectrumBlocks.SILVERFISH_MOB_BLOCK);
		entries.add(SpectrumBlocks.SKELETON_MOB_BLOCK);
		entries.add(SpectrumBlocks.SLIME_MOB_BLOCK);
		entries.add(SpectrumBlocks.SNOW_GOLEM_MOB_BLOCK);
		entries.add(SpectrumBlocks.SPIDER_MOB_BLOCK);
		entries.add(SpectrumBlocks.SQUID_MOB_BLOCK);
		entries.add(SpectrumBlocks.STRAY_MOB_BLOCK);
		entries.add(SpectrumBlocks.STRIDER_MOB_BLOCK);
		entries.add(SpectrumBlocks.TURTLE_MOB_BLOCK);
		entries.add(SpectrumBlocks.WITCH_MOB_BLOCK);
		entries.add(SpectrumBlocks.WITHER_MOB_BLOCK);
		entries.add(SpectrumBlocks.WITHER_SKELETON_MOB_BLOCK);
		entries.add(SpectrumBlocks.ZOMBIE_MOB_BLOCK);
	...
	public static final ItemSubGroup CUISINE = new ItemSubGroup.Builder(MAIN, Text.translatable("itemGroup.spectrum.cuisine")).backgroundTexture(TEXTURE).entries((displayContext, entries) -> {
		...
		entries.add(SpectrumItems.INFUSED_BEVERAGE);
