...
public class SpectrumItems {
	...
	public static final Item MARROW_SPAWN_EGG = register(parented(item("marrow_spawn_egg", new SpawnEggItem(SpectrumEntityTypes.MARROW, 0x200d29, 0xc83e93, IS.of()), InkColors.WHITE), SpectrumModels.SPAWN_EGG)); // TODO: colors
	public static final Item SPLINTERSPAWN_SPAWN_EGG = register(parented(item("splinterspawn_spawn_egg", new SpawnEggItem(SpectrumEntityTypes.SPLINTERSPAWN, 0x200d29, 0xc83e93, IS.of()), InkColors.WHITE), SpectrumModels.SPAWN_EGG)); // TODO: colors
