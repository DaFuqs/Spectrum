...
public class SpectrumItems {
	...
	public static final Item GLASS_AMPOULE = new GlassAmpouleItem(IS.of(Rarity.RARE).maxCount(8));
	public static final Item FRACTAL_GLASS_AMPOULE = new FractalGlassAmpouleItem(IS.of(Rarity.RARE).maxCount(8));
	public static final Item FEROCIOUS_GLASS_AMPOULE = new FerociousGlassAmpouleItem(IS.of(Rarity.RARE).maxCount(8));
	public static final Item CRYSTALLIZED_DRAGON_FANG = new CrystallizedDragonFangItem(IS.of(Rarity.RARE).maxCount(8));
	...
	public static final CloakedFloatItem STRATINE_FRAGMENTS = new CloakedFloatItem(IS.of(64).fireproof(), 1.003F, ((RevelationAware) SpectrumBlocks.STRATINE_ORE).getCloakAdvancementIdentifier(), Items.RED_DYE);
	public static final CloakedFloatItem STRATINE_GEM = new CloakedFloatItem(IS.of(16).fireproof(), 1.02F, ((RevelationAware) SpectrumBlocks.STRATINE_ORE).getCloakAdvancementIdentifier(), Items.RED_DYE);
	public static final CloakedFloatItem PALTAERIA_FRAGMENTS = new CloakedFloatItem(IS.of(), 0.997F, ((RevelationAware) SpectrumBlocks.PALTAERIA_ORE).getCloakAdvancementIdentifier(), Items.CYAN_DYE);
	public static final CloakedFloatItem PALTAERIA_GEM = new CloakedFloatItem(IS.of(16), 0.98F, ((RevelationAware) SpectrumBlocks.PALTAERIA_ORE).getCloakAdvancementIdentifier(), Items.CYAN_DYE);
	...
	public static final Item HIBERNATING_JADE_VINE_BULB = new ItemWithTooltip(IS.of(16), "item.spectrum.hibernating_jade_vine_seeds.tooltip");
	public static final Item GERMINATED_JADE_VINE_BULB = new GerminatedJadeVineBulbItem(IS.of(16), SpectrumCommon.locate("hidden/collect_hibernating_jade_vine_seeds"), Items.LIME_DYE);
	...
	public static final Item MYCEYLON = new Item(IS.of());
	...
	public static final Item MELOCHITES_COOKBOOK_VOL_1 = new CookbookItem(IS.of().maxCount(1), "cuisine/melochites_cookbook_vol_1");
	public static final Item MELOCHITES_COOKBOOK_VOL_2 = new CookbookItem(IS.of().maxCount(1), "cuisine/melochites_cookbook_vol_2");
	public static final Item IMBRIFER_COOKBOOK = new CookbookItem(IS.of().maxCount(1), "cuisine/imbrifer_cookbook");
	public static final Item IMPERIAL_COOKBOOK = new CookbookItem(IS.of().maxCount(1), "cuisine/imperial_cookbook");
	public static final Item BREWERS_HANDBOOK = new CookbookItem(IS.of().maxCount(1), "cuisine/brewers_handbook");
	
	public static final Item AQUA_REGIA = new Item(IS.of().food(SpectrumFoodComponents.AQUA_REGIA));
	...
	public static final Item BRISTLE_MEAD = new Item(IS.of().food(SpectrumFoodComponents.BRISTLE_MEAD));
	...
	public static final Item GOLDEN_BRISTLE_TEA = new Item(IS.of().food(SpectrumFoodComponents.GOLDEN_BRISTLE_TEA));
	public static final Item HARE_ROAST = new Item(IS.of().food(SpectrumFoodComponents.GOLDEN_BRISTLE_TEA));
	public static final Item JUNKET = new Item(IS.of().food(SpectrumFoodComponents.JUNKET));
	public static final Item KOI_FISH = new Item(IS.of().food(SpectrumFoodComponents.KOI_FISH));
	...
	public static final Item MORCHELLA = new Item(IS.of().food(SpectrumFoodComponents.MORCHELLA));
	public static final Item NECTERED_VIOGNIER = new Item(IS.of().food(SpectrumFoodComponents.NECTERED_VIOGNIER));
	public static final Item PEACHES_FLAMBE = new Item(IS.of().food(SpectrumFoodComponents.PEACHES_FLAMBE));
	public static final Item PEACH_CREAM = new Item(IS.of().food(SpectrumFoodComponents.PEACH_CREAM));
	public static final Item PEACH_JAM = new Item(IS.of().food(SpectrumFoodComponents.PEACH_JAM));
	public static final Item RABBIT_CREAM_PIE = new Item(IS.of().food(SpectrumFoodComponents.RABBIT_CREAM_PIE));
	public static final Item SEDATIVES = new Item(IS.of().food(SpectrumFoodComponents.SEDATIVES));
	public static final Item SLUSHSLIDE = new Item(IS.of().food(SpectrumFoodComponents.SLUSHSLIDE));
	...
	public static final Item EGG_LAYING_WOOLY_PIG_SPAWN_EGG = new SpawnEggItem(SpectrumEntityTypes.EGG_LAYING_WOOLY_PIG, 0x4e3842, 0xffe6c2, IS.of()); // TODO: colors
	...
	public static final Item KINDLING_SPAWN_EGG = new SpawnEggItem(SpectrumEntityTypes.KINDLING, 0x4e3842, 0xffe6c2, IS.of()); // TODO: colors
	...
	public static final Item MYSTERIOUS_COMPASS = new StructureCompassItem(IS.of(1, Rarity.RARE), SpectrumStructureTags.MYSTERIOUS_COMPASS_LOCATED);
