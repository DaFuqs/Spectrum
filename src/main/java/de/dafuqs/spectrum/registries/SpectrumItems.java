...
public class SpectrumItems {
	...
	public static final CloakedFloatItem STRATINE_FRAGMENTS = new CloakedFloatItem(Tab.RESOURCES.settings(64).fireproof(), -0.00125F, ((RevelationAware) SpectrumBlocks.STRATINE_ORE).getCloakAdvancementIdentifier(), Items.RED_DYE);
	public static final CloakedFloatItem STRATINE_GEM = new CloakedFloatItem(Tab.RESOURCES.settings(16).fireproof(), -0.01F, ((RevelationAware) SpectrumBlocks.STRATINE_ORE).getCloakAdvancementIdentifier(), Items.RED_DYE);
	public static final CloakedFloatItem PALTAERIA_FRAGMENTS = new CloakedFloatItem(Tab.RESOURCES.settings(), 0.00125F, ((RevelationAware) SpectrumBlocks.PALTAERIA_ORE).getCloakAdvancementIdentifier(), Items.CYAN_DYE);
	public static final CloakedFloatItem PALTAERIA_GEM = new CloakedFloatItem(Tab.RESOURCES.settings(16), 0.01F, ((RevelationAware) SpectrumBlocks.PALTAERIA_ORE).getCloakAdvancementIdentifier(), Items.CYAN_DYE);
	public static final Item PYRITE_CHUNK = new Item(Tab.RESOURCES.settings());
	public static final Item DRAGONBONE_CHUNK = new CloakedItem(Tab.RESOURCES.settings(Rarity.UNCOMMON), SpectrumCommon.locate("hidden/collect_dragonbone"), Items.GRAY_DYE);
	public static final Item BONE_ASH = new CloakedItem(Tab.RESOURCES.settings(Rarity.UNCOMMON), SpectrumCommon.locate("hidden/collect_dragonbone"), Items.GRAY_DYE);
	...
	public static final Item BODACIOUS_BERRY_BAR = new Item(Tab.CUISINE.settings().food(SpectrumFoodComponents.BODACIOUS_BERRY_BAR));
	...
	public static final Item CREAM_PASTRY = new CustomUseTimeItem(Tab.CUISINE.settings().food(SpectrumFoodComponents.CREAM_PASTRY), 24);
	...
	public static final Item GOLDEN_BRISTLE_TEA = new TeaItem(Tab.CUISINE.settings().food(SpectrumFoodComponents.GOLDEN_BRISTLE_TEA), SpectrumFoodComponents.GOLDEN_BRISTLE_TEA_SCONE_BONUS);
	public static final Item HARE_ROAST = new CustomUseTimeItem(Tab.CUISINE.settings().food(SpectrumFoodComponents.HARE_ROAST), 64);
	public static final Item JUNKET = new Item(Tab.CUISINE.settings().food(SpectrumFoodComponents.JUNKET));
	public static final Item KOI = new Item(Tab.CUISINE.settings().food(SpectrumFoodComponents.KOI));
	...
	public static final Item RABBIT_CREAM_PIE = new ItemWithTooltip(Tab.CUISINE.settings().food(SpectrumFoodComponents.RABBIT_CREAM_PIE), "item.spectrum.rabbit_cream_pie.tooltip");
	public static final Item SEDATIVES = new SedativesItem(Tab.CUISINE.settings().food(SpectrumFoodComponents.SEDATIVES), "item.spectrum.sedatives.tooltip");
	public static final Item SLUSHSLIDE = new ItemWithTooltip(Tab.CUISINE.settings().food(SpectrumFoodComponents.SLUSHSLIDE), "item.spectrum.slushslide.tooltip");
	...
	public static final Item PRESERVATION_TURRET_SPAWN_EGG = new SpawnEggItem(SpectrumEntityTypes.PRESERVATION_TURRET, 0xf3f6f8, 0xc8c5be, Tab.CREATURES.settings()); // TODO: colors
	...
	public static final Item LIZARD_SPAWN_EGG = new SpawnEggItem(SpectrumEntityTypes.LIZARD, 0x896459, 0x503a40, Tab.CREATURES.settings());
	public static final Item ERASER_SPAWN_EGG = new SpawnEggItem(SpectrumEntityTypes.ERASER, 0x200d29, 0xc83e93, Tab.CREATURES.settings());
