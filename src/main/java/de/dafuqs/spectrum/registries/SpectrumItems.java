...
public class SpectrumItems {
	...
	public static final DeferredItem<CloakedFloatItem> STRATINE_GEM = register(simple(item("stratine_gem", new CloakedFloatItem(IS.of(16).fireResistant(), -0.01F, ((RevelationAware) SpectrumBlocks.STRATINE_ORE).getCloakAdvancementIdentifier(), RED_DYE), InkColors.RED)));
