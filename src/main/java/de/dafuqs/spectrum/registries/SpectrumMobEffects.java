...
public class SpectrumMobEffects {
	 ...
	 */
	public static final Holder<MobEffect> IMMUNITY = register("immunity", () -> new ImmunityStatusEffect(MobEffectCategory.NEUTRAL, 0x4bbed5)
	 ...
	 */
	public static final Holder<MobEffect> NOURISHING = register("nourishing", () -> new NourishingStatusEffect(MobEffectCategory.BENEFICIAL, 0x2324f8));
	
	/**
	 * Rerolls loot table entry counts based on chance (like with fortune/looting) and takes the best one
	 */
	public static final Holder<MobEffect> ANOTHER_ROLL = register("another_roll", () -> new NoopStatusEffect(MobEffectCategory.BENEFICIAL, 0xa1ce00));
	
	/**
	 * Stops natural regeneration
	 * and prevents sprinting
	 */
	public static final Holder<MobEffect> SCARRED = register("scarred", () -> new ScarredStatusEffect(MobEffectCategory.HARMFUL, 0x5b1d1d));
	...
	public static final Holder<MobEffect> VULNERABILITY = register("vulnerability", () -> new NoopStatusEffect(MobEffectCategory.HARMFUL, 0x353535));
	
	/**
	 * Removes gravity to the entity
	 * entities will fall slower or start levitating with high potency
	 */
	public static final Holder<MobEffect> LIGHTWEIGHT = register("lightweight", () -> new GravityStatusEffect(MobEffectCategory.NEUTRAL, 0x00dde4, 0.02F));
	
	/**
	 * Adds gravity to the entity
	 * flying mobs will fall and be nearly unable to fall (phantoms, ghasts)
	 */
	public static final Holder<MobEffect> DENSITY = register("density", () -> new GravityStatusEffect(MobEffectCategory.HARMFUL, 0x671a25, -0.02F));
	
	/**
	 * Increases attack speed
	 */
	public static final Holder<MobEffect> SWIFTNESS = register("swiftness", () -> new NoopStatusEffect(MobEffectCategory.BENEFICIAL, 0xffe566)
	 ...
	 */
	public static final Holder<MobEffect> STIFFNESS = register("stiffness", () -> new NoopStatusEffect(MobEffectCategory.HARMFUL, 0x7e7549)
	 ...
	 */
	public static final Holder<MobEffect> MAGIC_ANNULATION = register("magic_annulation", () -> new NoopStatusEffect(MobEffectCategory.BENEFICIAL, 0x7a1082)
	 ...
	 */
	public static final Holder<MobEffect> DEADLY_POISON = register("deadly_poison", () -> new DeadlyPoisonStatusEffect(MobEffectCategory.HARMFUL, 5149489));
	
	/**
	 * Increased toughness. Simple, effective
	 */
	public static final Holder<MobEffect> TOUGHNESS = register("toughness", () -> new NoopStatusEffect(MobEffectCategory.BENEFICIAL, 0x28bbe0)
	 ...
	 */
	public static final Holder<MobEffect> EFFECT_PROLONGING = register("effect_prolonging", () -> new EffectProlongingStatusEffect(MobEffectCategory.BENEFICIAL, 0xc081d5));
	
	/**
	 * Reduced health over time
	 */
	public static final Holder<MobEffect> LIFE_DRAIN = register("life_drain", () -> new LifeDrainStatusEffect(MobEffectCategory.HARMFUL, 0x222222)
	 ...
	 */
	public static final Holder<MobEffect> ASCENSION = register("ascension", () -> new AscensionStatusEffect(MobEffectCategory.BENEFICIAL, 0xdff9fc));
	public static final Holder<MobEffect> DIVINITY = register("divinity", () -> new DivinityStatusEffect(MobEffectCategory.BENEFICIAL, 0xdff9fc)
	 ...
	 */
	public static final Holder<MobEffect> FRENZY = register("frenzy", () -> new FrenzyStatusEffect(MobEffectCategory.NEUTRAL, 0x990000)
	 ...
	 */
	public static final Holder<MobEffect> LAVA_GLIDING = register("lava_gliding", () -> new NoopStatusEffect(MobEffectCategory.BENEFICIAL, 0xc42e0e)
	 ...
	 */
	public static final Holder<MobEffect> CALMING = register("calming", () -> new SleepStatusEffect(MobEffectCategory.BENEFICIAL, 0x5fd7b3, true)
	 ...
	 */
	public static final Holder<MobEffect> SOMNOLENCE = register("somnolence", () -> new SleepStatusEffect(MobEffectCategory.NEUTRAL, 0xae7bec, true)
	 ...
	 */
	public static final Holder<MobEffect> ETERNAL_SLUMBER = register("eternal_slumber", () -> new SleepStatusEffect(MobEffectCategory.HARMFUL, ETERNAL_SLUMBER_COLOR, false)
	 ...
	 */
	public static final Holder<MobEffect> FATAL_SLUMBER = register("fatal_slumber", () -> new SleepStatusEffect(MobEffectCategory.HARMFUL, 0x8136c2, false)
	...
	public static final Holder<MobEffect> PROJECTILE_REBOUND = register("projectile_rebound", () -> new NoopStatusEffect(MobEffectCategory.BENEFICIAL, 0x77e6df));
