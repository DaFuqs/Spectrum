...
public class SpectrumRegistries {
	...
	public static final Registry<ExplosionModifier> EXPLOSION_EFFECT_MODIFIERS = FabricRegistryBuilder.createSimple(ExplosionModifier.class, SpectrumCommon.locate("explosion_effect_modifier")).attribute(RegistryAttribute.SYNCED).buildAndRegister();
	public static final Registry<ExplosionModifierType> EXPLOSION_EFFECT_FAMILIES = FabricRegistryBuilder.createSimple(ExplosionModifierType.class, SpectrumCommon.locate("explosion_effect_family")).attribute(RegistryAttribute.SYNCED).buildAndRegister();
