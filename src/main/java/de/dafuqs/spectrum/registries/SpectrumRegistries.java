...
public class SpectrumRegistries {
	...
	public static final Registry<KindlingVariant> KINDLING_VARIANT = FabricRegistryBuilder.createSimple(KindlingVariant.class, KINDLING_VARIANT_ID).attribute(RegistryAttribute.SYNCED).buildAndRegister();
