...
public class SpectrumSoundEvents {
	...
	private static final DeferredRegister<SoundEvent> REGISTRAR = DeferredRegister.create(Registries.SOUND_EVENT, SpectrumCommon.MOD_ID);
	...
	public static final SoundEvent BLOCK_ARCANE_CHARGE_EXPLODE = register("block.arcane_charge.explode");
	...
	private static SoundEvent register(String id) {
		ResourceLocation resourceLocation = SpectrumCommon.locate(id);
		SoundEvent soundEvent = SoundEvent.createVariableRangeEvent(resourceLocation);
		REGISTRAR.register(id, () -> soundEvent);
		return soundEvent;
	}
