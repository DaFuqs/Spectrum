...
public class BedrockArmorCapeModel {
    ...
    private static ModelPart createCape() {
        ...
        root.addChild("cape", ModelPartBuilder.create()
            ...
            .uv(0, 49).cuboid(-4.0F, -1.8333F, 0.1667F, 9.0F, 21.0F, 0.0F, Dilation.NONE)
            .uv(62, 78).cuboid(-6.5F, 0.1667F, -0.0833F, 5.0F, 21.0F, 0.0F, Dilation.NONE)
            .uv(52, 68).cuboid(2.5F, 0.1667F, -0.0833F, 5.0F, 21.0F, 0.0F, Dilation.NONE), ModelTransform.pivot(-0.5F, 1.8333F, 2.6833F));
