...
public class SpectrumBlockSoundGroups {
	...
	public static BlockSoundGroup DROWNED_MOB_BLOCK;
	...
	public static BlockSoundGroup VINDICATOR_MOB_BLOCK;
	...
	public static void register() {
		...
		VINDICATOR_MOB_BLOCK = new BlockSoundGroup(1.0F, 1.0F, SoundEvents.ENTITY_VINDICATOR_DEATH, SoundEvents.BLOCK_WOOL_STEP, SoundEvents.ENTITY_VINDICATOR_AMBIENT, SoundEvents.ENTITY_VINDICATOR_HURT, SoundEvents.ENTITY_VINDICATOR_AMBIENT);
