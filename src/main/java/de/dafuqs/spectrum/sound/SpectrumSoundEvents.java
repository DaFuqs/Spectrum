...
public class SpectrumSoundEvents {
	...
	public static SoundEvent PUFF_CIRCLET_PFFT = register("puff_circlet");
	public static SoundEvent MIDNIGHT_ABERRATION_CRUMBLING = register("midnight_aberration_crumbling");
