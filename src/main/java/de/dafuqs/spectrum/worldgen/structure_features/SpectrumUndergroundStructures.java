...
public class SpectrumUndergroundStructures extends StructureFeature<StructurePoolFeatureConfig> {

    public SpectrumUndergroundStructures() {
        super(StructurePoolFeatureConfig.CODEC, SpectrumUndergroundStructures::createPiecesGenerator, PostPlacementProcessor.EMPTY);
    }
