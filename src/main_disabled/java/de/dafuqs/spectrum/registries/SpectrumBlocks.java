...
public class SpectrumBlocks {
	...
	public static final Block PARAMETRIC_MINING_DEVICE = register(blockWithItem("parametric_mining_device", new ParametricMiningDeviceBlock(BlockBehaviour.Properties.ofFullCopy(BLACKSLAG).noOcclusion().instabreak()), block -> new ParametricMiningDeviceItem(block, IS.of(8)), InkColors.RED));
	...
	public static final Block CONNECTION_NODE = register(cutout(blockWithItem("connection_node", new PastelNodeBlock(pastelNode(SoundType.AMETHYST_CLUSTER), PastelNodeType.CONNECTION), IS.of(16), InkColors.LIGHT_GRAY).withPredefinedItemModel()));
	public static final Block PROVIDER_NODE = register(cutout(blockWithItem("provider_node", new PastelNodeBlock(pastelNode(SoundType.AMETHYST_CLUSTER), PastelNodeType.PROVIDER), IS.of(16), InkColors.MAGENTA).withPredefinedItemModel()));
	public static final Block STORAGE_NODE = register(cutout(blockWithItem("storage_node", new PastelNodeBlock(pastelNode(SpectrumBlockSoundGroups.TOPAZ_CLUSTER), PastelNodeType.STORAGE), IS.of(16), InkColors.CYAN).withPredefinedItemModel()));
	public static final Block SENDER_NODE = register(cutout(blockWithItem("sender_node", new PastelNodeBlock(pastelNode(SpectrumBlockSoundGroups.CITRINE_CLUSTER), PastelNodeType.SENDER), IS.of(16), InkColors.YELLOW).withPredefinedItemModel()));
	public static final Block GATHER_NODE = register(cutout(blockWithItem("gather_node", new PastelNodeBlock(pastelNode(SpectrumBlockSoundGroups.ONYX_CLUSTER), PastelNodeType.GATHER), IS.of(16), InkColors.BLACK).withPredefinedItemModel()));
	...
	public static final Block POTTED_SWEET_PEA = register(pottedPlant(block("potted_sweet_pea", new FlowerPotBlock(SWEET_PEA, pottedPlant().lightLevel(s -> 11).hasPostProcess(SpectrumBlocks::always).emissiveRendering(SpectrumBlocks::always))), false));
	public static final Block POTTED_APRICOTTI = register(pottedPlant(block("potted_apricotti", new FlowerPotBlock(APRICOTTI, pottedPlant().lightLevel(s -> 11).hasPostProcess(SpectrumBlocks::always).emissiveRendering(SpectrumBlocks::always))), false));
	...
	public static final Block POTTED_HUMMING_BELL = register(pottedPlant(block("potted_humming_bell", new FlowerPotBlock(HUMMING_BELL, pottedPlant().lightLevel(s -> 9).hasPostProcess(SpectrumBlocks::always).emissiveRendering(SpectrumBlocks::always))), false));
	...
	public static final Block STARDUST_BLOCK = register(blockWithItem("stardust_block", new ColoredFallingBlock(new ColorRGBA(DyeColor.PURPLE.getFireworkColor()), BlockBehaviour.Properties.ofFullCopy(Blocks.SAND).mapColor(MapColor.COLOR_PURPLE)), IS.of(1, Rarity.UNCOMMON), InkColors.BLACK));
